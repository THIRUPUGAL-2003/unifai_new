...
description: "Integrate AWS Bedrock Guardrails with UnifAI for enterprise-grade content filtering, PII protection, prompt attack detection, and image content analysis."
icon: "aws"
---

UnifAI integrates with **Amazon Bedrock Guardrails** to provide enterprise-grade content filtering and safety features with deep AWS integration. This page covers the configuration and capabilities of the AWS Bedrock guardrail provider.
