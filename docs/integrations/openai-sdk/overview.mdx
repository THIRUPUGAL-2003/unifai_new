---
title: "Overview"
description: "Use UnifAI as a drop-in replacement for OpenAI API with full compatibility and enhanced features."
icon: "book"
---

## Overview

UnifAI provides complete OpenAI API compatibility through protocol adaptation. The integration handles request transformation, response normalization, and error mapping between OpenAI's API specification and UnifAI's internal processing pipeline.

This integration enables you to utilize UnifAI's features like governance, load balancing, semantic caching, multi-provider support, and more, all while preserving your existing OpenAI SDK-based architecture.
...
The OpenAI integration supports all features that are available in both the OpenAI SDK and UnifAI core functionality. If the OpenAI SDK supports a feature and UnifAI supports it, the integration will work seamlessly.
