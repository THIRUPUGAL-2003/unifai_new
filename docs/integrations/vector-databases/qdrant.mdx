---
title: "Qdrant"
description: "Qdrant vector database integration for semantic caching in UnifAI."
icon: "database"
---
...
| `port` | integer | `6334` | gRPC port. UnifAI always uses the gRPC interface. |
...
<Note>
Qdrant uses port 6334 for gRPC and port 6333 for REST. UnifAI uses the gRPC port.
</Note>
