...
tag: "Beta"
description: "Upload files and create batch jobs for asynchronous processing using the Anthropic SDK through UnifAI across multiple providers."
icon: "folder-open"
---

## Overview

UnifAI supports the Anthropic Files API and Batch API (via the `beta` namespace) with **cross-provider routing**. This means you can use the Anthropic SDK to manage files and batch jobs across multiple providers including Anthropic, OpenAI, and Gemini.
