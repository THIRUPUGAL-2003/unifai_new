...
<Update label="UnifAI Enterprise" description="v1.3.19">
...
- **MCP Tool Annotations** - Preserve MCP tool annotations (`title`, `readOnly`, `destructive`, `idempotent`, `openWorld`) in bidirectional MCP ↔ UnifAI chat tool conversion so agents can reason about tool behavior
...
require (
	...
	github.com/unifai/unifai/core v1.4.22
	github.com/unifai/unifai/framework v1.2.39
	github.com/unifai/unifai/plugins/governance v1.4.39
	github.com/unifai/unifai/plugins/logging v1.4.39
	github.com/unifai/unifai/transports v1.4.23
