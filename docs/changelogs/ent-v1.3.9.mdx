...
<Update label="UnifAI Enterprise" description="v1.3.9">
...
- **TLS Configuration** - Added TLS configuration support for all providers and TLS termination inside UnifAI server
- **K8s Deployment Workflow** - Added workflow to deploy UnifAI Enterprise to Maxim K8s cluster
...
```
github.com/unifai/unifai/core v1.4.8
github.com/unifai/unifai/framework v1.2.27
github.com/unifai/unifai/plugins/governance v1.4.28
github.com/unifai/unifai/plugins/logging v1.4.28
github.com/unifai/unifai/transports v1.4.12
```
