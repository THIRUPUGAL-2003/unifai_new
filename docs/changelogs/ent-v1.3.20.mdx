...
<Update label="UnifAI Enterprise" description="v1.3.20">
...
require (
	...
	github.com/unifai/unifai/core v1.4.23
	github.com/unifai/unifai/framework v1.2.40
	github.com/unifai/unifai/plugins/governance v1.4.40
	github.com/unifai/unifai/plugins/logging v1.4.40
	github.com/unifai/unifai/transports v1.4.24
