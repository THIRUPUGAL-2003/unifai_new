...
<Update label="UnifAI Enterprise" description="v1.4.13">
...
- **Datadog session-grouped traces** - A new `group_traces_by_session` option groups all requests sharing the same `x-uf-session-id` header into a single Datadog APM trace, by pinning each request's root span to a deterministic trace ID derived from the session ID via SHA-256. An inbound W3C `traceparent` always takes precedence.
...
require (
	...
	github.com/unifai/unifai/core v1.5.22
	github.com/unifai/unifai/framework v1.3.22
	github.com/unifai/unifai/plugins/governance v1.5.22
	github.com/unifai/unifai/plugins/logging v1.5.22
	github.com/unifai/unifai/plugins/prompts v1.0.22
	github.com/unifai/unifai/plugins/semanticcache v1.5.22
	github.com/unifai/unifai/transports v1.5.16
...
require (
	...
	github.com/unifai/unifai/plugins/compat v0.1.21 // indirect
	github.com/unifai/unifai/plugins/maxim v1.6.22 // indirect
	github.com/unifai/unifai/plugins/mocker v1.5.22 // indirect
	github.com/unifai/unifai/plugins/modelcatalogresolver v1.0.3 // indirect
	github.com/unifai/unifai/plugins/otel v1.2.23 // indirect
	github.com/unifai/unifai/plugins/telemetry v1.5.22 // indirect
