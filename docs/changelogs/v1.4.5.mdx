...
<Tabs>
  <Tab title="NPX">
    ```bash
    npx -y @unifai/unifai --transport-version v1.4.5
    ```
  </Tab>
  <Tab title="Docker">
    ```bash
    docker pull unifai/unifai:v1.4.5
    docker run -p 8080:8080 unifai/unifai:v1.4.5
    ```
  </Tab>
</Tabs>

<Update label="UnifAI(HTTP)" description="1.4.5">
...
- fix: mapping of multiple modality tokens from gemini usage metadata to unifai usage
