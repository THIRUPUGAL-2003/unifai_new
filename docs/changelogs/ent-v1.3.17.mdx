...
<Update label="UnifAI Enterprise" description="v1.3.17">
...
require (
	...
	github.com/unifai/unifai/core v1.4.17
	github.com/unifai/unifai/framework v1.2.36
	github.com/unifai/unifai/plugins/governance v1.4.36
	github.com/unifai/unifai/plugins/logging v1.4.36
	github.com/unifai/unifai/transports v1.4.20
