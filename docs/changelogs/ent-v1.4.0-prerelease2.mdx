...
<Update label="UnifAI Enterprise" description="v1.4.0-prerelease2">
...
require (
	...
	github.com/unifai/unifai/core v1.5.1
	github.com/unifai/unifai/framework v1.3.1
	github.com/unifai/unifai/plugins/governance v1.5.1
	github.com/unifai/unifai/plugins/logging v1.5.1
	github.com/unifai/unifai/transports v1.5.0-prerelease2
