...
<Update label="UnifAI Enterprise" description="v1.3.16">
...
require (
	...
	github.com/unifai/unifai/core v1.4.16
	github.com/unifai/unifai/framework v1.2.35
	github.com/unifai/unifai/plugins/governance v1.4.35
	github.com/unifai/unifai/plugins/logging v1.4.35
	github.com/unifai/unifai/transports v1.4.19
