...
<Update label="UnifAI Enterprise" description="v1.3.13">
...
- **MCP Gateway Headers** - Fixed support for `x-uf-mcp-include-clients` and `x-uf-mcp-include-tools` headers to filter MCP tools/list response
...
github.com/unifai/unifai/core v1.4.14
github.com/unifai/unifai/framework v1.2.33
github.com/unifai/unifai/plugins/governance v1.4.33
github.com/unifai/unifai/plugins/logging v1.4.33
github.com/unifai/unifai/transports v1.4.17
