...
<Tabs>
  <Tab title="NPX">
    ```bash
    npx -y @unifai/unifai --transport-version v1.5.0-prerelease7
    ```
  </Tab>
  <Tab title="Docker">
    ```bash
    docker pull unifai/unifai:v1.5.0-prerelease7
    docker run -p 8080:8080 unifai/unifai:v1.5.0-prerelease7
    ```
  </Tab>
</Tabs>

<Update label="UnifAI(HTTP)" description="1.5.0-prerelease7">
## ✨ Features
...
- **Unified Dimension Headers (`x-uf-dim-*`)** - New unified dimension headers automatically forwarded to logs, traces, Prometheus, and Maxim tags
...
- feat: add `x-uf-dim-*` unified dimension headers forwarded to logs, traces, Prometheus, and Maxim tags
...
- feat: store and show finish reason in LLM calls
- feat: forward `x-uf-dim-*` unified dimension headers to logs and traces
...
- feat: forward `x-uf-dim-*` unified dimension headers as Maxim tags
...
- feat: forward `x-uf-dim-*` unified dimension headers to Prometheus metrics
- chore: upgraded core to v1.5.6 and framework to v1.3.6
