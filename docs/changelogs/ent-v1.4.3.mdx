...
<Update label="UnifAI Enterprise" description="v1.4.3">
...
- **Broker-mode clustering** : a new `broker` cluster type routes all inter-node traffic through a central gRPC relay instead of a peer-to-peer memberlist mesh, enabling deployment on platforms without inbound peer connectivity such as Cloud Run. Start the lightweight relay with `-mode=broker` (or `UNIFAI_MODE=broker`); leader election, roster sync, diagnostics, optional TLS, and auth tokens are all supported.
...
- **Streaming chunk context** : `ProcessStreamingChunk` now receives the request `UnifAIContext`.
...
- **DB safety** : the unsafe inline jsonb cast was replaced with a `unifai_safe_jsonb` PL/pgSQL helper.
...
- **Vertex service tier** : the Vertex traffic type now maps to the correct UnifAI service tier.
...
```
github.com/unifai/unifai/core                  v1.5.11
github.com/unifai/unifai/framework             v1.3.12
github.com/unifai/unifai/transports            v1.5.4
github.com/unifai/unifai/plugins/governance    v1.5.12
github.com/unifai/unifai/plugins/logging       v1.5.12
github.com/unifai/unifai/plugins/prompts       v1.0.12
github.com/unifai/unifai/plugins/semanticcache v1.5.12
github.com/unifai/unifai/plugins/compat        v0.1.10
github.com/unifai/unifai/plugins/maxim         v1.6.11
github.com/unifai/unifai/plugins/mocker        v1.5.11
github.com/unifai/unifai/plugins/otel          v1.2.11
github.com/unifai/unifai/plugins/telemetry     v1.5.11
```
...
require (
	...
	github.com/unifai/unifai/core v1.5.12
	github.com/unifai/unifai/framework v1.3.12
	github.com/unifai/unifai/plugins/governance v1.5.12
	github.com/unifai/unifai/plugins/logging v1.5.12
	github.com/unifai/unifai/plugins/prompts v1.0.12
...
require (
	...
	github.com/unifai/unifai/plugins/compat v0.1.11 // indirect
	github.com/unifai/unifai/plugins/maxim v1.6.12 // indirect
	github.com/unifai/unifai/plugins/mocker v1.5.12 // indirect
	github.com/unifai/unifai/plugins/otel v1.2.12 // indirect
	github.com/unifai/unifai/plugins/telemetry v1.5.12 // indirect
