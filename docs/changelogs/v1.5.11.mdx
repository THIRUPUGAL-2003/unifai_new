---
title: "v1.5.11"
description: "v1.5.11 changelog - 2026-06-08"
---
<Tabs>
  <Tab title="NPX">
    ```bash
    npx -y @unifai/unifai --transport-version v1.5.11
    ```
  </Tab>
  <Tab title="Docker">
    ```bash
    docker pull unifai/unifai:v1.5.11
    docker run -p 8080:8080 unifai/unifai:v1.5.11
    ```
  </Tab>
</Tabs>

<Update label="UnifAI(HTTP)" description="1.5.11">
