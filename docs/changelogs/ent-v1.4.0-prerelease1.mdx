...
<Update label="UnifAI Enterprise" description="v1.4.0-prerelease1">
...
- **MCP Gateway Filtering** - Support for `x-uf-mcp-include-clients` and `x-uf-mcp-include-tools` request headers to filter MCP tools/list response
...
require (
	...
	github.com/unifai/unifai/core v1.5.0
	github.com/unifai/unifai/framework v1.3.0
	github.com/unifai/unifai/plugins/governance v1.5.0
	github.com/unifai/unifai/plugins/logging v1.5.0
	github.com/unifai/unifai/transports v1.5.0-prerelease1
