...
<Update label="UnifAI Enterprise" description="v1.4.11">
...
- **pprof Profiling Server (OSS + enterprise)** - Optional runtime profiling server gated by `UNIFAI_PPROF_PORT`, with env-tunable block and mutex sampling rates and graceful shutdown alongside the main server. The enterprise binary now wires the profiling server into its startup path so the same diagnostics are available in enterprise deployments.
...
require (
	...
	github.com/unifai/unifai/core v1.5.21
	github.com/unifai/unifai/framework v1.3.21
	github.com/unifai/unifai/plugins/governance v1.5.21
	github.com/unifai/unifai/plugins/logging v1.5.21
	github.com/unifai/unifai/plugins/prompts v1.0.21
	github.com/unifai/unifai/plugins/semanticcache v1.5.21
	github.com/unifai/unifai/transports v1.5.15
...
require (
	...
	github.com/unifai/unifai/plugins/compat v0.1.20 // indirect
	github.com/unifai/unifai/plugins/maxim v1.6.21 // indirect
	github.com/unifai/unifai/plugins/mocker v1.5.21 // indirect
	github.com/unifai/unifai/plugins/modelcatalogresolver v1.0.2 // indirect
	github.com/unifai/unifai/plugins/otel v1.2.22 // indirect
	github.com/unifai/unifai/plugins/telemetry v1.5.21 // indirect
