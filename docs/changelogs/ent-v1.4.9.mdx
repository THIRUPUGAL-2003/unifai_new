...
<Update label="UnifAI Enterprise" description="v1.4.9">
...
- **Virtual Key Handling** - Generate a UUID when a virtual key is created without an ID, propagate the VK in GenAI file upload sessions, stamp the VK tool allowlist when the `include-clients` filter is present, and enforce the VK tool-grant boundary on caller-provided `x-uf-mcp-include-*` headers.
...
require (
	...
	github.com/unifai/unifai/core v1.5.19
	github.com/unifai/unifai/framework v1.3.19
	github.com/unifai/unifai/plugins/governance v1.5.19
	github.com/unifai/unifai/plugins/logging v1.5.19
	github.com/unifai/unifai/plugins/prompts v1.0.19
	github.com/unifai/unifai/plugins/semanticcache v1.5.19
	github.com/unifai/unifai/transports v1.5.13
...
require (
	...
	github.com/unifai/unifai/plugins/compat v0.1.18 // indirect
	github.com/unifai/unifai/plugins/maxim v1.6.19 // indirect
	github.com/unifai/unifai/plugins/mocker v1.5.19 // indirect
	github.com/unifai/unifai/plugins/modelcatalogresolver v1.0.0 // indirect
	github.com/unifai/unifai/plugins/otel v1.2.19 // indirect
	github.com/unifai/unifai/plugins/telemetry v1.5.19 // indirect
