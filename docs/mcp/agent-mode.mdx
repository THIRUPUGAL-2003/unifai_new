...
**Agent Mode** enables UnifAI to automatically execute tool calls without requiring explicit execution API calls for each tool. This transforms UnifAI from a simple gateway into an autonomous agent runtime.
...
2. UnifAI automatically executes **auto-executable** tools
        ...
        Input: []schemas.ChatMessage{
            {
                ...
                Content: schemas.ChatMessageContent{
                    ContentStr: unifai.Ptr("List all Go files in the project and summarize their purpose"),
                },
            },
        },
    }
...
mcpConfig := &schemas.MCPConfig{
    ...
    FetchNewRequestIDFunc: func(ctx context.Context) string {
        ...
        baseID := ctx.Value(schemas.UnifAIContextKeyRequestID).(string)
