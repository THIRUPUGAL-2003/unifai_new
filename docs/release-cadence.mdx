...
description: "How UnifAI OSS releases are versioned and shipped"
icon: "box-open"
---

UnifAI follows standard [semantic versioning](https://semver.org/) (`MAJOR.MINOR.PATCH`). The cadence below describes when each release type ships, what it typically contains, and how to decide whether you need to upgrade.
