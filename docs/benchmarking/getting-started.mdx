...
description: "Introduction to UnifAI's performance capabilities and how to choose the right instance size for your workload."
icon: "rocket"
---

## Overview

UnifAI has been rigorously tested under high load conditions to ensure optimal performance for production deployments. Our benchmark tests demonstrate exceptional performance characteristics at **5,000 requests per second (RPS)** across different AWS EC2 instance types.
...
UnifAI was benchmarked on two primary AWS EC2 instance configurations:
...
| **UnifAI Overhead** | 59 µs | 11 µs | **-81%** |
...
One of UnifAI's key strengths is its **configuration flexibility**. You can fine-tune the speed ↔ memory trade-off based on your specific requirements:
...
### **Run Your Own Tests**
- **[Run Your Own Benchmarks](./run-your-own-benchmarks)** - Step-by-step guide to benchmark UnifAI in your environment
