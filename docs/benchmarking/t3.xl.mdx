---
title: "t3.xlarge"
description: "Detailed performance metrics and analysis for UnifAI running on AWS t3.xlarge instances (4 vCPUs, 16GB RAM)."
icon: "server"
---
...
1. **Dramatic Overhead Reduction**: 81% lower UnifAI overhead (59 µs → 11 µs)
