---
title: "t3.medium"
description: "Detailed performance metrics and analysis for UnifAI running on AWS t3.medium instances (2 vCPUs, 4GB RAM)."
icon: "server"
---
...
|-----------|---------|-------------------|
| **Queue Wait Time** | 47.13 µs | Time waiting in UnifAI's internal queue |
...
|--------|-----------|-----------|------------|
| **UnifAI Overhead** | 59 µs | 11 µs | +81% slower |
