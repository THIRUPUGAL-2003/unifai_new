...
--data '{
    "model": "openai/tts-1",
    "input": "Hello! This is a sample text that will be converted to speech using UnifAI speech synthesis capabilities. The weather today is wonderful, and I hope you are having a great day!",
    "voice": "alloy",
    "response_format": "mp3"
}' \
--output "output.mp3"
...
--form 'prompt="This is a sample audio transcription from UnifAI speech synthesis."'
```

**Response format:**
```json
{
    "text": "Hello! This is a sample text that will be converted to speech using UnifAI speech synthesis capabilities. The weather today is wonderful, and I hope you are having a great day!"
}
```
