...
description: "Learn how to enable basic authentication for the UnifAI dashboard to secure your admin interface and API endpoints."
icon: "lock"
---

## Overview

UnifAI provides built-in authentication to protect your dashboard and admin API endpoints. When enabled, users must log in with credentials before accessing the dashboard or making admin API calls. This feature helps secure your UnifAI instance, especially when deployed in production environments.

## Enabling Authentication

### Step 1: Navigate to Security Settings

1. Open your UnifAI dashboard
...
1. Navigate to your UnifAI dashboard URL
...
UnifAI supports different authentication methods depending on the type of request:
