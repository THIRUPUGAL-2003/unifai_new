---
title: "Integrations"
description: "Use UnifAI as a drop-in replacement for existing AI provider SDKs with zero code changes. Just change the base URL and unlock advanced features."
icon: "plug"
---

## What are Integrations?

Integrations are protocol adapters that make UnifAI **100% compatible** with existing AI provider SDKs. They translate between provider-specific API formats (OpenAI, Anthropic, Google GenAI) and UnifAI's unified API, enabling you to:
...
**That's it!** Your application now has automatic fallbacks, governance, monitoring, and all UnifAI features.

## Available Integrations

UnifAI provides complete compatibility with these popular AI SDKs:
