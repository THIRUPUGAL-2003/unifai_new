---
title: "Logging"
description: "Configure logging for debugging, monitoring, and troubleshooting your UnifAI integration."
icon: "file-lines"
---

UnifAI provides a flexible logging system with configurable log levels and output formats. You can use the built-in default logger or implement your own custom logger.

## Using the Default Logger

UnifAI includes a `DefaultLogger` that writes to stdout/stderr with timestamps. Create one with your desired log level:
...
func main() {
    ...
    // Initialize UnifAI with the logger
    client, err := unifai.Init(schemas.UnifAIConfig{
        Account: &MyAccount{},
        Logger:  logger,
    })
    if err != nil {
...
UnifAI supports four log levels, from most to least verbose:
...
Pass your custom logger to UnifAI during initialization:
