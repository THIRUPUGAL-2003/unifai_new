---
title: "Reranking"
description: "Rerank documents with UnifAI Go SDK using client.RerankRequest."
...
func main() {
	...
	resp, bfErr := client.RerankRequest(schemas.NewUnifAIContext(context.Background(), schemas.NoDeadline), request)
	if bfErr != nil {
