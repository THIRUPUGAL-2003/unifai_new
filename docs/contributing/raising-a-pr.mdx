...
description: "Guidelines for submitting high-quality pull requests to UnifAI."
...
- core/unifai.go - Plugin registration
- transports/unifai-http/server.go - Cache middleware integration
...
- core/unifai.go - Register cache handler
...
Affected packages:
- core/providers/
- core/unifai.go (minor type update)
```
...
- transports/unifai-http/middleware.go - Apply rate limit checks
