...
description: "Code style and convention guidelines for contributing to UnifAI."
icon: "brush"
---

## Commit Message Format

All commits to UnifAI should follow a standardized format. This ensures clear history and makes it easy to understand changes at a glance.
