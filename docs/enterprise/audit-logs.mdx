---
title: "Audit Logs"
description: "Track administrative activity in UnifAI Enterprise with signed audit events, filtering, and export support."
icon: "scroll"
---

## Overview

**Audit Logs** in UnifAI Enterprise record administrative activity so operators can review who changed what, when it happened, and which resource was affected.
...
Open **Governance > Audit Logs** in the UnifAI dashboard.
