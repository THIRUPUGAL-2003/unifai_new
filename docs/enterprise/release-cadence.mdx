...
description: "How UnifAI Enterprise releases are versioned and shipped"
icon: "box-open"
---

UnifAI Enterprise follows standard [semantic versioning](https://semver.org/) (`MAJOR.MINOR.PATCH`) on top of the OSS base. The cadence below describes when each release type ships, what it typically contains, and how to decide whether you need to upgrade.
