...
**Custom Regex** is a UnifAI Enterprise guardrail provider that evaluates request and response text against regex patterns you define.
...
5. If any pattern matches any evaluated text block, UnifAI returns `GUARDRAIL_INTERVENED`.
    ...
    "guardrail_rules": [
      {
        ...
        "enabled": true,
        "cel_expression": "headers[\"x-uf-tenant\"] == \"external\"",
        "query": {
          "combinator": "and",
          "rules": [
            {
