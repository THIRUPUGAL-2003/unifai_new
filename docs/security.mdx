---
title: "Security at UnifAI"
description: "Overview of security practices across UnifAI's CI/CD pipelines, container images, supply chain, and deployment infrastructure."
icon: "shield"
sidebarTitle: "Security"
---

UnifAI applies defense-in-depth across its open-source and enterprise repositories. Every pull request,
...
UnifAI runs two Snyk scanning jobs on every push and pull request. Results are uploaded as
...
`unifai/unifai` image. Every image pushed to Docker Hub is automatically scanned for CVEs against
...
| --- | --- | --- |
| `unifai` (OSS) | Full SHA with version comment | 103 / 103 (100 %) |
| `unifai-enterprise` | Full SHA with version comment | 103 / 103 (100 %) |
