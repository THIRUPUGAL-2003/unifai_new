...
Perplexity is an OpenAI-compatible API with built-in web search capabilities and reasoning support. UnifAI performs conversions including:
...
These fields are preserved in the UnifAI response for client use.
