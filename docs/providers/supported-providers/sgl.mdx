...
SGL (SGLang) is an **OpenAI-compatible local/remote inference engine** used for serving models with high throughput. UnifAI delegates all operations to the OpenAI provider implementation. Key features:
