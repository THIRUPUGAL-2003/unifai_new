---
title: "OpenAI"
description: "OpenAI API conversion guide - what to know when using OpenAI through UnifAI"
icon: "openai"
---

## Overview

OpenAI is the **baseline schema** for UnifAI. When using OpenAI directly, parameters are passed through with minimal conversion - mostly validation and filtering of OpenAI-specific features.
...
<Tab title="API">
Refer to the API documentation for [Provider Keys Management](https://docs.unifai.ai/api-reference/providers/create-a-key-for-a-provider).
</Tab>
<Tab title="Go SDK">
...
| `messages` | [array](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L15) | ✅ | [`ChatMessage`](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L370) array with roles ([docs](https://platform.openai.com/docs/api-reference/chat/create#chat-create-messages)) |
...
| `logit_bias` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L25) | ❌ | Token logit adjustments |
| `logprobs` | bool | ❌ | Include log probabilities |
| `top_logprobs` | int | ❌ | Number of log probabilities per token |
| `seed` | int | ❌ | Reproducibility seed |
| `response_format` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L23) | ❌ | Output format ([docs](https://platform.openai.com/docs/api-reference/chat/create#chat-create-response_format)) |
| `tools` | [array](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L21) | ❌ | [`Tool`](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L600) objects ([docs](https://platform.openai.com/docs/api-reference/chat/create#chat-create-tools)) |
| `tool_choice` | string/[object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L22) | ❌ | `"auto"`, `"none"`, `"required"`, or specific tool |
| `parallel_tool_calls` | bool | ❌ | Allow multiple simultaneous tool calls |
| `stream_options` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L26) | ❌ | Streaming options ([docs](https://platform.openai.com/docs/api-reference/chat/create#chat-create-stream_options)) |
| `reasoning` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L24) | ❌ | Reasoning parameters ([UnifAI docs](/providers/reasoning), [OpenAI docs](https://platform.openai.com/docs/api-reference/chat/create#chat-create-reasoning)) |
| `user` | string | ❌ | **Truncated to 64 chars** |
| `metadata` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L27) | ❌ | Custom metadata |
...
| `prediction` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L28) | ❌ | Predicted output for acceleration |
| `audio` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L29) | ❌ | Audio output config |
| `modalities` | [array](https://github.com/unifai/unifai/blob/main/core/schemas/chatcompletions.go#L30) | ❌ | Response modalities (text, audio) |

---

- **Reasoning:** OpenAI supports `reasoning.effort` (`minimal`, `low`, `medium`, `high`) and `reasoning.max_tokens` - both passed through directly. When routing to other providers, `"minimal"` effort is converted to `"low"` for compatibility. See [UnifAI reasoning docs](/providers/reasoning).
...
- **Streaming:** Server-Sent Events format with `delta.content`, `delta.tool_calls`, `finish_reason`, and `usage` (final chunk only, automatically included by UnifAI). `stream_options: { include_usage: true }` is set by default for all streaming calls.
...
|-----------|------|----------|-------|
| `model` | string | ✅ | Model identifier |
| `input` | string/[array](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L40) | ✅ | Text or [`ContentBlock`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L500) array ([docs](https://platform.openai.com/docs/api-reference/responses/create#responses-create-input)) |
...
| `metadata` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L94) | ❌ | Custom metadata |
| `parallel_tool_calls` | bool | ❌ | Allow multiple simultaneous tool calls |
| `previous_response_id` | string | ❌ | ID of previous response to continue from |
| `prompt_cache_key` | string | ❌ | Prompt caching key |
| `reasoning` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L238) | ❌ | [`ResponsesParametersReasoning`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L238) configuration ([UnifAI docs](/providers/reasoning)) |
| `safety_identifier` | string | ❌ | Safety identifier for content filtering |
| `service_tier` | string | ❌ | Service tier for the request |
| `stream_options` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L116) | ❌ | [`ResponsesStreamOptions`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L116) configuration |
| `store` | bool | ❌ | Store the response for later retrieval |
| `temperature` | float | ❌ | Sampling temperature |
| `text` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L120) | ❌ | [`ResponsesTextConfig`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L120) for output formatting |
| `top_logprobs` | int | ❌ | Number of log probabilities to return per token |
| `top_p` | float | ❌ | Nucleus sampling parameter |
| `tool_choice` | string/[object](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L969) | ❌ | [`ResponsesToolChoice`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L969) strategy |
| `tools` | [array](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L1050) | ❌ | [`ResponsesTool`](https://github.com/unifai/unifai/blob/main/core/schemas/responses.go#L1050) objects ([docs](https://platform.openai.com/docs/api-reference/responses/create#responses-create-tools)) |
...
This conversion ensures compatibility across different model architectures for the structured Responses API. See [UnifAI reasoning docs](/providers/reasoning) for detailed reasoning handling.
...
|-----------|------|----------|-------|
| `model` | string | ✅ | Model identifier |
| `input` | string/[array](https://github.com/unifai/unifai/blob/main/core/schemas/embedding.go#L12) | ✅ | Text(s) to embed ([docs](https://platform.openai.com/docs/api-reference/embeddings/create#embeddings-create-input)) |
...
- No streaming support. Returns [`embedding`](https://github.com/unifai/unifai/blob/main/core/schemas/embedding.go#L30) array with usage counts.
...
- **Model & Prompt**: `unifaiReq.Model` → `req.Model`, `unifaiReq.Prompt` → `req.Prompt`
- **Parameters**: All fields from `unifaiReq` (`ImageGenerationParameters`) are embedded directly into the OpenAI request struct via struct embedding. No field mapping or transformation is performed.
- **Streaming**: When streaming is requested, `stream: true` is set in the request body.

**Response Conversion**

- **Non-streaming**: OpenAI responses are unmarshaled directly into `UnifAIImageGenerationResponse` since UnifAI's response schema is a superset of OpenAI's format. All fields are passed through as-is.
- **Streaming**: OpenAI streaming responses use Server-Sent Events (SSE) format with event types:
  ...
  UnifAI converts these to `UnifAIImageGenerationStreamResponse` chunks with:
...
- **Model & Input**: `unifaiReq.Model` → `req.Model`, `unifaiReq.Input.Images` → `req.Input.Images`, `unifaiReq.Input.Prompt` → `req.Input.Prompt`
- **Parameters**: All fields from `unifaiReq.Params` (`ImageEditParameters`) are embedded directly into the OpenAI request struct via struct embedding. No field mapping or transformation is performed.
...
- **Model & Input**: `unifaiReq.Model` → `req.Model`, `unifaiReq.Input.Image.Image` → `req.Input.Image.Image`
- **Parameters**: All fields from `unifaiReq.Params` (`ImageVariationParameters`) are embedded directly into the OpenAI request struct via struct embedding. No field mapping or transformation is performed.
- **Multipart Form Data**: The request is serialized as `multipart/form-data`:
...
- **Non-streaming**: OpenAI responses are unmarshaled directly into `UnifAIImageVariationResponse` (which is a type alias for `UnifAIImageGenerationResponse`). All fields are passed through as-is.
...
Response: [`FileObject`](https://github.com/unifai/unifai/blob/main/core/schemas/files.go#L40) with `id`, `bytes`, `created_at`, `filename`, `purpose`, `status` ([docs](https://platform.openai.com/docs/api-reference/files/create))
...
| `requests` | [array](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L75) | Conditional | [`BatchRequestItem`](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L31) objects (converted to JSONL) |
| `endpoint` | string | ✅ | Target endpoint (e.g., /v1/chat/completions) |
| `completion_window` | string | ❌ | 24h (default) |
| `metadata` | [object](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L89) | ❌ | Custom metadata |

**Response:** [`UnifAIBatchCreateResponse`](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L91) with `id`, `endpoint`, `input_file_id`, `status`, `created_at`, `request_counts` ([docs](https://platform.openai.com/docs/api-reference/batch/create)). Statuses: [`BatchStatus`](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L5) (validating, failed, in_progress, finalizing, completed, expired, cancelling, cancelled)
...
Operations:
- GET `/v1/batches/{batch_id}` - Get batch [`UnifAIBatchRetrieveResponse`](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L167) ([docs](https://platform.openai.com/docs/api-reference/batch/retrieve))
...
3. Parse JSONL - each [`BatchResultItem`](https://github.com/unifai/unifai/blob/main/core/schemas/batch.go#L254): `{id, custom_id, response: {status_code, body}}`

---

# 12. List Models

GET `/v1/models` - Lists available models with metadata. Model IDs in UnifAI responses are prefixed with `openai/` (e.g., `openai/gpt-4o`). Results are aggregated from all configured API keys. No request body or parameters required.
...
**Response**: [`UnifAIVideoGenerationResponse`](https://github.com/unifai/unifai/blob/main/core/schemas/videos.go) - `id`, `status`, `model`, `prompt`, `created_at`
...
| `fallbacks` | array | ❌ | UnifAI fallback model list. |
