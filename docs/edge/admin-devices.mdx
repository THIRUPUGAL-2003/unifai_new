---
title: "Devices"
description: "View the machines running UnifAI Edge, who they belong to, and the AI apps and MCP servers installed on each."
icon: "laptop"
---
...
<Frame>
  <img src="/media/edge/edge-devices-view.png" alt="UnifAI Edge devices dashboard listing machines across the fleet" />
</Frame>
