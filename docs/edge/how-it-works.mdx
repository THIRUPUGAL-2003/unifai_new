...
description: "The UnifAI Edge experience from a user's point of view: one browser sign-in, an always-on menu-bar agent, and every AI request routed through UnifAI automatically."
icon: "route"
---

UnifAI Edge is designed to be invisible. After a one-time sign-in, users keep using the AI tools they already have - Claude Desktop, ChatGPT, Cursor, coding agents in the terminal - and Edge quietly routes that traffic through your UnifAI in the background. There is no proxy to configure, no base URL to change, and nothing to remember.
...
<Frame>
  <img src="/media/edge/edge-agent.png" alt="UnifAI Edge menu-bar status and controls" />
</Frame>
...
<Frame>
  <img src="/media/edge/edge-app-usage.png" alt="UnifAI Edge showing AI traffic routed and governed" />
</Frame>
