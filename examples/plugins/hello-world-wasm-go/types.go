...
type PreHookInput struct {
	Context map[string]interface{}  `json:"context"`
	Request *schemas.UnifAIRequest `json:"request,omitempty"` // Keep raw for pass-through
}

// PreHookOutput is the output for pre_hook
type PreHookOutput struct {
	Context         map[string]interface{}      `json:"context"`
	Request         *schemas.UnifAIRequest     `json:"request,omitempty"`
...
type PostHookInput struct {
	Context  map[string]interface{}   `json:"context"`
	Response *schemas.UnifAIResponse `json:"response,omitempty"`
	Error    *schemas.UnifAIError    `json:"error,omitempty"`
...
type HTTPStreamChunkHookInput struct {
	Context map[string]interface{}     `json:"context"`
	Request *schemas.HTTPRequest       `json:"request,omitempty"`
	Chunk   *schemas.UnifAIStreamChunk `json:"chunk,omitempty"`
}
