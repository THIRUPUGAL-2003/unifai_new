...
A minimal example of a UnifAI plugin written in Go and compiled to WebAssembly using TinyGo.
...
**PostLLMHook Input:**
- `ctx`: Context JSON
- `resp`: UnifAI response JSON
- `err`: UnifAI error JSON (or null)
