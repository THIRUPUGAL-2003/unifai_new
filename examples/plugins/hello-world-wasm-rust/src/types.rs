//! Type definitions for UnifAI WASM plugins.
...
mod nullable {
    ...
    /// Deserialize a UnifAIContext that may be null, converting null to default.
    pub fn context<'de, D>(deserializer: D) -> Result<super::UnifAIContext, D::Error>
    where
        D: Deserializer<'de>,
    {
        Option::<super::UnifAIContext>::deserialize(deserializer).map(|opt| opt.unwrap_or_default())
    }
}
...
/// UnifAIContext holds request-scoped values passed between hooks.
...
#[serde(transparent)]
pub struct UnifAIContext(pub HashMap<String, serde_json::Value>);
...
// =============================================================================
// Chat Completion Structures (UnifAIRequest)
// =============================================================================
...
/// UnifAIChatRequest represents a chat completion request.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct UnifAIChatRequest {
    #[serde(default)]
    pub provider: String,
...
/// UnifAIRequest is the unified request structure.
/// Only one of the request types should be present.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct UnifAIRequest {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chat_request: Option<UnifAIChatRequest>,
...
// =============================================================================
// Response Structures (UnifAIResponse)
// =============================================================================
...
/// UnifAIChatResponse represents a chat completion response.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct UnifAIChatResponse {
    #[serde(default)]
    pub id: String,
...
/// UnifAIResponse is the unified response structure.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct UnifAIResponse {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chat_response: Option<UnifAIChatResponse>,
...
/// UnifAIError represents an error response.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct UnifAIError {
    #[serde(default)]
...
pub struct LLMPluginShortCircuit {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response: Option<UnifAIResponse>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub error: Option<UnifAIError>,
}
...
impl PreHookInput {
    /// Parse the request as a UnifAIRequest
    pub fn parse_request(&self) -> Option<UnifAIRequest> {
...
impl PostHookInput {
    /// Parse the response as a UnifAIResponse
    pub fn parse_response(&self) -> Option<UnifAIResponse> {
        serde_json::from_value(self.response.clone()).ok()
    }

    /// Parse the error as a UnifAIError
    pub fn parse_error(&self) -> Option<UnifAIError> {
        if self.has_error {
...
pub struct HTTPStreamChunkHookInput {
    ...
    #[serde(default)]
    pub chunk: serde_json::Value, // UnifAIStreamChunk as JSON
}
...
pub struct HTTPStreamChunkHookOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chunk: Option<serde_json::Value>, // UnifAIStreamChunk as JSON, None to skip
...
mod tests {
    ...
    fn test_context_deserialization() {
        ...
        let ctx: UnifAIContext = serde_json::from_str(json).unwrap();
    ...
    #[test]
    fn test_unifai_error() {
        let error = UnifAIError::new("Test error")
            .with_type("test_type")
            .with_code("500")
            .with_status(500);
