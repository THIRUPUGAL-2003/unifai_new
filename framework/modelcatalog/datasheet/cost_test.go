...
func chatPricing(input, output float64) configstoreTables.TableModelPricing {
	return configstoreTables.TableModelPricing{
		...
		Mode:               "chat",
		InputCostPerToken:  unifai.Ptr(input),
		OutputCostPerToken: unifai.Ptr(output),
	}
}
...
// routingInfoFor builds a minimal RoutingInfo populated by core.unifai for a
...
// makeChatResponse builds a minimal UnifAIResponse for a chat completion.
func makeChatResponse(provider schemas.ModelProvider, model string, usage *schemas.UnifAILLMUsage) *schemas.UnifAIResponse {
...
// makeEmbeddingResponse builds a minimal UnifAIResponse for an embedding request.
func makeEmbeddingResponse(provider schemas.ModelProvider, model string, usage *schemas.UnifAILLMUsage) *schemas.UnifAIResponse {
	return &schemas.UnifAIResponse{
...
// makeRerankResponse builds a minimal UnifAIResponse for a rerank request.
func makeRerankResponse(provider schemas.ModelProvider, model string, usage *schemas.UnifAILLMUsage) *schemas.UnifAIResponse {
	return &schemas.UnifAIResponse{
...
// makeImageResponse builds a minimal UnifAIResponse for an image generation request.
func makeImageResponse(provider schemas.ModelProvider, model string, usage *schemas.ImageUsage) *schemas.UnifAIResponse {
	return &schemas.UnifAIResponse{
...
func TestComputeTextCost_WithCachedPromptTokens(t *testing.T) {
	...
	p.CacheReadInputTokenCost = unifai.Ptr(0.0000003)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000375)
...
func TestComputeTextCost_FastMode(t *testing.T) {
	...
	p.InputCostPerTokenFast = unifai.Ptr(0.00001)
	p.OutputCostPerTokenFast = unifai.Ptr(0.00005)
...
func TestComputeTextCost_FastMode_FlatAcrossContextWindow(t *testing.T) {
	...
	p.InputCostPerTokenFast = unifai.Ptr(0.00001)
	p.OutputCostPerTokenFast = unifai.Ptr(0.00005)
	p.InputCostPerTokenAbove200kTokens = unifai.Ptr(0.0000075)
	p.OutputCostPerTokenAbove200kTokens = unifai.Ptr(0.0000375)
...
func TestComputeTextCost_FastMode_CacheBillsAtStandardRates(t *testing.T) {
	...
	p.InputCostPerTokenFast = unifai.Ptr(0.00001)
	p.OutputCostPerTokenFast = unifai.Ptr(0.00005)
	p.CacheReadInputTokenCost = unifai.Ptr(0.0000005)      // standard read
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000625) // standard 5m write
...
func TestTierFromResponse_Speed(t *testing.T) {
	...
	assert.False(t, tierFromResponse(nil, unifai.Ptr("standard")).isFast)
	assert.True(t, tierFromResponse(nil, unifai.Ptr("fast")).isFast)
}
...
func TestComputeTextCost_With1hrCacheCreationTokens(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.CacheReadInputTokenCost = unifai.Ptr(3e-7)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove1hr = unifai.Ptr(0.0000075)
...
func TestComputeTextCost_1hrCacheCreationFallsBackToStandardWhenAbove1hrRateAbsent(t *testing.T) {
	...
	p.CacheReadInputTokenCost = unifai.Ptr(8e-8)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.000001)
...
func TestComputeTextCost_CacheWriteTokenDetailsNil_FallsBackToStandardCreationRate(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove1hr = unifai.Ptr(0.0000075) // present but must not be used
...
func TestComputeTextCost_1hrCacheCreationAbove200k_UsesAbove1hrAbove200kRate(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.InputCostPerTokenAbove200kTokens = unifai.Ptr(0.000006)
	p.OutputCostPerTokenAbove200kTokens = unifai.Ptr(0.00003)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove200kTokens = unifai.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hr = unifai.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hrAbove200kTokens = unifai.Ptr(0.000015)
...
func TestComputeTextCost_1hrCacheCreationAbove200k_FallsBackToAbove1hrWhenAbove200kRateAbsent(t *testing.T) {
	...
	p.CacheCreationInputTokenCost = unifai.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove200kTokens = unifai.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hr = unifai.Ptr(0.000009) // distinct from above_200k to make fallback unambiguous
...
func TestComputeTextCost_1hrCacheCreationAbove200k_FallsBackToStandardAbove200kWhenNo1hrRates(t *testing.T) {
	...
	p := chatPricing(8e-7, 0.000004)
	p.InputCostPerTokenAbove200kTokens = unifai.Ptr(0.0000016)
	p.OutputCostPerTokenAbove200kTokens = unifai.Ptr(0.000008)
	p.CacheCreationInputTokenCost = unifai.Ptr(0.000001)
	p.CacheCreationInputTokenCostAbove200kTokens = unifai.Ptr(0.000002)
...
func TestComputeTextCost_SearchQueryCost(t *testing.T) {
	p := chatPricing(0.000003, 0.000015)
	p.SearchContextCostPerQuery = unifai.Ptr(0.01) // $0.01 per search query
...
func TestComputeEmbeddingCost_Basic(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  unifai.Ptr(0.0000001),
		OutputCostPerToken: unifai.Ptr(0.0),
	}
	usage := &schemas.UnifAILLMUsage{
		PromptTokens: 5000,
		TotalTokens:  5000,
...
func TestComputeRerankCost_Basic(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  unifai.Ptr(0.000001),
		OutputCostPerToken: unifai.Ptr(0.000002),
	}
	usage := &schemas.UnifAILLMUsage{
		PromptTokens:     2000,
...
func TestComputeRerankCost_WithSearchCost(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:         unifai.Ptr(0.0),
		OutputCostPerToken:        unifai.Ptr(0.0),
		SearchContextCostPerQuery: unifai.Ptr(0.001),
	}
	numQueries := 5
	usage := &schemas.UnifAILLMUsage{
		CompletionTokensDetails: &schemas.ChatCompletionTokensDetails{
...
func TestComputeSpeechCost_TokensPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   unifai.Ptr(0.0000025),
		OutputCostPerToken:  unifai.Ptr(0.00001),
		OutputCostPerSecond: unifai.Ptr(0.00025),
	}
	seconds := 60
	usage := &schemas.UnifAILLMUsage{
		PromptTokens:     100,
...
func TestComputeSpeechCost_OutputFallsBackToPerSecond(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   unifai.Ptr(0.000001),
		OutputCostPerToken:  unifai.Ptr(0.000002),
		OutputCostPerSecond: unifai.Ptr(0.0001),
	}
	seconds := 120
	usage := &schemas.UnifAILLMUsage{PromptTokens: 500}
	cost := computeSpeechCost(&p, usage, &seconds, 0, serviceTier{})
...
func TestComputeSpeechCost_OutputAudioTokenRate(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:       unifai.Ptr(0.000001),
		OutputCostPerToken:      unifai.Ptr(0.000002),
		OutputCostPerAudioToken: unifai.Ptr(0.00005),
	}
	usage := &schemas.UnifAILLMUsage{
		PromptTokens:     200,
		CompletionTokens: 100,
...
func TestComputeTranscriptionCost_DurationBased(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  unifai.Ptr(0.0),
		OutputCostPerToken: unifai.Ptr(0.0),
		InputCostPerSecond: unifai.Ptr(0.00010278),
	}
...
func TestComputeTranscriptionCost_AudioTokenDetails(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:      unifai.Ptr(0.000005),
		OutputCostPerToken:     unifai.Ptr(0.000015),
		InputCostPerAudioToken: unifai.Ptr(0.00001),
	}
	usage := &schemas.UnifAILLMUsage{
		PromptTokens:     2000,
		CompletionTokens: 500,
...
func TestComputeTranscriptionCost_TokenDetailsPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:          unifai.Ptr(0.000005),
		OutputCostPerToken:         unifai.Ptr(0.0),
		InputCostPerAudioPerSecond: unifai.Ptr(0.0001),
		InputCostPerAudioToken:     unifai.Ptr(0.00001),
	}
	seconds := 60
	audioDetails := &schemas.TranscriptionUsageInputTokenDetails{
...
func TestComputeImageCost_PerImage(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  unifai.Ptr(0.0),
		OutputCostPerToken: unifai.Ptr(0.0),
		OutputCostPerImage: unifai.Ptr(0.052),
	}
...
func TestComputeImageCost_InputAndOutputPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerImage:  unifai.Ptr(0.01),
		OutputCostPerImage: unifai.Ptr(0.05),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      3,
...
func TestComputeImageCost_PerPixelOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: unifai.Ptr(0.000000019), // ~$0.02 for 1024x1024
	}
	usage := &schemas.ImageUsage{
...
func TestComputeImageCost_PerPixelInputAndOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerPixel:  unifai.Ptr(0.00000001),
		OutputCostPerPixel: unifai.Ptr(0.00000002),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      2,
...
func TestComputeImageCost_PixelsPreferredOverPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: unifai.Ptr(0.00000002),
		OutputCostPerImage: unifai.Ptr(999.0), // should not be used
	}
	usage := &schemas.ImageUsage{
		OutputTokensDetails: &schemas.ImageTokenDetails{NImages: 1},
	}
...
func TestComputeImageCost_QualityBasedRates(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		OutputCostPerImage:              unifai.Ptr(0.01),
		OutputCostPerImageLowQuality:    unifai.Ptr(0.02),
		OutputCostPerImageMediumQuality: unifai.Ptr(0.03),
		OutputCostPerImageHighQuality:   unifai.Ptr(0.04),
		OutputCostPerImageAutoQuality:   unifai.Ptr(0.05),
	}
...
func TestComputeVideoCost_DurationBased(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:           unifai.Ptr(0.000001),
		OutputCostPerToken:          unifai.Ptr(0.0),
		OutputCostPerVideoPerSecond: unifai.Ptr(0.001),
	}
	seconds := 30
	usage := &schemas.UnifAILLMUsage{PromptTokens: 500, TotalTokens: 500}
...
func TestComputeVideoCost_OutputCostPerSecondFallback(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   unifai.Ptr(0.0),
		OutputCostPerToken:  unifai.Ptr(0.0),
		OutputCostPerSecond: unifai.Ptr(0.002),
	}
	seconds := 10
...
func TestComputeVideoCost_NilSeconds(t *testing.T) {
	...
	usage := &schemas.UnifAILLMUsage{PromptTokens: 1000}
...
func TestTieredInputRate_BelowThreshold(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:                unifai.Ptr(0.000003),
		InputCostPerTokenAbove200kTokens: unifai.Ptr(0.000006),
	}
...
func TestTieredOutputRate_AboveThreshold(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerToken:                unifai.Ptr(0.000015),
		OutputCostPerTokenAbove200kTokens: unifai.Ptr(0.00003),
	}
...
func TestExtractCostInput_ChatResponse(t *testing.T) {
	usage := &schemas.UnifAILLMUsage{PromptTokens: 100, CompletionTokens: 50, TotalTokens: 150}
	resp := &schemas.UnifAIResponse{
		ChatResponse: &schemas.UnifAIChatResponse{Usage: usage},
	}
...
func TestExtractCostInput_EmbeddingResponse(t *testing.T) {
	usage := &schemas.UnifAILLMUsage{PromptTokens: 200, TotalTokens: 200}
	resp := &schemas.UnifAIResponse{
		EmbeddingResponse: &schemas.UnifAIEmbeddingResponse{Usage: usage},
	}
	input := extractCostInput(resp)
	require.NotNil(t, input.usage)
...
func TestExtractCostInput_ImageResponse(t *testing.T) {
	...
	resp := &schemas.UnifAIResponse{
		ImageGenerationResponse: &schemas.UnifAIImageGenerationResponse{Usage: imgUsage},
	}
	input := extractCostInput(resp)
	...
	resp := &schemas.UnifAIResponse{
		TranscriptionResponse: &schemas.UnifAITranscriptionResponse{
			Usage: &schemas.TranscriptionUsage{
				Seconds:      &sec,
				InputTokens:  unifai.Ptr(1000),
				OutputTokens: unifai.Ptr(200),
				TotalTokens:  unifai.Ptr(1200),
			},
		},
	}
	input := extractCostInput(resp)
...
func TestCalculateCost_SemanticCacheDirectHit(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken: unifai.Ptr(0.000005), OutputCostPerToken: unifai.Ptr(0.000015),
		},
	})
...
func TestCalculateCost_SemanticCacheSemanticHit(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("text-embedding-3-small", "openai", "embedding"): {
			...
			InputCostPerToken: unifai.Ptr(0.00000002),
		},
	})
...
func TestCalculateCost_ProviderComputedCostPassthrough(t *testing.T) {
	...
	resp := makeChatResponse(schemas.OpenAI, "gpt-4o", &schemas.UnifAILLMUsage{
		PromptTokens:     1000,
		CompletionTokens: 500,
		TotalTokens:      1500,
		Cost: &schemas.UnifAICost{
...
func TestCalculateCost_ChatCompletion_GPT4o(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken:       unifai.Ptr(0.000005),
			OutputCostPerToken:      unifai.Ptr(0.000015),
			CacheReadInputTokenCost: unifai.Ptr(0.0000005),
		},
	})
...
func TestCalculateCost_ChatCompletion_Claude35Sonnet_WithCache(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20241022-v2:0", "bedrock", "chat"): {
			...
			InputCostPerToken:                 unifai.Ptr(0.000003),
			OutputCostPerToken:                unifai.Ptr(0.000015),
			CacheReadInputTokenCost:           unifai.Ptr(0.0000003),
			CacheCreationInputTokenCost:       unifai.Ptr(0.00000375),
			InputCostPerTokenAbove200kTokens:  unifai.Ptr(0.000006),
			OutputCostPerTokenAbove200kTokens: unifai.Ptr(0.00003),
		},
	})

	resp := makeChatResponse(schemas.Bedrock, "anthropic.claude-3-5-sonnet-20241022-v2:0", &schemas.UnifAILLMUsage{
		PromptTokens:     5000,
		CompletionTokens: 1000,
		TotalTokens:      6000,
		PromptTokensDetails: &schemas.ChatPromptTokensDetails{
...
func TestCalculateCost_Embedding(t *testing.T) {
	...
	resp := makeEmbeddingResponse(schemas.Bedrock, "amazon.titan-embed-text-v1", &schemas.UnifAILLMUsage{
		PromptTokens: 10000,
		TotalTokens:  10000,
	})
...
func TestCalculateCost_Rerank(t *testing.T) {
	...
	resp := makeRerankResponse(schemas.Bedrock, "amazon.rerank-v1:0", &schemas.UnifAILLMUsage{
		PromptTokens: 500,
		TotalTokens:  500,
	})
...
func TestCalculateCost_NoPricingData(t *testing.T) {
	s := testStoreWithPricing(nil)
	resp := makeChatResponse(schemas.OpenAI, "unknown-model", &schemas.UnifAILLMUsage{
...
func TestGetPricing_GeminiFallsBackToVertex(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gemini-2.0-flash", "vertex", "chat"): {
			...
			InputCostPerToken: unifai.Ptr(0.0000001), OutputCostPerToken: unifai.Ptr(0.0000004),
		},
	})
...
// =========================================================================
// 15. responsesUsageToUnifAIUsage
// =========================================================================

func TestResponsesUsageToUnifAIUsage_Basic(t *testing.T) {
	u := &schemas.ResponsesResponseUsage{
		InputTokens:  100,
		OutputTokens: 50,
		TotalTokens:  150,
	}
	result := responsesUsageToUnifAIUsage(u)
...
func TestResponsesUsageToUnifAIUsage_WithTokenDetails(t *testing.T) {
	numQueries := 2
	u := &schemas.ResponsesResponseUsage{
		InputTokens:  1000,
		OutputTokens: 500,
...
func TestCalculateCost_200kTier_EndToEnd(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20240620-v1:0", "bedrock", "chat"): {
			...
			CacheReadInputTokenCost:                    unifai.Ptr(0.0000003),
			CacheCreationInputTokenCost:                unifai.Ptr(0.00000375),
			CacheReadInputTokenCostAbove200kTokens:     unifai.Ptr(0.0000006),
			CacheCreationInputTokenCostAbove200kTokens: unifai.Ptr(0.0000075),
		},
	})

	resp := makeChatResponse(schemas.Bedrock, "anthropic.claude-3-5-sonnet-20240620-v1:0", &schemas.UnifAILLMUsage{
		PromptTokens:     190000,
...
func TestCalculateCost_272kTier_EndToEnd(t *testing.T) {
	...
	resp := makeChatResponse(schemas.Anthropic, "claude-3-7-sonnet", &schemas.UnifAILLMUsage{
		PromptTokens:     250000,
		CompletionTokens: 30000,
		TotalTokens:      280000, // Above 272k
	})
...
func TestCalculateCost_PriorityTier_EndToEnd(t *testing.T) {
	tier := schemas.UnifAIServiceTierPriority
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			Model:                      "gpt-4o",
			Provider:                   "openai",
...
func TestCalculateCost_NonPriorityServiceTier_UsesBaseRate(t *testing.T) {
	tier := schemas.UnifAIServiceTierAuto
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			Model:                      "gpt-4o",
			Provider:                   "openai",
...
func TestTierFromResponse_Priority(t *testing.T) {
	s := schemas.UnifAIServiceTierPriority
...
func TestTierFromResponse_Flex(t *testing.T) {
	s := schemas.UnifAIServiceTierFlex
	tier := tierFromResponse(&s, nil)
...
func TestTierFromResponse_Default(t *testing.T) {
	for _, s := range []schemas.UnifAIServiceTier{schemas.UnifAIServiceTierAuto, schemas.UnifAIServiceTierDefault, ""} {
		tier := tierFromResponse(&s, nil)
...
func TestCalculateCost_FlexTier_EndToEnd(t *testing.T) {
	tier := schemas.UnifAIServiceTierFlex
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			Model:                  "gpt-4o",
			Provider:               "openai",
...
func TestCalculateCost_AllCachedTokens(t *testing.T) {
	...
	p := chatPricing(0.000005, 0.000015)
	p.CacheReadInputTokenCost = unifai.Ptr(0.0000005)
...
func TestCalculateCost_ImageGeneration_NilUsage_PerImagePricing(t *testing.T) {
	...
	pricing := configstoreTables.TableModelPricing{
		...
		InputCostPerToken:  unifai.Ptr(0.0),
		OutputCostPerImage: unifai.Ptr(0.04),
	}
...
func TestComputeContainerCreationCost_Basic(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		...
		Provider:                      "openai",
		Mode:                          "chat",
		CodeInterpreterCostPerSession: unifai.Ptr(0.03),
	}
...
func TestCalculateCost_ContainerCreate_NoMemoryLimit(t *testing.T) {
	...
	resp := &schemas.UnifAIResponse{
		ContainerCreateResponse: &schemas.UnifAIContainerCreateResponse{
			ID:   "cntr_abc123",
			Name: "test-container",
			ExtraFields: schemas.UnifAIResponseExtraFields{
...
func TestCalculateCost_ContainerCreate_MemorySpecificEntry(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("container-4g", "openai", "chat"): {
			...
			Provider:                      "openai",
			Mode:                          "chat",
			CodeInterpreterCostPerSession: unifai.Ptr(0.12),
		},
	})
...
func TestCalculateCost_BackCompat_RoutingInfoWinsOverLegacyFields(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("gemini-2.0-flash", "gemini", "chat"): {
			...
			Mode:               "chat",
			InputCostPerToken:  unifai.Ptr(0.0000001),
			OutputCostPerToken: unifai.Ptr(0.0000004),
		},
	})
...
// cost as billing a full UnifAIResponse carrying that usage (the success path),
