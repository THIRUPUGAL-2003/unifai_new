...
// CalculateCost calculates the cost of a UnifAI response.
...
func (s *Store) CalculateCost(result *schemas.UnifAIResponse, scopes *LookupScopes) float64 {
	if result == nil {
		return 0
	}
...
// provider / model / request type, for cases where no full UnifAIResponse
// exists. The primary use is billing partial usage carried on a failed or
// cancelled request via UnifAIError.ExtraFields.BilledUsage: the
...
func (s *Store) CalculateCostForUsage(usage *schemas.UnifAILLMUsage, provider schemas.ModelProvider, model string, requestType schemas.RequestType, scopes *LookupScopes) float64 {
	if usage == nil {
		return 0
	}
...
func (s *Store) calculateCostWithCache(result *schemas.UnifAIResponse, cacheDebug *schemas.UnifAICacheDebug, scopes LookupScopes) float64 {
...
func (s *Store) computeCacheEmbeddingCost(cacheDebug *schemas.UnifAICacheDebug, scopes LookupScopes) float64 {
...
func (s *Store) calculateBaseCost(result *schemas.UnifAIResponse, scopes LookupScopes) float64 {
	extraFields := result.GetExtraFields()
	if extraFields == nil {
		return 0
	}

	// Read routing info populated by core.unifai at request time.
	//
...
func extractCostInput(result *schemas.UnifAIResponse) costInput {
	var input costInput
	...
	case result.ResponsesResponse != nil && result.ResponsesResponse.Usage != nil:
		input.usage = responsesUsageToUnifAIUsage(result.ResponsesResponse.Usage)
	...
	case result.CompactionResponse != nil && result.CompactionResponse.Usage != nil:
		input.usage = responsesUsageToUnifAIUsage(result.CompactionResponse.Usage)

	case result.ResponsesStreamResponse != nil && result.ResponsesStreamResponse.Response != nil && result.ResponsesStreamResponse.Response.Usage != nil:
		input.usage = responsesUsageToUnifAIUsage(result.ResponsesStreamResponse.Response.Usage)
	...
	case result.SpeechResponse != nil && result.SpeechResponse.Usage != nil:
		input.usage = speechUsageToUnifAIUsage(result.SpeechResponse.Usage)
	...
	case result.SpeechStreamResponse != nil && result.SpeechStreamResponse.Usage != nil:
		input.usage = speechUsageToUnifAIUsage(result.SpeechStreamResponse.Usage)
	...
	case result.ImageGenerationResponse != nil:
		...
		// and we must not mutate the caller's UnifAIResponse during what is
...
func responsesUsageToUnifAIUsage(u *schemas.ResponsesResponseUsage) *schemas.UnifAILLMUsage {
...
func speechUsageToUnifAIUsage(u *schemas.SpeechUsage) *schemas.UnifAILLMUsage {
...
func extractTranscriptionUsage(u *schemas.TranscriptionUsage) (*schemas.UnifAILLMUsage, *int, *schemas.TranscriptionUsageInputTokenDetails) {
	usage := &schemas.UnifAILLMUsage{}
...
func computeTextCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeEmbeddingCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeRerankCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeSpeechCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, audioSeconds *int, audioTextInputChars int, tier serviceTier) float64 {
...
func computeTranscriptionCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, audioSeconds *int, audioTokenDetails *schemas.TranscriptionUsageInputTokenDetails, tier serviceTier) float64 {
	totalTokens := safeTotalTokens(usage)
...
func computeAudioInputCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, audioSeconds *int, audioTokenDetails *schemas.TranscriptionUsageInputTokenDetails, totalTokens int, tier serviceTier) float64 {
...
func computeAudioOutputCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, audioSeconds *int, totalTokens int, tier serviceTier) float64 {
...
// Input and output are calculated independently — tokens first, then per-second fallback.
func computeVideoCost(pricing *configstoreTables.TableModelPricing, usage *schemas.UnifAILLMUsage, videoSeconds *int, tier serviceTier) float64 {
	totalTokens := safeTotalTokens(usage)
...
func tierFromResponse(s *schemas.UnifAIServiceTier, speed *string) serviceTier {
...
func safeTotalTokens(usage *schemas.UnifAILLMUsage) int {
	if usage == nil {
		return 0
	}
...
// RoutingInfo populated on the response/error by core.unifai at request time.
//
...
func inferPassthroughRequestType(provider schemas.ModelProvider, path string, su *schemas.UnifAIPassthroughUsage) schemas.RequestType {
	if su != nil {
...
// passthroughUsageToCostInput converts UnifAIPassthroughUsage into costInput.
func passthroughUsageToCostInput(su *schemas.UnifAIPassthroughUsage) costInput {
	var input costInput
	if su.LLMUsage != nil {
