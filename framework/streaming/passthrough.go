...
func (a *Accumulator) processPassthroughStreamingResponse(ctx *schemas.UnifAIContext, result *schemas.UnifAIResponse, unifaiErr *schemas.UnifAIError) (*ProcessedStreamResponse, error) {
	...
	passthroughResp := &schemas.UnifAIPassthroughResponse{
