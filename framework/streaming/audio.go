...
func (a *Accumulator) buildCompleteMessageFromAudioStreamChunks(chunks []*AudioStreamChunk) *schemas.UnifAISpeechResponse {
	completeMessage := &schemas.UnifAISpeechResponse{}
...
func (a *Accumulator) processAccumulatedAudioStreamingChunks(requestID string, unifaiErr *schemas.UnifAIError, isFinalChunk bool) (*AccumulatedData, error) {
...
func (a *Accumulator) processAudioStreamingResponse(ctx *schemas.UnifAIContext, result *schemas.UnifAIResponse, unifaiErr *schemas.UnifAIError) (*ProcessedStreamResponse, error) {
	...
	if unifaiErr != nil {
		...
		newDelta := &schemas.UnifAISpeechStreamResponse{
		...
		if result.SpeechStreamResponse.ExtraFields.RawResponse != nil {
			chunk.RawResponse = unifai.Ptr(fmt.Sprintf("%v", result.SpeechStreamResponse.ExtraFields.RawResponse))
		}
	...
	if isFinalChunk {
		...
		data, processErr := a.processAccumulatedAudioStreamingChunks(requestID, unifaiErr, isFinalChunk)
		if processErr != nil {
