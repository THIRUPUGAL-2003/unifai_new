...
func TestPopulateResponsesResponseAttributesSerializesMetadataAsJSON(t *testing.T) {
	...
	PopulateResponsesResponseAttributes(&schemas.UnifAIResponsesResponse{
...
func TestPopulateTextCompletionRequestAttributesSerializesLogitBiasAsJSON(t *testing.T) {
	...
	PopulateTextCompletionRequestAttributes(&schemas.UnifAITextCompletionRequest{
...
func TestPopulateBatchCreateRequestAttributesSerializesMetadataAsJSON(t *testing.T) {
	...
	PopulateBatchCreateRequestAttributes(&schemas.UnifAIBatchCreateRequest{
	...
	tests := []struct {
	...
	}{
		{
			...
			populate: func(attrs map[string]any) {
				PopulateChatRequestAttributes(&schemas.UnifAIChatRequest{
		...
		},
		{
			name: "embedding",
			populate: func(attrs map[string]any) {
				PopulateEmbeddingRequestAttributes(&schemas.UnifAIEmbeddingRequest{
		...
		},
		{
			name: "batch",
			populate: func(attrs map[string]any) {
				PopulateBatchListRequestAttributes(&schemas.UnifAIBatchListRequest{
					ExtraParams: map[string]any{
		...
		},
		{
			name: "file",
			populate: func(attrs map[string]any) {
				PopulateFileListRequestAttributes(&schemas.UnifAIFileListRequest{
					ExtraParams: map[string]any{
