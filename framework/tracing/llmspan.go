// Package tracing provides distributed tracing utilities for UnifAI.
package tracing
...
// PopulateRequestAttributes extracts common request attributes from a UnifAIRequest.
// This is the main entry point for populating request attributes on a span.
func PopulateRequestAttributes(req *schemas.UnifAIRequest) map[string]any {
	...
	attrs[schemas.AttrUnifAIProviderName] = string(provider) // raw UnifAI short name, mirrors canonical gen_ai.provider.name
...
// PopulateResponseAttributes extracts common response attributes from a UnifAIResponse.
// This is the main entry point for populating response attributes on a span.
func PopulateResponseAttributes(resp *schemas.UnifAIResponse) map[string]any {
	attrs := make(map[string]any)
	if resp == nil {
		return attrs
	}
...
// PopulateErrorAttributes extracts error attributes from a UnifAIError.
func PopulateErrorAttributes(err *schemas.UnifAIError) map[string]any {
	attrs := make(map[string]any)
...
func PopulateContextAttributes(
	...
	if virtualKeyID != "" {
		attrs[schemas.AttrVirtualKeyID] = virtualKeyID     // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrVirtualKeyName] = virtualKeyName // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAIVirtualKeyID] = virtualKeyID
		attrs[schemas.AttrUnifAIVirtualKeyName] = virtualKeyName
	}
	if selectedKeyID != "" {
		attrs[schemas.AttrSelectedKeyID] = selectedKeyID     // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrSelectedKeyName] = selectedKeyName // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAISelectedKeyID] = selectedKeyID
		attrs[schemas.AttrUnifAISelectedKeyName] = selectedKeyName
	}
	if routingRuleID != "" {
		attrs[schemas.AttrRoutingRuleID] = routingRuleID     // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrRoutingRuleName] = routingRuleName // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAIRoutingRuleID] = routingRuleID
		attrs[schemas.AttrUnifAIRoutingRuleName] = routingRuleName
	}
	if teamID != "" {
		attrs[schemas.AttrTeamID] = teamID // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAITeamID] = teamID
	}
	if teamName != "" {
		attrs[schemas.AttrTeamName] = teamName // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAITeamName] = teamName
	}
	if customerID != "" {
		attrs[schemas.AttrCustomerID] = customerID // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAICustomerID] = customerID
	}
	if customerName != "" {
		attrs[schemas.AttrCustomerName] = customerName // legacy: gen_ai.* placement of unifai-internal attr
		attrs[schemas.AttrUnifAICustomerName] = customerName
	}
	if businessUnitID != "" {
		attrs[schemas.AttrUnifAIBusinessUnitID] = businessUnitID
	}
	if businessUnitName != "" {
		attrs[schemas.AttrUnifAIBusinessUnitName] = businessUnitName
	}
	if userID != "" {
		attrs[schemas.AttrUnifAIUserID] = userID
	}
	if userName != "" {
		attrs[schemas.AttrUnifAIUserName] = userName
	}
	attrs[schemas.AttrNumberOfRetries] = numberOfRetries // legacy: gen_ai.* placement of unifai-internal attr
	attrs[schemas.AttrFallbackIndex] = fallbackIndex     // legacy: gen_ai.* placement of unifai-internal attr
	attrs[schemas.AttrUnifAIRetries] = numberOfRetries
	attrs[schemas.AttrUnifAIFallbackIndex] = fallbackIndex
}
...
func PopulateChatRequestAttributes(req *schemas.UnifAIChatRequest, attrs map[string]any) {
	if req == nil {
		return
	}
	...
	if req.Params != nil {
		...
		if req.Params.Stop != nil {
			...
			attrs[schemas.AttrUnifAIStopSequencesJoined] = strings.Join(req.Params.Stop, ",") // legacy: comma-joined back-compat for dashboards predating the []string fix
		}
...
func PopulateChatResponseAttributes(resp *schemas.UnifAIChatResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateTextCompletionRequestAttributes(req *schemas.UnifAITextCompletionRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateTextCompletionResponseAttributes(resp *schemas.UnifAITextCompletionResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateEmbeddingRequestAttributes(req *schemas.UnifAIEmbeddingRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateEmbeddingResponseAttributes(resp *schemas.UnifAIEmbeddingResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
	// Usage
...
func PopulateTranscriptionRequestAttributes(req *schemas.UnifAITranscriptionRequest, attrs map[string]any) {
...
func PopulateTranscriptionResponseAttributes(resp *schemas.UnifAITranscriptionResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateSpeechRequestAttributes(req *schemas.UnifAISpeechRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateSpeechResponseAttributes(resp *schemas.UnifAISpeechResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateResponsesRequestAttributes(req *schemas.UnifAIResponsesRequest, attrs map[string]any) {
	if req == nil || req.Params == nil {
		return
	}
...
func PopulateResponsesResponseAttributes(resp *schemas.UnifAIResponsesResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateBatchCreateRequestAttributes(req *schemas.UnifAIBatchCreateRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateBatchListRequestAttributes(req *schemas.UnifAIBatchListRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateBatchRetrieveRequestAttributes(req *schemas.UnifAIBatchRetrieveRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateBatchCancelRequestAttributes(req *schemas.UnifAIBatchCancelRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateBatchResultsRequestAttributes(req *schemas.UnifAIBatchResultsRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateBatchCreateResponseAttributes(resp *schemas.UnifAIBatchCreateResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateBatchListResponseAttributes(resp *schemas.UnifAIBatchListResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateBatchRetrieveResponseAttributes(resp *schemas.UnifAIBatchRetrieveResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateBatchCancelResponseAttributes(resp *schemas.UnifAIBatchCancelResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateBatchResultsResponseAttributes(resp *schemas.UnifAIBatchResultsResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateFileUploadRequestAttributes(req *schemas.UnifAIFileUploadRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateFileListRequestAttributes(req *schemas.UnifAIFileListRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateFileRetrieveRequestAttributes(req *schemas.UnifAIFileRetrieveRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateFileDeleteRequestAttributes(req *schemas.UnifAIFileDeleteRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateFileContentRequestAttributes(req *schemas.UnifAIFileContentRequest, attrs map[string]any) {
	if req == nil {
		return
	}
...
func PopulateFileUploadResponseAttributes(resp *schemas.UnifAIFileUploadResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateFileListResponseAttributes(resp *schemas.UnifAIFileListResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateFileRetrieveResponseAttributes(resp *schemas.UnifAIFileRetrieveResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateFileDeleteResponseAttributes(resp *schemas.UnifAIFileDeleteResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func PopulateFileContentResponseAttributes(resp *schemas.UnifAIFileContentResponse, attrs map[string]any) {
	if resp == nil {
		return
	}
...
func extractChatResponseMessages(resp *schemas.UnifAIChatResponse) []MessageSummary {
	if resp == nil {
		return nil
	}
...
func extractResponsesOutputMessages(resp *schemas.UnifAIResponsesResponse) []ResponsesMessageSummary {
	if resp == nil {
		return nil
	}
