...
const (
	// MCPServerAuthModeHeaders accepts header credentials only: x-uf-vk,
	// Authorization: Bearer <vk>, x-api-key, x-uf-mcp-session-id.
...
type OAuth2ServerConfig struct {
	...
	//   - uf_sub liveness check on refresh (VK or user deleted / deactivated →
