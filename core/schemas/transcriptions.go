...
type UnifAITranscriptionRequest struct {
...
func (r *UnifAITranscriptionRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type UnifAITranscriptionResponse struct {
...
func (r *UnifAITranscriptionResponse) BackfillParams(req *UnifAITranscriptionRequest) {
...
// UnifAITranscriptionStreamResponse represents streaming specific fields only
type UnifAITranscriptionStreamResponse struct {
