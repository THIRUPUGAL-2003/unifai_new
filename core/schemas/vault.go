...
const defaultVaultPrefix = "unifai"
...
// VaultPrefixHook returns the configured vault path prefix (e.g. "unifai").
// It is nil in OSS deployments; VaultPrefix() falls back to "unifai".
...
// VaultPrefix returns the configured vault path prefix, defaulting to "unifai".
