...
func TestRealtimeCanonicalEventClassifiers(t *testing.T) {
	...
	transcriptEvent := &UnifAIRealtimeEvent{Type: RTEventInputAudioTransCompleted}
	...
	if IsRealtimeInputTranscriptEvent(&UnifAIRealtimeEvent{Type: RTEventInputAudioTransDelta}) {
