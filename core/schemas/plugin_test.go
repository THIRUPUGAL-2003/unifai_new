...
func TestCaseInsensitiveLookup(t *testing.T) {
	tests := []struct {
		...
		// x-uf-vk header variations
		{
			name:     "x-uf-vk exact match lowercase",
			data:     map[string]string{"x-uf-vk": "sk-uf-test123"},
			key:      "x-uf-vk",
			expected: "sk-uf-test123",
		},
		{
			name:     "x-uf-vk mixed case in map",
			data:     map[string]string{"X-Uf-Vk": "sk-uf-test123"},
			key:      "x-uf-vk",
			expected: "sk-uf-test123",
		},
		{
			name:     "x-uf-vk uppercase in map",
			data:     map[string]string{"X-UF-VK": "sk-uf-test123"},
			key:      "x-uf-vk",
			expected: "sk-uf-test123",
		},
		// authorization header variations
		{
			...
			data:     map[string]string{"authorization": "Bearer sk-uf-test123"},
			key:      "authorization",
			expected: "Bearer sk-uf-test123",
		},
		{
		...
		// x-api-key header variations
		{
			...
			data:     map[string]string{"x-api-key": "sk-uf-apikey123"},
			key:      "x-api-key",
			expected: "sk-uf-apikey123",
		},
		{
		...
		// x-goog-api-key header variations
		{
			...
			data:     map[string]string{"x-goog-api-key": "sk-uf-google123"},
			key:      "x-goog-api-key",
			expected: "sk-uf-google123",
		},
		{
