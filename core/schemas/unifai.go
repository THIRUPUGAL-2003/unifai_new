...
type KeySelector func(ctx *UnifAIContext, keys []Key, providerKey ModelProvider, model string) (Key, error)

// KeyPoolFilter is an optional hook called before key selection to veto keys
// from the available pool.
type KeyPoolFilter func(ctx *UnifAIContext, provider ModelProvider, model string, keys []Key) ([]Key, error)

// UnifAIConfig represents the configuration for initializing a UnifAI instance.
...
type UnifAIConfig struct {
	...
	InitialPoolSize    int           // Initial pool size for sync pools in UnifAI. Higher values will reduce memory allocations but will increase memory usage.
...
// ModelProvider represents the different AI model providers supported by UnifAI.
...
// UnifAIContextKey is a type for context keys used in UnifAI.
type UnifAIContextKey string
...
// stored as a context key. Derived via UnifAIContext.MCPAuthMode().
...
const (
	...
	MCPContextKeyIncludeClients UnifAIContextKey = "mcp-include-clients" // Context key for whitelist client filtering
	MCPContextKeyIncludeTools   UnifAIContextKey = "mcp-include-tools"   // Context key for whitelist tool filtering (Note: toolName should be in "clientName-toolName" format for individual tools, or "clientName-*" for wildcard)

	UnifAIContextKeySelectedKeyID                       UnifAIContextKey = "unifai-selected-key-id"                // string (to store the selected key ID (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeySelectedKeyName                     UnifAIContextKey = "unifai-selected-key-name"              // string (to store the selected key name (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceVirtualKeyID              UnifAIContextKey = "unifai-governance-virtual-key-id"      // string (to store the virtual key ID (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceVirtualKeyName            UnifAIContextKey = "unifai-governance-virtual-key-name"    // string (to store the virtual key name (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceTeamID                    UnifAIContextKey = "unifai-governance-team-id"             // string (to store the team ID (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceTeamName                  UnifAIContextKey = "unifai-governance-team-name"           // string (to store the team name (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceCustomerID                UnifAIContextKey = "unifai-governance-customer-id"         // string (to store the customer ID (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceCustomerName              UnifAIContextKey = "unifai-governance-customer-name"       // string (to store the customer name (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceBusinessUnitID            UnifAIContextKey = "unifai-governance-business-unit-id"    // string (to store the business unit ID (set by enterprise governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceBusinessUnitName          UnifAIContextKey = "unifai-governance-business-unit-name"  // string (to store the business unit name (set by enterprise governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceTeamIDs                   UnifAIContextKey = "unifai-governance-team-ids"            // []string (all teams a user/AP request belongs to; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyGovernanceTeamNames                 UnifAIContextKey = "unifai-governance-team-names"          // []string (display names, aligned with team-ids; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyGovernanceBusinessUnitIDs           UnifAIContextKey = "unifai-governance-business-unit-ids"   // []string (distinct BUs across the user's teams; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyGovernanceBusinessUnitNames         UnifAIContextKey = "unifai-governance-business-unit-names" // []string (display names, aligned with business-unit-ids; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyGovernanceCustomerIDs               UnifAIContextKey = "unifai-governance-customer-ids"        // []string (distinct customers a user/team request belongs to; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyGovernanceCustomerNames             UnifAIContextKey = "unifai-governance-customer-names"      // []string (display names, aligned with customer-ids; set by enterprise governance plugin - DO NOT SET THIS MANUALLY)
	...
	UnifAIContextKeySelectedPromptID                    UnifAIContextKey = "unifai-selected-prompt-id"             // string (id of the selected prompt (set by prompts plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyGovernanceIncludeOnlyKeys           UnifAIContextKey = "unifai-governance-include-only-keys"   // []string (to store the include-only key IDs for provider config routing (set by unifai governance plugin - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyNumberOfRetries                     UnifAIContextKey = "unifai-number-of-retries"              // int (to store the number of retries (set by unifai - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyFallbackIndex                       UnifAIContextKey = "unifai-fallback-index"                 // int (to store the fallback index (set by unifai - DO NOT SET THIS MANUALLY)) 0 for primary, 1 for first fallback, etc.
	UnifAIContextKeyResolvedAlias                       UnifAIContextKey = "unifai-resolved-alias"                 // *ResolvedAlias (set by unifai after key-level alias resolution — providers read this for model_family routing and provider-specific overrides; nil/absent when no alias matched)
	UnifAIContextKeyStreamEndIndicator                  UnifAIContextKey = "unifai-stream-end-indicator"           // bool (set by unifai - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyStreamGated                         UnifAIContextKey = "unifai-stream-gated"                   // bool (set by ctx.PauseStream/ResumeStream/EndStream when a plugin first engages the pause/resume gate; provider helpers use this as a fast-path check to skip Tracer.GateSend on streams that never engage the gate)
	UnifAIContextKeyStreamIdleTimeout                   UnifAIContextKey = "unifai-stream-idle-timeout"            // time.Duration (per-chunk idle timeout for streaming)
	UnifAIContextKeySkipKeySelection                    UnifAIContextKey = "unifai-skip-key-selection"             // bool (will pass an empty key to the provider)
	UnifAIContextKeyExtraHeaders                        UnifAIContextKey = "unifai-extra-headers"                  // map[string][]string
	UnifAIContextKeyURLPath                             UnifAIContextKey = "unifai-extra-url-path"                 // string
	UnifAIContextKeyUseRawRequestBody                   UnifAIContextKey = "unifai-use-raw-request-body"
	UnifAIContextKeyChangeRequestType                   UnifAIContextKey = "unifai-change-request-type"                      // RequestType (set by plugins to trigger request type conversion in core, e.g. text->chat or chat->responses)
	UnifAIContextKeySendBackRawRequest                  UnifAIContextKey = "unifai-send-back-raw-request"                    // bool (per-request override — read by unifai.go, never overwritten)
	UnifAIContextKeySendBackRawResponse                 UnifAIContextKey = "unifai-send-back-raw-response"                   // bool (per-request override — read by unifai.go, never overwritten)
	...
	UnifAIContextKeySkipVirtualKeyUsageTracking         UnifAIContextKey = "unifai-skip-virtual-key-usage-tracking"          // bool (set by governance callers to skip VK usage while preserving VK auth/attribution)
	UnifAIContextKeyTraceID                             UnifAIContextKey = "unifai-trace-id"                                 // string (trace ID for distributed tracing - set by tracing middleware)
	UnifAIContextKeySpanID                              UnifAIContextKey = "unifai-span-id"                                  // string (current span ID for child span creation - set by tracer)
	UnifAIContextKeyParentSpanID                        UnifAIContextKey = "unifai-parent-span-id"                           // string (parent span ID from W3C traceparent header - set by tracing middleware)
	UnifAIContextKeyStreamStartTime                     UnifAIContextKey = "unifai-stream-start-time"                        // time.Time (start time for streaming TTFT calculation - set by unifai)
	UnifAIContextKeyTracer                              UnifAIContextKey = "unifai-tracer"                                   // Tracer (tracer instance for completing deferred spans - set by unifai)
	UnifAIContextKeyDeferTraceCompletion                UnifAIContextKey = "unifai-defer-trace-completion"                   // bool (signals trace completion should be deferred for streaming - set by streaming handlers)
	UnifAIContextKeyTraceCompleter                      UnifAIContextKey = "unifai-trace-completer"                          // func([]PluginLogEntry) (callback to complete trace after streaming, receives transport plugin logs - set by tracing middleware)
	UnifAIContextKeyAccumulatorID                       UnifAIContextKey = "unifai-accumulator-id"                           // string (ID for streaming accumulator lookup - set by tracer for accumulator operations)
	UnifAIContextKeyMCPSessionID                        UnifAIContextKey = "unifai-mcp-session-id"                           // string (session-mode identity: any opaque value asserted by the caller via x-uf-mcp-session-id; binds the OAuth token row to subsequent /mcp calls when no VK or user is present)
	UnifAIContextKeyMCPCallbackBaseURL                  UnifAIContextKey = "unifai-mcp-callback-base-url"                    // string (base URL like "https://host" — set by HTTP middleware. OAuth resolver appends /api/oauth/callback; headers resolver appends the workspace submit path. Used for both per-user OAuth and per-user headers auth flows)
	...
	UnifAIContextKeyDropRawRequestFromClient            UnifAIContextKey = "unifai-drop-raw-request-from-client"             // bool (set by unifai - DO NOT SET THIS MANUALLY) — true when raw request should be stripped from the client-facing response
	UnifAIContextKeyDropRawResponseFromClient           UnifAIContextKey = "unifai-drop-raw-response-from-client"            // bool (set by unifai - DO NOT SET THIS MANUALLY) — true when raw response should be stripped from the client-facing response
	UnifAIContextKeyShouldStoreRawInLogs                UnifAIContextKey = "unifai-should-store-raw-in-logs"                 // bool (set by unifai - DO NOT SET THIS MANUALLY) — true when raw request/response should be persisted in log records
	UnifAIContextKeyRetryDBFetch                        UnifAIContextKey = "unifai-retry-db-fetch"                           // bool (set by unifai - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyIsCustomProvider                    UnifAIContextKey = "unifai-is-custom-provider"                       // bool (set by unifai - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyHTTPRequestType                     UnifAIContextKey = "unifai-http-request-type"                        // RequestType (set by unifai - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyPassthroughExtraParams              UnifAIContextKey = "unifai-passthrough-extra-params"                 // bool
	UnifAIContextKeyRoutingEnginesUsed                  UnifAIContextKey = "unifai-routing-engines-used"                     // []string (set by unifai - DO NOT SET THIS MANUALLY) - list of routing engines used ("routing-rule", "governance", "loadbalancing", etc.)
	UnifAIContextKeyRoutingEngineLogs                   UnifAIContextKey = "unifai-routing-engine-logs"                      // []RoutingEngineLogEntry (set by unifai - DO NOT SET THIS MANUALLY) - list of routing engine log entries
	UnifAIContextKeyTransportPluginLogs                 UnifAIContextKey = "unifai-transport-plugin-logs"                    // []PluginLogEntry (transport-layer plugin logs accumulated during HTTP transport hooks)
	UnifAIContextKeyTransportPostHookCompleter          UnifAIContextKey = "unifai-transport-posthook-completer"             // func() (callback to run HTTPTransportPostHook after streaming - set by transport interceptor middleware)
	UnifAIContextKeySkipPluginPipeline                  UnifAIContextKey = "unifai-skip-plugin-pipeline"                     // bool - skip plugin pipeline for the request
	UnifAIContextKeyParentRequestID                     UnifAIContextKey = "unifai-parent-request-id"                        // string (parent linkage for grouped request logs like realtime turns)
	UnifAIContextKeyRealtimeSessionID                   UnifAIContextKey = "unifai-realtime-session-id"                      // string
	UnifAIContextKeyRealtimeProviderSessionID           UnifAIContextKey = "unifai-realtime-provider-session-id"             // string
	UnifAIContextKeyRealtimeSource                      UnifAIContextKey = "unifai-realtime-source"                          // string ("ei" or "lm")
	UnifAIContextKeyRealtimeEventType                   UnifAIContextKey = "unifai-realtime-event-type"                      // string
	UnifAIContextKeyRealtimeTransport                   UnifAIContextKey = "unifai-realtime-transport"                       // string ("websocket" or "webrtc")
	UnifAIContextKeyRealtimeVoice                       UnifAIContextKey = "unifai-realtime-voice"                           // string
	UnifAIIsAsyncRequest                                UnifAIContextKey = "unifai-is-async-request"                         // bool (set by unifai - DO NOT SET THIS MANUALLY)) - whether the request is an async request (only used in gateway)
	UnifAIContextKeyRequestHeaders                      UnifAIContextKey = "unifai-request-headers"                          // map[string]string (all request headers with lowercased keys)
	UnifAIContextKeyRequestQuery                        UnifAIContextKey = "unifai-request-query"                            // map[string]string (request query params with lowercased keys; consumed by governance routing CEL rules)
	...
	UnifAIContextKeyUserName                            UnifAIContextKey = "unifai-user-name"                  // string (to store the user name (set by enterprise auth middleware - DO NOT SET THIS MANUALLY))
	UnifAIContextKeyQueryScope                          UnifAIContextKey = "unifai-query-scope"                // configstore.QueryScope (func that mutates a query; set by upstream wrapper - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyVisibilityFilterProvider            UnifAIContextKey = "unifai-visibility-filter-provider" // DEPRECATED: replaced by UnifAIContextKeyQueryScope. Will be removed once all callers migrate.
	UnifAIContextKeyTargetUserID                        UnifAIContextKey = "target_user_id"
	UnifAIContextKeyIsAzureUserAgent                    UnifAIContextKey = "unifai-is-azure-user-agent" // bool (set by unifai - DO NOT SET THIS MANUALLY)) - whether the request is an Azure user agent (only used in gateway)
	UnifAIContextKeyUserRoleID                          UnifAIContextKey = "unifai-user-role-id"
	UnifAIContextKeyVideoOutputRequested                UnifAIContextKey = "unifai-video-output-requested"
	UnifAIContextKeyValidateKeys                        UnifAIContextKey = "unifai-validate-keys"                      // bool (triggers additional key validation during provider add/update)
	UnifAIContextKeyProviderResponseHeaders             UnifAIContextKey = "unifai-provider-response-headers"          // map[string]string (set by provider handlers for response header forwarding)
	UnifAIContextKeyMCPAddedTools                       UnifAIContextKey = "unifai-mcp-added-tools"                    // []string (set by unifai - DO NOT SET THIS MANUALLY)) - list of tools added to the request by MCP, all the tool are in the format "clientName-toolName"
	UnifAIContextKeyLargePayloadMode                    UnifAIContextKey = "unifai-large-payload-mode"                 // bool (set by unifai - DO NOT SET THIS MANUALLY)) indicates large payload streaming mode is active
	UnifAIContextKeyLargePayloadReader                  UnifAIContextKey = "unifai-large-payload-reader"               // io.Reader (set by unifai - DO NOT SET THIS MANUALLY)) upstream reader for large payloads
	UnifAIContextKeyLargePayloadContentLength           UnifAIContextKey = "unifai-large-payload-content-length"       // int (set by unifai - DO NOT SET THIS MANUALLY)) content length for large payloads
	UnifAIContextKeyLargePayloadContentType             UnifAIContextKey = "unifai-large-payload-content-type"         // string (set by enterprise - DO NOT SET THIS MANUALLY)) original content type for large payload passthrough
	UnifAIContextKeyLargePayloadMetadata                UnifAIContextKey = "unifai-large-payload-metadata"             // *LargePayloadMetadata (set by unifai - DO NOT SET THIS MANUALLY)) routing metadata for large payloads
	UnifAIContextKeyLargePayloadRequestThreshold        UnifAIContextKey = "unifai-large-payload-request-threshold"    // int64 (set by enterprise - DO NOT SET THIS MANUALLY)) request threshold used by transport heuristics
	UnifAIContextKeyLargeResponseMode                   UnifAIContextKey = "unifai-large-response-mode"                // bool (set by unifai - DO NOT SET THIS MANUALLY)) indicates large response streaming mode is active
	UnifAIContextKeyLargePayloadRequestPreview          UnifAIContextKey = "unifai-large-payload-request-preview"      // string (set by unifai - DO NOT SET THIS MANUALLY)) truncated request body preview for logging
	UnifAIContextKeyLargePayloadResponsePreview         UnifAIContextKey = "unifai-large-payload-response-preview"     // string (set by unifai - DO NOT SET THIS MANUALLY)) truncated response body preview for logging
	UnifAIContextKeyLargeResponseReader                 UnifAIContextKey = "unifai-large-response-reader"              // io.ReadCloser (set by unifai - DO NOT SET THIS MANUALLY)) upstream reader for large responses
	UnifAIContextKeyLargeResponseContentLength          UnifAIContextKey = "unifai-large-response-content-length"      // int (set by unifai - DO NOT SET THIS MANUALLY)) content length for large responses
	UnifAIContextKeyLargeResponseContentType            UnifAIContextKey = "unifai-large-response-content-type"        // string (set by unifai - DO NOT SET THIS MANUALLY)) upstream content type for large responses
	UnifAIContextKeyLargeResponseContentDisposition     UnifAIContextKey = "unifai-large-response-content-disposition" // string (set by unifai - DO NOT SET THIS MANUALLY)) downstream content disposition for large responses
	UnifAIContextKeyLargeResponseThreshold              UnifAIContextKey = "unifai-large-response-threshold"           // int64 (set by enterprise - DO NOT SET THIS MANUALLY)) threshold for response streaming
	UnifAIContextKeyLargePayloadPrefetchSize            UnifAIContextKey = "unifai-large-payload-prefetch-size"        // int (set by enterprise - DO NOT SET THIS MANUALLY)) prefetch buffer size for metadata extraction from large responses
	UnifAIContextKeyDeferredUsage                       UnifAIContextKey = "unifai-deferred-usage"                     // chan *UnifAILLMUsage (set by provider Phase B — delivers usage after response streaming completes)
	UnifAIContextKeyStreamAccumulatedUsage              UnifAIContextKey = "unifai-stream-accumulated-usage"           // *UnifAILLMUsage handle, set ONCE by a streaming provider and mutated in place as usage arrives; read on cancel/timeout to bill partial usage that the provider already consumed
	UnifAIContextKeyDeferredLargePayloadMetadata        UnifAIContextKey = "unifai-deferred-large-payload-metadata"    // <-chan *LargePayloadMetadata (set by enterprise Phase B request — delivers metadata after body streaming)
	UnifAIContextKeySSEReaderFactory                    UnifAIContextKey = "unifai-sse-reader-factory"                 // *providerUtils.SSEReaderFactory (set by enterprise — replaces default bufio.Scanner SSE readers with streaming readers)
	UnifAIContextKeySessionID                           UnifAIContextKey = "unifai-session-id"                         // string session ID for the request (session stickiness)
	UnifAIContextKeySessionTTL                          UnifAIContextKey = "unifai-session-ttl"                        // time.Duration session TTL for the request (session stickiness)
	UnifAIContextKeyMCPExtraHeaders                     UnifAIContextKey = "unifai-mcp-extra-headers"                  // map[string][]string (these headers are forwarded only to the MCP while tool execution if they are in the allowlist of the MCP client)
	UnifAIContextKeyMCPLogID                            UnifAIContextKey = "unifai-mcp-log-id"                         // string (unique UUID for each MCP tool log entry - set per goroutine by agent executor - DO NOT SET THIS MANUALLY)
	UnifAIContextKeyMCPHealthCheckRequest               UnifAIContextKey = "unifai-mcp-health-check-request"           // bool (set by unifai - DO NOT SET THIS MANUALLY) - true when the MCP ping/list-tools request was generated by unifai itself for health checks rather than originating from a caller
	UnifAIContextKeyCompatConvertTextToChat             UnifAIContextKey = "unifai-compat-convert-text-to-chat"        // bool (per-request override from x-uf-compat header)
	UnifAIContextKeyCompatConvertChatToResponses        UnifAIContextKey = "unifai-compat-convert-chat-to-responses"   // bool (per-request override from x-uf-compat header)
	UnifAIContextKeyCompatShouldDropParams              UnifAIContextKey = "unifai-compat-should-drop-params"          // bool (per-request override from x-uf-compat header)
	UnifAIContextKeyCompatShouldConvertParams           UnifAIContextKey = "unifai-compat-should-convert-params"       // bool (per-request override from x-uf-compat header)
	...
	UnifAIContextKeyTempTokenResourceID                 UnifAIContextKey = "unifai-temp-token-resource-id" // string (set by auth middleware alongside the scope - the resource_id the token is bound to, e.g. an OAuth flow ID for mcp_auth)
)
...
const (
	...
	// RoutingEngineCore represents the UnifAI core orchestrator's own
...
// make sure to mark UnifAIContextKeyStreamEndIndicator as true at the end of the stream.
...
// UnifAIRequest is the request struct for all unifai requests.
...
// NOTE: UnifAI Request is submitted back to pool after every use so DO NOT keep references to this struct after use, especially in go routines.
type UnifAIRequest struct {
	RequestType RequestType

	ListModelsRequest            *UnifAIListModelsRequest
	TextCompletionRequest        *UnifAITextCompletionRequest
	ChatRequest                  *UnifAIChatRequest
	ResponsesRequest             *UnifAIResponsesRequest
	ResponsesRetrieveRequest     *UnifAIResponsesRetrieveRequest
	ResponsesDeleteRequest       *UnifAIResponsesDeleteRequest
	ResponsesCancelRequest       *UnifAIResponsesCancelRequest
	ResponsesInputItemsRequest   *UnifAIResponsesInputItemsRequest
	CountTokensRequest           *UnifAIResponsesRequest
	CompactionRequest            *UnifAICompactionRequest
	EmbeddingRequest             *UnifAIEmbeddingRequest
	RerankRequest                *UnifAIRerankRequest
	OCRRequest                   *UnifAIOCRRequest
	SpeechRequest                *UnifAISpeechRequest
	TranscriptionRequest         *UnifAITranscriptionRequest
	ImageGenerationRequest       *UnifAIImageGenerationRequest
	ImageEditRequest             *UnifAIImageEditRequest
	ImageVariationRequest        *UnifAIImageVariationRequest
	VideoGenerationRequest       *UnifAIVideoGenerationRequest
	VideoRetrieveRequest         *UnifAIVideoRetrieveRequest
	VideoDownloadRequest         *UnifAIVideoDownloadRequest
	VideoListRequest             *UnifAIVideoListRequest
	VideoRemixRequest            *UnifAIVideoRemixRequest
	VideoDeleteRequest           *UnifAIVideoDeleteRequest
	FileUploadRequest            *UnifAIFileUploadRequest
	FileListRequest              *UnifAIFileListRequest
	FileRetrieveRequest          *UnifAIFileRetrieveRequest
	FileDeleteRequest            *UnifAIFileDeleteRequest
	FileContentRequest           *UnifAIFileContentRequest
	CachedContentCreateRequest   *UnifAICachedContentCreateRequest
	CachedContentListRequest     *UnifAICachedContentListRequest
	CachedContentRetrieveRequest *UnifAICachedContentRetrieveRequest
	CachedContentUpdateRequest   *UnifAICachedContentUpdateRequest
	CachedContentDeleteRequest   *UnifAICachedContentDeleteRequest
	BatchCreateRequest           *UnifAIBatchCreateRequest
	BatchListRequest             *UnifAIBatchListRequest
	BatchRetrieveRequest         *UnifAIBatchRetrieveRequest
	BatchCancelRequest           *UnifAIBatchCancelRequest
	BatchResultsRequest          *UnifAIBatchResultsRequest
	BatchDeleteRequest           *UnifAIBatchDeleteRequest
	ContainerCreateRequest       *UnifAIContainerCreateRequest
	ContainerListRequest         *UnifAIContainerListRequest
	ContainerRetrieveRequest     *UnifAIContainerRetrieveRequest
	ContainerDeleteRequest       *UnifAIContainerDeleteRequest
	ContainerFileCreateRequest   *UnifAIContainerFileCreateRequest
	ContainerFileListRequest     *UnifAIContainerFileListRequest
	ContainerFileRetrieveRequest *UnifAIContainerFileRetrieveRequest
	ContainerFileContentRequest  *UnifAIContainerFileContentRequest
	ContainerFileDeleteRequest   *UnifAIContainerFileDeleteRequest
	PassthroughRequest           *UnifAIPassthroughRequest
}

// GetRequestFields returns the provider, model, and fallbacks from the request.
func (br *UnifAIRequest) GetRequestFields() (provider ModelProvider, model string, fallbacks []Fallback) {
	switch {
...
func (br *UnifAIRequest) SetProvider(provider ModelProvider) {
	switch {
	case br.ListModelsRequest != nil:
...
func (br *UnifAIRequest) SetModel(model string) {
	switch {
	case br.TextCompletionRequest != nil:
...
func (br *UnifAIRequest) SetFallbacks(fallbacks []Fallback) {
	switch {
	case br.TextCompletionRequest != nil:
...
func (br *UnifAIRequest) SetRawRequestBody(rawRequestBody []byte) {
	switch {
	case br.TextCompletionRequest != nil:
...
// UnifAIMCPRequest is the envelope for MCP requests that flow through the generic
...
// MCPConnectionPlugin interface using *UnifAIMCPConnectRequest directly.
//
// Exactly one of the embedded sub-request pointers is populated, matched by RequestType:
//   - RequestType == MCPRequestTypePing       → UnifAIMCPPingRequest
//   - RequestType == MCPRequestTypeListTools  → UnifAIMCPListToolsRequest
//   - RequestType == MCPRequestTypeExecuteTool / MCPRequestTypeChatToolCall / MCPRequestTypeResponsesToolCall → UnifAIMCPExecuteToolRequest
type UnifAIMCPRequest struct {
	RequestType MCPRequestType
	ClientName  string // MCP client this request targets (always set, regardless of request type)

	*UnifAIMCPPingRequest
	*UnifAIMCPListToolsRequest

	// [DEPRECATED] these will be replaced by UnifAIMCPExecuteToolRequest in the next major bump, but are kept for backward compatibility for now since some tools still rely on the old fields
	*ChatAssistantMessageToolCall
	*ResponsesToolMessage

	// Will be used in from the next major bump
	*UnifAIMCPExecuteToolRequest
}

// UnifAIMCPConnectRequest carries the prepared inputs for an MCP connect operation.
...
type UnifAIMCPConnectRequest struct {
...
// UnifAIMCPPingRequest is intentionally empty: the wire ping rides over the existing
// transport and has no per-call headers or parameters. Plugins observe via ClientName on
// the parent UnifAIMCPRequest and may short-circuit (synthetic healthy/unhealthy).
type UnifAIMCPPingRequest struct {
}

// UnifAIMCPListToolsRequest is intentionally empty for the same reason as ping: list_tools
// reuses the existing transport's headers. Plugins observe via ClientName and may short-circuit
// (e.g. cached tool list).
type UnifAIMCPListToolsRequest struct {
}
...
type UnifAIMCPExecuteToolRequest struct {
}

func (r *UnifAIMCPRequest) GetToolName() string {
...
func (r *UnifAIMCPRequest) GetToolArguments() interface{} {
	if r.ChatAssistantMessageToolCall != nil {
...
// UnifAIResponse represents the complete result from any unifai request.
type UnifAIResponse struct {
	ListModelsResponse            *UnifAIListModelsResponse
	TextCompletionResponse        *UnifAITextCompletionResponse
	ChatResponse                  *UnifAIChatResponse
	ResponsesResponse             *UnifAIResponsesResponse
	ResponsesStreamResponse       *UnifAIResponsesStreamResponse
	ResponsesDeleteResponse       *UnifAIResponsesDeleteResponse
	ResponsesInputItemsResponse   *UnifAIResponsesInputItemsResponse
	CountTokensResponse           *UnifAICountTokensResponse
	CompactionResponse            *UnifAICompactionResponse
	EmbeddingResponse             *UnifAIEmbeddingResponse
	RerankResponse                *UnifAIRerankResponse
	OCRResponse                   *UnifAIOCRResponse
	SpeechResponse                *UnifAISpeechResponse
	SpeechStreamResponse          *UnifAISpeechStreamResponse
	TranscriptionResponse         *UnifAITranscriptionResponse
	TranscriptionStreamResponse   *UnifAITranscriptionStreamResponse
	ImageGenerationResponse       *UnifAIImageGenerationResponse
	ImageGenerationStreamResponse *UnifAIImageGenerationStreamResponse
	VideoGenerationResponse       *UnifAIVideoGenerationResponse
	VideoDownloadResponse         *UnifAIVideoDownloadResponse
	VideoListResponse             *UnifAIVideoListResponse
	VideoDeleteResponse           *UnifAIVideoDeleteResponse
	FileUploadResponse            *UnifAIFileUploadResponse
	FileListResponse              *UnifAIFileListResponse
	FileRetrieveResponse          *UnifAIFileRetrieveResponse
	FileDeleteResponse            *UnifAIFileDeleteResponse
	FileContentResponse           *UnifAIFileContentResponse
	CachedContentCreateResponse   *UnifAICachedContentCreateResponse
	CachedContentListResponse     *UnifAICachedContentListResponse
	CachedContentRetrieveResponse *UnifAICachedContentRetrieveResponse
	CachedContentUpdateResponse   *UnifAICachedContentUpdateResponse
	CachedContentDeleteResponse   *UnifAICachedContentDeleteResponse
	BatchCreateResponse           *UnifAIBatchCreateResponse
	BatchListResponse             *UnifAIBatchListResponse
	BatchRetrieveResponse         *UnifAIBatchRetrieveResponse
	BatchCancelResponse           *UnifAIBatchCancelResponse
	BatchResultsResponse          *UnifAIBatchResultsResponse
	BatchDeleteResponse           *UnifAIBatchDeleteResponse
	ContainerCreateResponse       *UnifAIContainerCreateResponse
	ContainerListResponse         *UnifAIContainerListResponse
	ContainerRetrieveResponse     *UnifAIContainerRetrieveResponse
	ContainerDeleteResponse       *UnifAIContainerDeleteResponse
	ContainerFileCreateResponse   *UnifAIContainerFileCreateResponse
	ContainerFileListResponse     *UnifAIContainerFileListResponse
	ContainerFileRetrieveResponse *UnifAIContainerFileRetrieveResponse
	ContainerFileContentResponse  *UnifAIContainerFileContentResponse
	ContainerFileDeleteResponse   *UnifAIContainerFileDeleteResponse
	PassthroughResponse           *UnifAIPassthroughResponse
}

func (r *UnifAIResponse) GetExtraFields() *UnifAIResponseExtraFields {
	switch {
	...
	return &UnifAIResponseExtraFields{}
}
...
// discouraged.
func (r *UnifAIResponse) PopulateRoutingInfo(info RoutingInfo) {
	if r == nil {
		return
	}
...
func (e *UnifAIError) PopulateRoutingInfo(info RoutingInfo) {
	if e == nil {
		return
	}
...
func (r *UnifAIResponse) SetFallbackRoutingInfo(primaryProvider ModelProvider, primaryModel string) {
	if r == nil {
		return
	}
	ef := r.GetExtraFields()
...
// SetFallbackRoutingInfo is the UnifAIError counterpart — see the
// UnifAIResponse method for semantics.
func (e *UnifAIError) SetFallbackRoutingInfo(primaryProvider ModelProvider, primaryModel string) {
	if e == nil {
		return
	}
...
func (r *UnifAIResponse) PopulateExtraFields(requestType RequestType, provider ModelProvider, originalModelRequested string, resolvedModelUsed string) {
	if r == nil {
		return
	}
...
// UnifAIMCPResponse is the envelope for MCP responses that flow through the generic
...
// interface using *UnifAIMCPConnectResponse directly.
//
...
type UnifAIMCPResponse struct {
	*UnifAIMCPPingResponse
	*UnifAIMCPListToolsResponse

	// [DEPRECATED] back-compat fields for execute-tool requests; will move into
	// UnifAIMCPExecuteToolResponse in the next major bump.
	ChatMessage      *ChatMessage
	ResponsesMessage *ResponsesMessage

	// Empty stub today; will hold ChatMessage/ResponsesMessage in the next major bump.
	*UnifAIMCPExecuteToolResponse

	ExtraFields UnifAIMCPResponseExtraFields
}

// Latency for envelope MCP responses (ping, list_tools, execute_tool) is reported via
// UnifAIMCPResponse.ExtraFields.Latency (milliseconds). Connect carries its own
// ExtraFields on UnifAIMCPConnectResponse below — see typed Connect path.

type UnifAIMCPConnectResponse struct {
...
// already set. Mirrors UnifAIMCPResponse.PopulateExtraFields. Connect has no tool
// name, so only ClientName is populated.
func (r *UnifAIMCPConnectResponse) PopulateExtraFields(clientName string) {
	if r == nil {
		return
	}
...
// Only the booleans UnifAI cares about today; can grow as needed.
...
type UnifAIMCPPingResponse struct {
}

type UnifAIMCPListToolsResponse struct {
	...
	RawToolCount    int                 // Count returned by the MCP server before UnifAI-side filtering
	SkippedTools    []SkippedMCPTool    // Tools UnifAI dropped during conversion + reason
}

// SkippedMCPTool describes a tool that the MCP server returned but UnifAI did not include
...
type UnifAIMCPExecuteToolResponse struct {
}

// PopulateExtraFields backfills ExtraFields.{MCPRequestType, ClientName, ToolName}
// when they aren't already set on the response. Mirrors UnifAIResponse.PopulateExtraFields
// and is used by every MCP gate to ensure short-circuit responses carry the same
// attribution as real wire-call responses.
func (r *UnifAIMCPResponse) PopulateExtraFields(mcpRequestType MCPRequestType, clientName, toolName string) {
	if r == nil {
		return
	}
...
// UnifAIResponseExtraFields contains additional fields in a response.
type UnifAIResponseExtraFields struct {
...
type UnifAIMCPResponseExtraFields struct {
...
// UnifAICacheDebug represents debug information about the cache.
type UnifAICacheDebug struct {
...
// UnifAIStreamChunk represents a stream of responses from the UnifAI system.
// Either UnifAIResponse or UnifAIError will be non-nil.
type UnifAIStreamChunk struct {
	*UnifAITextCompletionResponse
	*UnifAIChatResponse
	*UnifAIResponsesStreamResponse
	*UnifAISpeechStreamResponse
	*UnifAITranscriptionStreamResponse
	*UnifAIImageGenerationStreamResponse
	*UnifAIPassthroughResponse
	*UnifAIError
}

// MarshalJSON implements custom JSON marshaling for UnifAIStreamChunk.
// This ensures that only the non-nil embedded struct is marshaled,
func (bs UnifAIStreamChunk) MarshalJSON() ([]byte, error) {
	if bs.UnifAITextCompletionResponse != nil {
		return MarshalSorted(bs.UnifAITextCompletionResponse)
	} else if bs.UnifAIChatResponse != nil {
		return MarshalSorted(bs.UnifAIChatResponse)
	} else if bs.UnifAIResponsesStreamResponse != nil {
		return MarshalSorted(bs.UnifAIResponsesStreamResponse)
	} else if bs.UnifAISpeechStreamResponse != nil {
		return MarshalSorted(bs.UnifAISpeechStreamResponse)
	} else if bs.UnifAITranscriptionStreamResponse != nil {
		return MarshalSorted(bs.UnifAITranscriptionStreamResponse)
	} else if bs.UnifAIImageGenerationStreamResponse != nil {
		return MarshalSorted(bs.UnifAIImageGenerationStreamResponse)
	} else if bs.UnifAIPassthroughResponse != nil {
		return MarshalSorted(bs.UnifAIPassthroughResponse)
	} else if bs.UnifAIError != nil {
		return MarshalSorted(bs.UnifAIError)
	}
	// Return empty object if both are nil (shouldn't happen in practice)
	return []byte("{}"), nil
}

// UnifAIError represents an error from the UnifAI system.
//
// PLUGIN DEVELOPERS: When creating UnifAIError in PreLLMHook or PostLLMHook, you can set AllowFallbacks:
// - AllowFallbacks = &true: UnifAI will try fallback providers if available
...
// modifications to these 4 fields are no-ops — tampering with them inside plugins is discouraged.
func (e *UnifAIError) PopulateExtraFields(requestType RequestType, provider ModelProvider, originalModelRequested string, resolvedModelUsed string) {
	if e == nil {
		return
	}
...
func (e *UnifAIError) String() string {
	if e == nil {
		return "<nil>"
	}
	b, err := MarshalSorted(e)
	if err != nil {
		return fmt.Sprintf("UnifAIError{marshal_err=%v}", err)
	}
	return string(b)
}

func (e *UnifAIError) GetErrorString() string {
	if e == nil {
		return ""
	}
...
// UnifAIErrorExtraFields contains additional fields in an error response.
type UnifAIErrorExtraFields struct {
	RoutingInfo RoutingInfo `json:"routing_info"`
	// Deprecated: use RoutingInfo.Provider. Still populated for backward
	// compatibility; new consumers should read from RoutingInfo.
	Provider ModelProvider `json:"provider,omitempty"`
	...
	BilledUsage *UnifAILLMUsage `json:"billed_usage,omitempty"`
}
