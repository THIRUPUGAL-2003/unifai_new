...
func resolveVertexProjectID(ctx *schemas.UnifAIContext, key schemas.Key) string {
...
func resolveVertexProjectNumber(ctx *schemas.UnifAIContext, key schemas.Key) string {
...
// them.
func resolveVertexRegion(ctx *schemas.UnifAIContext, key schemas.Key) string {
...
func isVertexModelSupportedForTier(model string, tier schemas.UnifAIServiceTier) bool {
...
func vertexServiceTierHeaderValue(region string, model string, tier schemas.UnifAIServiceTier) string {
	if region != "global" {
		return ""
	}
...
func buildResponseFromConfig(deployments schemas.KeyAliases, allowedModels schemas.WhiteList, blacklistedModels schemas.BlackList) *schemas.UnifAIListModelsResponse {
