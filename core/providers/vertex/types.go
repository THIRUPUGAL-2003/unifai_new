...
// Fields UnifAI interprets are typed; the deeply-nested explanation/monitoring config trees
...
// fields UnifAI maps directly are typed; any other Vertex-native field (modelParameters,
...
// The original request is echoed back; labels carry the UnifAI custom_id.
