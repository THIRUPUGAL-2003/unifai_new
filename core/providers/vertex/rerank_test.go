...
func TestVertexRankResponseToUnifAIRerankResponse(t *testing.T) {
	t.Parallel()
	...
	}).ToUnifAIRerankResponse(docs, true)
	require.NoError(t, err)
...
func TestVertexRankRequestToUnifAIRerankRequest(t *testing.T) {
	t.Parallel()
	...
	result := req.ToUnifAIRerankRequest(unifaiCtx)
...
func TestVertexRankRequestToUnifAIRerankRequestNil(t *testing.T) {
	t.Parallel()
...
func TestVertexRankResponseToUnifAIRerankResponseInvalidID(t *testing.T) {
	t.Parallel()
	...
	}).ToUnifAIRerankResponse([]schemas.RerankDocument{{Text: "doc"}}, false)
	require.Error(t, err)
