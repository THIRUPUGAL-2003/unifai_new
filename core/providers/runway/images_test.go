...
func makeImageReq(model, prompt string, params *schemas.ImageGenerationParameters) *schemas.UnifAIImageGenerationRequest {
...
func TestToRunwayImageGenerationRequest(t *testing.T) {
	...
	t.Run("nil_input_errors", func(t *testing.T) {
		_, err := ToRunwayImageGenerationRequest(&schemas.UnifAIImageGenerationRequest{Model: "gen4_image"})
		require.Error(t, err)
	})
...
func makeImageEditReq(model, prompt string, images [][]byte, params *schemas.ImageEditParameters) *schemas.UnifAIImageEditRequest {
...
func TestToRunwayImageEditRequest(t *testing.T) {
	t.Run("nil_input_errors", func(t *testing.T) {
		_, err := ToRunwayImageEditRequest(&schemas.UnifAIImageEditRequest{Model: "gen4_image"})
		require.Error(t, err)
	})
...
func TestToUnifAIImageGenerationResponse(t *testing.T) {
	t.Run("nil_task_details_errors", func(t *testing.T) {
		_, err := ToUnifAIImageGenerationResponse(nil)
	...
	t.Run("maps_output_urls", func(t *testing.T) {
		...
		resp, err := ToUnifAIImageGenerationResponse(taskDetails)
		require.Nil(t, err)
