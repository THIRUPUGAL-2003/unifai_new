...
func TestToGeminiVideoGenerationRequest_PutsReferenceImagesAndLastFrameOnInstance(t *testing.T) {
	...
	got, err := gemini.ToGeminiVideoGenerationRequest(&schemas.UnifAIVideoGenerationRequest{
...
func TestGeminiVideoGenerationRequest_RoundTripsInstanceReferenceFields(t *testing.T) {
	...
	unifaiReq, err := in.ToUnifAIVideoGenerationRequest(nil)
	require.NoError(t, err)

	got, err := gemini.ToGeminiVideoGenerationRequest(unifaiReq)
	require.NoError(t, err)
