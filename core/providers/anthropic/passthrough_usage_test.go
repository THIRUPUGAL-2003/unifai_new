...
func TestExtractAnthropicPassthroughUsage(t *testing.T) {
	tests := []struct {
		...
		path  string
		body  string
		check func(t *testing.T, u *schemas.UnifAIPassthroughUsage)
	}{
		{
			...
			check: func(t *testing.T, u *schemas.UnifAIPassthroughUsage) {
				...
				if u.ServiceTier == nil || *u.ServiceTier != schemas.UnifAIServiceTierDefault {
		...
		},
		{
			...
			check: func(t *testing.T, u *schemas.UnifAIPassthroughUsage) {
				if u == nil || u.ServiceTier == nil || *u.ServiceTier != schemas.UnifAIServiceTierPriority {
...
func anthropicMustLLM(t *testing.T, u *schemas.UnifAIPassthroughUsage, prompt, completion, total int) {
	t.Helper()
