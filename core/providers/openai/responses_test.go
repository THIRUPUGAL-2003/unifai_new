...
func TestToOpenAIResponsesRequest_ReasoningOnlyMessageSkip(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := ToOpenAIResponsesRequest(nil, unifaiReq)
...
func TestToOpenAIResponsesRequest_ReasoningStringContent(t *testing.T) {
	t.Run("empty string content is dropped", func(t *testing.T) {
		...
		result := ToOpenAIResponsesRequest(nil, unifaiReq)
		original := unifaiReq.Input[0].Content
...
func TestToOpenAIResponsesRequest_NormalizesReasoningEffort(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := ToOpenAIResponsesRequest(nil, &schemas.UnifAIResponsesRequest{
				Provider: provider,
				Model:    tt.model,
				Input: []schemas.ResponsesMessage{{
					Role:    schemas.Ptr(schemas.ResponsesInputMessageRoleUser),
...
func TestToOpenAIResponsesRequest_ToolNormalization(t *testing.T) {
	...
	origParams := unifaiReq.Params.Tools[0].ResponsesToolFunction.Parameters
	...
	if funcTool.ResponsesToolFunction == unifaiReq.Params.Tools[0].ResponsesToolFunction {
...
func TestToOpenAIResponsesRequest_OpenRouterServerToolsPreserved(t *testing.T) {
	makeReq := func(provider schemas.ModelProvider, toolType schemas.ResponsesToolType) *schemas.UnifAIResponsesRequest {
