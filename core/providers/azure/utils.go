...
func resolveAnthropicVersion(ctx *schemas.UnifAIContext) string {
...
func resolveAPIVersion(ctx *schemas.UnifAIContext, defaultVersion string) string {
...
// west-us2).
func resolveAzureEndpoint(ctx *schemas.UnifAIContext, key schemas.Key) string {
