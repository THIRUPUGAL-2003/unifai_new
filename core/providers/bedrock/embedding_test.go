...
func TestToBedrockCohereEmbeddingRequest(t *testing.T) {
	...
	t.Run("returns error for missing input", func(t *testing.T) {
		req, err := ToBedrockCohereEmbeddingRequest(&schemas.UnifAIEmbeddingRequest{})
		require.Error(t, err)
		assert.Nil(t, req)
	...
	t.Run("single text strips model and extracts typed params", func(t *testing.T) {
		...
		req, err := ToBedrockCohereEmbeddingRequest(unifaiReq)
...
func TestToBedrockCohereEmbeddingRequestBodyOmitsModel(t *testing.T) {
	...
	wireBody, unifaiErr := providerUtils.CheckContextAndGetRequestBody(
		...
		func() (providerUtils.RequestBodyWithExtraParams, error) {
			return ToBedrockCohereEmbeddingRequest(unifaiReq)
		},
	)
