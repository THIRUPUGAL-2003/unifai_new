...
func TestToBedrockConverseStreamResponse_CopiesCacheTokens(t *testing.T) {
	resp := &schemas.UnifAIResponsesStreamResponse{
...
func TestBuildBedrockTokenUsage_StreamMatchesNonStream(t *testing.T) {
	...
	streamResp := &schemas.UnifAIResponsesStreamResponse{
		Type:     schemas.ResponsesStreamResponseTypeCompleted,
		Response: &schemas.UnifAIResponsesResponse{Usage: usage},
	}
	...
	nonStreamResp, err := ToBedrockConverseResponse(&schemas.UnifAIResponsesResponse{Usage: usage})
	if err != nil {
