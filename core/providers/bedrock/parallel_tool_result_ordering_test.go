...
//
// Root cause: ConvertUnifAIMessagesToBedrockMessages stores pending results in
...
// buildParallelToolPayload builds a UnifAIResponsesRequest that mirrors the
...
// to the real payload.
func buildParallelToolPayload() *schemas.UnifAIResponsesRequest {
