...
func TestCodeMode_CallingMCPTool(t *testing.T) {
	...
	code := `echoResult = unifaiInternal.echo(message="Testing MCP call")
...
func TestCodeMode_CallingMultipleServers(t *testing.T) {
	...
	code := `result1 = unifaiInternal.echo(message="from HTTP")
result2 = unifaiInternal.echo(message="from SSE")
result = {
    "http": result1,
    "sse": result2
}`
...
func TestCodeMode_NestedToolCalls(t *testing.T) {
	...
	code := `# First call
echo1 = unifaiInternal.echo(message="step 1")

# Process result
processed = "Processed: " + str(echo1)

# Second call using processed result
echo2 = unifaiInternal.echo(message=processed)

# Third call
calc = unifaiInternal.calculator(operation="add", x=5, y=3)
...
func TestCodeMode_ToolNotInExecuteList(t *testing.T) {
	...
	code := `def main():
    if hasattr(unifaiInternal, "echo"):
        r = unifaiInternal.echo(message="blocked")
...
func TestCodeMode_NonAllowedToolExecution(t *testing.T) {
	...
	// Execute code that tries to access unifaiInternal
	// When ToolsToExecute = [], the server won't be bound in the environment at all
	// This should cause a runtime error: "undefined: unifaiInternal"
	code := `result = unifaiInternal.echo(message="should fail")`
	...
	// Verify we get an error because unifaiInternal is not defined
	// When ToolsToExecute = [], the server is not bound in the Starlark environment
	require.True(t, hasError, "should have execution error because unifaiInternal is not bound when ToolsToExecute is empty")
	assert.Contains(t, strings.ToLower(errorMsg), "undefined", "error should indicate unifaiInternal is undefined")
	t.Logf("Expected error (unifaiInternal unbound due to empty ToolsToExecute): %s", errorMsg)
}
...
func TestCodeMode_ToolExecutionTimeout(t *testing.T) {
	...
	code := `if hasattr(unifaiInternal, "echo"):
    r = unifaiInternal.echo(message="test")
...
func TestCodeMode_ToolCallWithAwait(t *testing.T) {
	...
	code := `result = unifaiInternal.calculator(operation="multiply", x=6, y=7)`
...
func TestCodeMode_ToolCallWithoutAwait(t *testing.T) {
	...
	code := `result = unifaiInternal.echo(message="promise test")`
...
results.append(unifaiInternal.echo(message="first"))
results.append(unifaiInternal.echo(message="second"))
results.append(unifaiInternal.echo(message="third"))
...
func TestCodeMode_MultipleParallelToolCalls(t *testing.T) {
	...
	code := `r1 = unifaiInternal.echo(message="parallel1")
r2 = unifaiInternal.echo(message="parallel2")
r3 = unifaiInternal.calculator(operation="add", x=10, y=20)
...
func TestCodeMode_ToolReturnsError(t *testing.T) {
	...
	code := `def main():
    r = unifaiInternal.throw_error(error_message="intentional error")
...
func TestCodeMode_ToolNotFound(t *testing.T) {
	...
	// Execute code that tries to use unifaiInternal which won't be bound
	// When ToolsToExecute = [], the server won't be bound in the environment at all
	// This should cause a runtime error: "undefined: unifaiInternal"
	code := `result = unifaiInternal.nonexistent_tool(param="value")`
	...
	// Verify we get an error because unifaiInternal is not defined
	// When ToolsToExecute = [], the server is not bound in the Starlark environment
	require.True(t, hasError, "should have execution error because unifaiInternal is not bound")
...
func TestCodeMode_ChatFormat(t *testing.T) {
	...
	code := `r = unifaiInternal.calculator(operation="divide", x=100, y=4)
