...
func TestAgentHelpers_Example_SimpleInProcessAgent(t *testing.T) {
	...
	AssertAgentSuccess(t, result, unifaiErr)
...
func TestAgentHelpers_Example_SimpleAgentTestHelper(t *testing.T) {
	...
	SimpleAgentTest(
		...
		func(t *testing.T, response *schemas.UnifAIChatResponse, unifaiErr *schemas.UnifAIError, mocker *DynamicLLMMocker) {
...
func TestAgentHelpers_Example_MaxDepthLimit(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "Should not error at max depth")
