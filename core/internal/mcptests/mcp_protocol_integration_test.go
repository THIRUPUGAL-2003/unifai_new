...
func TestProtocol_BasicToolExecution(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "Echo tool should succeed")
	...
	result, unifaiErr = unifai.ExecuteChatMCPTool(ctx, &toolCall)
	require.Nil(t, unifaiErr, "Calculator tool should succeed")
	require.NotNil(t, result, "Should have result")
...
func TestProtocol_ParallelExecution(t *testing.T) {
	...
	for _, tt := range testTools {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
			require.Nil(t, unifaiErr, "Tool should succeed")
			require.NotNil(t, result, "Should have result")
...
func TestProtocol_ErrorHandling(t *testing.T) {
	...
	t.Run("IntermittentFailure", func(t *testing.T) {
		...
		result, _ := unifai.ExecuteChatMCPTool(ctx, &toolCall)
	...
	t.Run("LargePayload", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Large payload should succeed")
		require.NotNil(t, result, "Should have result")
...
func TestProtocol_EdgeCases(t *testing.T) {
	...
	t.Run("UnicodeText", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Unicode tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("DeeplyNested", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Deeply nested tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("EmptyResponse", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Empty response tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("NullFields", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Null fields tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("SpecialCharacters", func(t *testing.T) {
		...
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, unifaiErr, "Special chars tool should succeed")
		require.NotNil(t, result, "Should have result")
...
func getTestToolsServerPath(t *testing.T) string {
	...
	// Path from unifai root: examples/mcps/test-tools-server/dist/index.js
