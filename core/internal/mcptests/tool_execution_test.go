...
func TestDirectToolExecution_ChatFormat(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "tool execution should succeed")
...
func TestDirectToolExecution_ResponsesFormat(t *testing.T) {
	...
	result, unifaiErr := unifai.ExecuteResponsesMCPTool(ctx, &toolCall)
	require.Nil(t, unifaiErr, "tool execution should succeed")
	require.NotNil(t, result, "should have result")
...
func TestToolExecutionWithArguments(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Nil(t, unifaiErr, "calculator execution should succeed")
			require.NotNil(t, result, "should have result")
...
func TestToolExecutionTimeout(t *testing.T) {
	...
	if unifaiErr != nil && unifaiErr.Error != nil {
		t.Logf("✅ Got expected timeout error: %v", unifaiErr.Error.Message)
	} else if result != nil {
...
func TestToolExecutionReturnsError(t *testing.T) {
	...
	if unifaiErr != nil && unifaiErr.Error != nil {
		assert.Contains(t, unifaiErr.Error.Message, errorMessage)
		t.Logf("✅ Error properly propagated: %v", unifaiErr.Error.Message)
...
func TestToolExecutionLargeResponse(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "large response should not error")
...
func TestToolExecutionEmptyResponse(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "empty response should not crash")
...
func TestToolExecutionStructuredResponse(t *testing.T) {
	...
	require.Nil(t, unifaiErr, "structured response should work")
	assert.NotNil(t, result, "should have result")
...
func TestToolExecutionParallel(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		...
		go func(id int) {
			...
			if unifaiErr != nil {
				errors <- fmt.Errorf("tool execution error: %v", unifaiErr)
			}
		}(i)
	}
...
func TestToolExecutionExtraFields(t *testing.T) {
	...
	// Note: ExtraFields are in UnifAIMCPResponse, not ChatMessage
}
...
func TestToolExecutionPreservesCallID(t *testing.T) {
	...
	chatResult, chatErr := unifai.ExecuteChatMCPTool(ctx, &chatToolCall)
	...
	responsesResult, responsesErr := unifai.ExecuteResponsesMCPTool(ctx, &responsesToolCall)
...
func TestToolExecutionMultipleClients(t *testing.T) {
	...
	echoResult, echoErr := unifai.ExecuteChatMCPTool(ctx, &echoToolCall)
	...
	inProcessToolCall := schemas.ChatAssistantMessageToolCall{
		...
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("unifaiInternal-local_tool"),
			Arguments: string(argsJSON),
		},
	}
	localResult, localErr := unifai.ExecuteChatMCPTool(ctx, &inProcessToolCall)
...
func TestToolExecutionClientNotFound(t *testing.T) {
	...
	if unifaiErr != nil {
		t.Logf("Got expected error: %v", unifaiErr)
	} else if result != nil {
...
func TestToolExecutionMalformedRequest(t *testing.T) {
	...
	t.Run("nil_tool_call", func(t *testing.T) {
		result, unifaiErr := unifai.ExecuteChatMCPTool(ctx, nil)
...
func TestToolExecutionContextCancellation(t *testing.T) {
	...
	// Should be cancelled
	if unifaiErr != nil {
		t.Logf("Got cancellation error: %v", unifaiErr)
	} else if result != nil {
...
func TestToolExecutionContextDeadline(t *testing.T) {
	...
	// Should hit deadline
	if unifaiErr != nil {
		t.Logf("Got deadline error: %v", unifaiErr)
	} else if result != nil {
