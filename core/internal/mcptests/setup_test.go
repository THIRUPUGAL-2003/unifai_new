...
// createTestContext creates a UnifAIContext for testing
func createTestContext() *schemas.UnifAIContext {
	return schemas.NewUnifAIContext(context.Background(), schemas.NoDeadline)
}

// createTestContextWithTimeout creates a UnifAIContext with timeout
func createTestContextWithTimeout(timeout time.Duration) (*schemas.UnifAIContext, context.CancelFunc) {
	ctx, cancel := context.WithTimeout(context.Background(), timeout)
	return schemas.NewUnifAIContext(ctx, schemas.NoDeadline), cancel
}
