...
func TestAgent_MultiConnection_MixedPermissions(t *testing.T) {
	...
	assert.True(t, toolNames["unifaiInternal-calculator"], "calculator should be waiting for approval")
...
func TestAgent_MultiConnection_ErrorInSTDIO(t *testing.T) {
	...
	// Assertions
	require.Nil(t, unifaiErr, "Agent should not fail on tool error")
	require.NotNil(t, result)
...
func TestAgent_MultiConnection_LargeParallelBatch(t *testing.T) {
	...
	expectedTools := []string{
		"unifaiInternal-echo",
		"unifaiInternal-calculator",
		"unifaiInternal-get_weather",
		"unifaiInternal-get_time",
