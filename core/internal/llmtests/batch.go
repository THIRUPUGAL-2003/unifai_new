// Package llmtests provides batch API test utilities for the UnifAI system.
package llmtests
...
func RunBatchCreateTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCreate", func(t *testing.T) {
		...
		response, err := WithBatchCreateTestRetry(t, batchCreateRetryConfig, retryContext, expectations, "BatchCreate", func() (*schemas.UnifAIBatchCreateResponse, *schemas.UnifAIError) {
			request := &schemas.UnifAIBatchCreateRequest{
				Provider: testConfig.Provider,
...
func RunBatchListTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchList", func(t *testing.T) {
		...
		response, err := WithBatchListTestRetry(t, batchListRetryConfig, retryContext, expectations, "BatchList", func() (*schemas.UnifAIBatchListResponse, *schemas.UnifAIError) {
			request := &schemas.UnifAIBatchListRequest{
				Provider: testConfig.Provider,
				Limit:    10,
			}
			bfCtx := schemas.NewUnifAIContext(ctx, schemas.NoDeadline)
...
func RunBatchRetrieveTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchRetrieve", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchRetrieve_Create", func() (*schemas.UnifAIBatchCreateResponse, *schemas.UnifAIError) {
		...
		response, err := WithBatchRetrieveTestRetry(t, batchRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "BatchRetrieve", func() (*schemas.UnifAIBatchRetrieveResponse, *schemas.UnifAIError) {
...
func RunBatchCancelTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCancel", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchCancel_Create", func() (*schemas.UnifAIBatchCreateResponse, *schemas.UnifAIError) {
			createRequest := &schemas.UnifAIBatchCreateRequest{
				Provider: testConfig.Provider,
				Model:    schemas.Ptr(testConfig.ChatModel),
				Endpoint: schemas.BatchEndpointChatCompletions,
		...
		response, err := WithBatchCancelTestRetry(t, batchCancelRetryConfig, cancelRetryContext, cancelExpectations, "BatchCancel", func() (*schemas.UnifAIBatchCancelResponse, *schemas.UnifAIError) {
...
func RunBatchResultsTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchResults", func(t *testing.T) {
		...
		request := &schemas.UnifAIBatchResultsRequest{
			Provider: testConfig.Provider,
...
func RunBatchUnsupportedTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileUploadTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileUpload", func(t *testing.T) {
		...
		response, err := WithFileUploadTestRetry(t, fileUploadRetryConfig, retryContext, expectations, "FileUpload", func() (*schemas.UnifAIFileUploadResponse, *schemas.UnifAIError) {
...
func RunFileListTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileList", func(t *testing.T) {
		...
		response, err := WithFileListTestRetry(t, fileListRetryConfig, retryContext, expectations, "FileList", func() (*schemas.UnifAIFileListResponse, *schemas.UnifAIError) {
			request := &schemas.UnifAIFileListRequest{
				Provider:      testConfig.Provider,
				Limit:         10,
				ExtraParams:   testConfig.FileExtraParams,
				StorageConfig: testConfig.FileStorageConfig,
...
func RunFileRetrieveTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileRetrieve", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileRetrieve_Upload", func() (*schemas.UnifAIFileUploadResponse, *schemas.UnifAIError) {
...
`)
		...
		response, err := WithFileRetrieveTestRetry(t, fileRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "FileRetrieve", func() (*schemas.UnifAIFileRetrieveResponse, *schemas.UnifAIError) {
...
func RunFileDeleteTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileDelete", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileDelete_Upload", func() (*schemas.UnifAIFileUploadResponse, *schemas.UnifAIError) {
...
`)
		...
		response, err := WithFileDeleteTestRetry(t, fileDeleteRetryConfig, deleteRetryContext, deleteExpectations, "FileDelete", func() (*schemas.UnifAIFileDeleteResponse, *schemas.UnifAIError) {
...
func RunFileContentTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileContent", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileContent_Upload", func() (*schemas.UnifAIFileUploadResponse, *schemas.UnifAIError) {
...
`)
		...
		response, err := WithFileContentTestRetry(t, fileContentRetryConfig, contentRetryContext, contentExpectations, "FileContent", func() (*schemas.UnifAIFileContentResponse, *schemas.UnifAIError) {
...
func RunFileUnsupportedTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileAndBatchIntegrationTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
`)
		...
		batchRequest := &schemas.UnifAIBatchCreateRequest{
			Provider:         testConfig.Provider,
			Model:            schemas.Ptr(testConfig.ChatModel),
