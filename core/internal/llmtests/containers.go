// Package llmtests provides container API test utilities for the UnifAI system.
package llmtests
...
func RunContainerCreateTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerCreate", func(t *testing.T) {
		...
		request := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container",
		}

		bfCtx := schemas.NewUnifAIContext(ctx, containerDeadline())
...
func RunContainerListTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerList", func(t *testing.T) {
		...
		request := &schemas.UnifAIContainerListRequest{
			Provider: testConfig.Provider,
			Limit:    10,
		}
...
func RunContainerRetrieveTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerRetrieve", func(t *testing.T) {
		...
		createRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-retrieve",
		}
...
func RunContainerDeleteTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerDelete", func(t *testing.T) {
		...
		createRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-delete",
		}
...
func RunContainerUnsupportedTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunContainerFileCreateTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileCreate", func(t *testing.T) {
		...
		containerRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-file-create",
		}
		...
		testContent := []byte("Hello, UnifAI! This is a test file for container file operations.")
		filePath := "/test-file.txt"

		fileCreateRequest := &schemas.UnifAIContainerFileCreateRequest{
			Provider:    testConfig.Provider,
			ContainerID: containerID,
			File:        testContent,
			Path:        &filePath,
		...
		// Clean up file
		fileDeleteRequest := &schemas.UnifAIContainerFileDeleteRequest{
			Provider:    testConfig.Provider,
			ContainerID: containerID,
			FileID:      response.ID,
		}
...
func RunContainerFileListTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileList", func(t *testing.T) {
		...
		containerRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-file-list",
		}
...
func RunContainerFileRetrieveTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileRetrieve", func(t *testing.T) {
		...
		containerRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-file-retrieve",
		}
...
func RunContainerFileContentTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileContent", func(t *testing.T) {
		...
		containerRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-file-content",
		}
	...
	testContent := []byte("Hello, UnifAI! This is test content for file content retrieval.")
...
func RunContainerFileDeleteTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileDelete", func(t *testing.T) {
		...
		containerRequest := &schemas.UnifAIContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "unifai-test-container-file-delete",
		}
...
func RunContainerFileUnsupportedTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
