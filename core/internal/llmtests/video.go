...
func RunVideoGenerationTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRetrieveTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRemixTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoRemix", func(t *testing.T) {
		...
		remixReq := &schemas.UnifAIVideoRemixRequest{
...
func RunVideoDownloadTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDownload", func(t *testing.T) {
		...
		downloadReq := &schemas.UnifAIVideoDownloadRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewUnifAIContext(ctx, schemas.NoDeadline)
...
func RunVideoListTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoList", func(t *testing.T) {
		...
		order := "desc"
		limit := 5
		req := &schemas.UnifAIVideoListRequest{
			Provider: testConfig.Provider,
			Order:    unifai.Ptr(order),
			Limit:    unifai.Ptr(limit),
		}
		bfCtx := schemas.NewUnifAIContext(ctx, schemas.NoDeadline)
...
func RunVideoDeleteTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDelete", func(t *testing.T) {
		...
		deleteReq := &schemas.UnifAIVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewUnifAIContext(ctx, schemas.NoDeadline)
...
func RunVideoUnsupportedTest(t *testing.T, client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoUnsupported", func(t *testing.T) {
		...
		_, listErr := client.VideoListRequest(bfCtx, &schemas.UnifAIVideoListRequest{
			Provider: testConfig.Provider,
		})
		...
		_, deleteErr := client.VideoDeleteRequest(bfCtx, &schemas.UnifAIVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
		})
		...
		_, remixErr := client.VideoRemixRequest(bfCtx, &schemas.UnifAIVideoRemixRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
...
func createVideoJob(client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig) (*schemas.UnifAIVideoGenerationResponse, *schemas.UnifAIError) {
...
func retrieveVideoWithRetries(client *unifai.UnifAI, ctx context.Context, testConfig ComprehensiveTestConfig, videoID string) (*schemas.UnifAIVideoGenerationResponse, *schemas.UnifAIError) {
	var lastErr *schemas.UnifAIError
	for attempt := 0; attempt < videoRetrieveMaxRetries; attempt++ {
		req := &schemas.UnifAIVideoRetrieveRequest{
			Provider: testConfig.Provider,
			ID:       videoID,
		}
		bfCtx := schemas.NewUnifAIContext(ctx, schemas.NoDeadline)
...
func waitForVideoCompletion(
	...
	var lastResp *schemas.UnifAIVideoGenerationResponse
	var lastErr *schemas.UnifAIError
...
func isUnsupportedOperationError(err *schemas.UnifAIError) bool {
