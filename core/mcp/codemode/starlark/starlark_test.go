...
func (m *testClientManager) AcquireClientConn(ctx *schemas.UnifAIContext, state *schemas.MCPClientState) (*client.Client, func(), error) {
	return nil, func() {}, nil
}
func (m *testClientManager) RunWithPluginPipeline(ctx *schemas.UnifAIContext, req *schemas.UnifAIMCPRequest, op codemcp.MCPOpFunc) (*schemas.UnifAIMCPResponse, *schemas.UnifAIError) {
	resp, err := op(req)
	if err != nil {
