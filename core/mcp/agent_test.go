...
// MockLLMCaller implements schemas.UnifAILLMCaller for testing
type MockLLMCaller struct {
	chatResponses      []*schemas.UnifAIChatResponse
	responsesResponses []*schemas.UnifAIResponsesResponse
	chatCallCount      int
	responsesCallCount int
}

func (m *MockLLMCaller) ChatCompletionRequest(ctx context.Context, req *schemas.UnifAIChatRequest) (*schemas.UnifAIChatResponse, *schemas.UnifAIError) {
...
func (m *MockLLMCaller) ResponsesRequest(ctx context.Context, req *schemas.UnifAIResponsesRequest) (*schemas.UnifAIResponsesResponse, *schemas.UnifAIError) {
...
func (m *MockClientManager) AcquireClientConn(ctx *schemas.UnifAIContext, state *schemas.MCPClientState) (*client.Client, func(), error) {
	return nil, func() {}, nil
}
func (m *MockClientManager) RunWithPluginPipeline(ctx *schemas.UnifAIContext, req *schemas.UnifAIMCPRequest, op MCPOpFunc) (*schemas.UnifAIMCPResponse, *schemas.UnifAIError) {
	resp, err := op(req)
	if err != nil {
...
func TestHasToolCallsForChatResponse(t *testing.T) {
	...
	// Test empty choices
	emptyResponse := &schemas.UnifAIChatResponse{
	...
	toolCallsResponse := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
	...
	responseWithToolCalls := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
	...
	responseWithStopReason := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
	...
	responseWithStopNoTools := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
	...
	// ToUnifAIChatResponse() splits text and tool calls across separate choices when a model
	// returns both text content and tool calls (e.g. Claude via the /v1/responses endpoint).
	responseWithToolCallsInSecondChoice := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
...
func TestExtractToolCalls(t *testing.T) {
	...
	responseNoTools := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
			},
	...
	responseWithTools := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
					Message: &schemas.ChatMessage{
...
func TestExecuteAgentForChatRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	responseWithNonAutoTools := &schemas.UnifAIChatResponse{
		Choices: []schemas.UnifAIResponseChoice{
			{
				FinishReason: schemas.Ptr("tool_calls"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
...
func TestHasToolCallsForResponsesResponse(t *testing.T) {
	...
	// Test empty output
	emptyResponse := &schemas.UnifAIResponsesResponse{
	...
	responseWithFunctionCall := &schemas.UnifAIResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
	...
	responseWithoutToolMessage := &schemas.UnifAIResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
	...
	responseWithRegularMessage := &schemas.UnifAIResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
...
func TestExecuteAgentForResponsesRequest(t *testing.T) {
	...
	// Test with response that has no tool calls - should return immediately
	responseNoTools := &schemas.UnifAIResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeMessage),
...
func TestExecuteAgentForResponsesRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	// Create a response with tool calls that will NOT be auto-executed
	responseWithNonAutoTools := &schemas.UnifAIResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
				Role: schemas.Ptr(schemas.ResponsesInputMessageRoleAssistant),
...
func (m *MockAutoClientManager) AcquireClientConn(ctx *schemas.UnifAIContext, state *schemas.MCPClientState) (*client.Client, func(), error) {
	return nil, func() {}, nil
}
func (m *MockAutoClientManager) RunWithPluginPipeline(ctx *schemas.UnifAIContext, req *schemas.UnifAIMCPRequest, op MCPOpFunc) (*schemas.UnifAIMCPResponse, *schemas.UnifAIError) {
	resp, err := op(req)
	if err != nil {
		return nil, &schemas.UnifAIError{IsUnifAIError: false, Error: &schemas.ErrorField{Message: err.Error()}}
	}
...
// single LLM response each receive a unique UnifAIContextKeyMCPLogID in their context.
//
...
func TestParallelToolCallsHaveUniqueMCPLogIDs(t *testing.T) {
	...
	executeToolFunc := func(ctx *schemas.UnifAIContext, req *schemas.UnifAIMCPRequest) (*schemas.UnifAIMCPResponse, error) {
