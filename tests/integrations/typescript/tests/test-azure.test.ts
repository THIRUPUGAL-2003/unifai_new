/**
 * Azure OpenAI SDK Integration Tests - Azure Provider via UnifAI
 *
 * This test suite uses the AzureOpenAI SDK to test against Azure through UnifAI.
 ...
 *   uses the model as deployment-id in the URL path, and UnifAI's AzureEndpointPreHook
