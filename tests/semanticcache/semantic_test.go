...
func TestSemantic(t *testing.T) {
	...
	// 2.8 cache_type_direct_in_semantic — x-uf-cache-type=direct on a paraphrase
	...
	// 2.9 cache_type_semantic_only_exact — x-uf-cache-type=semantic on identical
	...
	t.Run("2.32_dimension_change_silent_miss", func(t *testing.T) {
		...
		// If UnifAI errors instead, the test will fail at postChat with status!=200
