...
const enterpriseFeaturesDir = resolve(__dirname, '../../../unifai-enterprise/tests/e2e/features')
const includeEnterprise = process.env.UNIFAI_E2E_INCLUDE_ENTERPRISE === '1' && existsSync(enterpriseFeaturesDir)
...
/**
 * Playwright configuration for UnifAI E2E tests
