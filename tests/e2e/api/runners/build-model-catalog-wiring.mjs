...
const DEFAULT_OUT = join(HERE, "..", "collections", "unifai-model-catalog-wiring.postman_collection.json");

// Each entry generates the full six-scenario suite against a custom provider
// whose base_provider_type is `type`. Key values use UnifAI's `env.<NAME>`
// resolution: the credential is read from the UnifAI process env at request
...
const collection = buildCollection({
  id: "unifai-model-catalog-wiring",
  name: "UnifAI Model Catalog Wiring",
  description:
