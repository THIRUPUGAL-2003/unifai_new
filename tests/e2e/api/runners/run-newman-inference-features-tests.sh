...
# UnifAI V1 Inference with UnifAI Features Newman Test Runner
...
COLLECTION="collections/unifai-v1-inference-features.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Inference with UnifAI Features Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
