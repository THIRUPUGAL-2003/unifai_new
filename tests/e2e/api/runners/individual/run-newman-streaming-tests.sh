...
# UnifAI V1 Streaming Newman Test Runner
...
COLLECTION="collections/unifai-v1-streaming.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Streaming Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
