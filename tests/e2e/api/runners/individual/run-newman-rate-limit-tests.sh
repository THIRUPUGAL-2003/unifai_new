...
# UnifAI V1 Rate Limit Newman Test Runner
...
COLLECTION="collections/unifai-v1-rate-limit.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Rate Limit Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
