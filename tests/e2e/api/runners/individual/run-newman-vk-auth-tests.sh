...
# UnifAI V1 Virtual Key Auth Newman Test Runner
...
# Configuration
COLLECTION="collections/unifai-v1-vk-auth.postman_collection.json"
...
# Print banner
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Virtual Key Auth Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
