...
# UnifAI Routing Wiring Test Runner
...
COLLECTION="collections/unifai-routing-wiring.postman_collection.json"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}UnifAI Routing Wiring Tests${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
set +e
"${cmd[@]}" --reporter-htmlextra-export "$REPORT_DIR/report.html" --reporter-htmlextra-title "UnifAI Routing Wiring"
EXIT_CODE=$?
set -e
