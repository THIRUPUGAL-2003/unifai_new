...
# UnifAI OpenAI Integration API Newman Test Runner
...
# Configuration
COLLECTION="collections/unifai-openai-integration.postman_collection.json"
...
if [ "$ci_normalized" = "1" ] || [ "$ci_normalized" = "true" ]; then
    echo -e "${GREEN}UnifAI OpenAI Integration API Test Runner with retries: 10${NC}"
else
    echo -e "${GREEN}UnifAI OpenAI Integration API Test Runner${NC}"
fi
echo -e "${GREEN}========================================${NC}"
echo ""
