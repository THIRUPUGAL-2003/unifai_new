...
# UnifAI V1 Management E2E Flows Newman Test Runner
...
COLLECTION="collections/unifai-v1-mgmt-flows.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Management E2E Flows Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
