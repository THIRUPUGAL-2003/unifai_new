...
# UnifAI V1 VK Routing Newman Test Runner
...
COLLECTION="collections/unifai-v1-vk-routing.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 VK Routing Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
