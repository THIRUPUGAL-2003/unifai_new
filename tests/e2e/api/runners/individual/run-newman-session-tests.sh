...
# UnifAI V1 Session Stickiness Newman Test Runner
# Runs session stickiness tests (x-uf-session-id, x-uf-session-ttl).
...
COLLECTION="collections/unifai-v1-session.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Session Stickiness Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
