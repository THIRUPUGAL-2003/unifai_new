...
# UnifAI V1 Async Inference Newman Test Runner
...
COLLECTION="collections/unifai-v1-async.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}UnifAI V1 Async Inference Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
