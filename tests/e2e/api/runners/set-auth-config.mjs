...
const username = process.env.UNIFAI_E2E_ADMIN_USERNAME || "admin";
const password = process.env.UNIFAI_E2E_ADMIN_PASSWORD || "UnifAI-E2E-Admin-Pass1!";
const authHeader = process.env.UNIFAI_E2E_AUTH_HEADER || "";
