...
This directory contains community-maintained data that powers parts of the UnifAI platform. Contributions are reviewed by maintainers and, once merged into the `dev` branch, are synced to the live platform.
...
4. **Live** — UnifAI periodically reads the latest data from `dev` and serves it to all users.
...
If you'd like to propose a new community-maintained catalog, open a [feature request](https://github.com/unifai/unifai/issues/new?template=feature_request.yml) describing:
