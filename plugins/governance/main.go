...
//   - `config.IsVkMandatory` controls whether `x-uf-vk` is required in PreLLMHook.
...
// from the x-uf-mcp-include-tools header in lib/ctx.go) down to the tools the virtual key
