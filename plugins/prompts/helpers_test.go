...
func (r *staticResolver) Resolve(_ *schemas.UnifAIContext, _ *schemas.UnifAIRequest) (string, int, error) {
...
// chatRequest returns a UnifAIRequest wrapping a ChatRequest with the given messages.
func chatRequest(msgs ...schemas.ChatMessage) *schemas.UnifAIRequest {
...
// bfCtx returns a fresh UnifAIContext with no deadline.
func bfCtx() *schemas.UnifAIContext {
...
// chatRequestWithParams returns a UnifAIRequest with Params pre-set.
func chatRequestWithParams(params *schemas.ChatParameters, msgs ...schemas.ChatMessage) *schemas.UnifAIRequest {
	return &schemas.UnifAIRequest{
		ChatRequest: &schemas.UnifAIChatRequest{
			Input:  append([]schemas.ChatMessage{}, msgs...),
			Params: params,
...
// chatRequestWithModel returns a UnifAIRequest with the Model field pre-set.
func chatRequestWithModel(model string, msgs ...schemas.ChatMessage) *schemas.UnifAIRequest {
	return &schemas.UnifAIRequest{
		ChatRequest: &schemas.UnifAIChatRequest{
			Model: model,
			Input: append([]schemas.ChatMessage{}, msgs...),
...
// the UnifAI UI writes for assistant (completion_result) messages.
