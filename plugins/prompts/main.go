...
// keys populated from HTTP headers in HTTPTransportPreHook (x-uf-prompt-id, x-uf-prompt-version).
...
// x-uf-prompt-version header or a custom PromptResolver such as deployment traffic routing).
