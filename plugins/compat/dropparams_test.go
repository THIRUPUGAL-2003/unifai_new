...
func newTestContext() *schemas.UnifAIContext {
	return schemas.NewUnifAIContext(context.Background(), time.Time{})
}

func newResponsesRequest(provider schemas.ModelProvider, model string, params *schemas.ResponsesParameters) *schemas.UnifAIRequest {
	return &schemas.UnifAIRequest{
		RequestType:      schemas.ResponsesRequest,
		ResponsesRequest: &schemas.UnifAIResponsesRequest{Provider: provider, Model: model, Params: params},
	}
}
...
func TestDropUnsupportedParams_ChatMaxCompletionTokensUnchanged(t *testing.T) {
	newChat := func() *schemas.UnifAIRequest {
		return &schemas.UnifAIRequest{
