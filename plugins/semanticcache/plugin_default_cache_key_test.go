...
func TestDefaultCacheKey_CachesWithoutPerRequestKey(t *testing.T) {
	...
	testRequest := CreateBasicChatRequest("What is UnifAI? Answer in one short sentence.", 0.7, 50)
...
func TestDefaultCacheKey_PerRequestKeyOverridesDefault(t *testing.T) {
	...
	AssertCacheHit(t, &schemas.UnifAIResponse{ChatResponse: responseDefault2}, string(CacheTypeDirect))
