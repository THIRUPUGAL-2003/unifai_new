			...
			<div className="space-y-4">
							...
							<div>
								...
								<ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
									<li>
										...
										<code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">x-uf-eh-*</code> prefix. For example,{" "}
										<code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">x-uf-eh-custom-id</code> is forwarded as{" "}
							...
							<div>
								...
								<ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
									<li>
										...
										<code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">x-uf-eh-*</code> prefixed headers are forwarded
										(default behavior)
									</li>
									<li>
							...
							<div>
								...
								<ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
									<li>
										...
										<code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">x-uf-eh-</code> prefix
									</li>
									<li>
										Example: To allow <code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">x-uf-eh-custom-id</code> or direct{" "}
					...
					<AccordionItem value="security-note">
						...
						<AccordionContent>
							...
							<p className="text-muted-foreground mt-1 font-mono text-xs">
								proxy-authorization, cookie, host, content-length, connection, transfer-encoding, x-api-key, x-goog-api-key, x-uf-api-key,
								x-uf-vk
							</p>
						</AccordionContent>
					</AccordionItem>
				...
				<div className="space-y-3">
					<div className="space-y-1">
						...
						<p className="text-muted-foreground text-xs">
							Headers to allow. Enter names without the <code className="bg-muted rounded px-1 font-mono">x-uf-eh-</code> prefix. Any header
				...
				<div className="space-y-3">
					<div className="space-y-1">
						...
						<p className="text-muted-foreground text-xs">
							Headers to block. Enter names without the <code className="bg-muted rounded px-1 font-mono">x-uf-eh-</code> prefix. Applies to
