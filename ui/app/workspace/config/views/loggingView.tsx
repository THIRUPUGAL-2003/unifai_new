	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4">
			...
			<div className="space-y-4">
					...
					<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">
								...
								{!unifaiConfig?.is_logs_connected && (
				...
				{localConfig.enable_logging && unifaiConfig?.is_logs_connected && (
					<div>
						<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
							<div className="space-y-0.5">
					...
					<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">
								...
								<code className="text-xs">x-uf-disable-content-logging</code> header or context key, and can opt-in to persisting raw
								provider bytes in logs using the <code className="text-xs">x-uf-store-raw-request-response</code> header. Raw-byte storage
								requires content logging to be on — either globally, or via{" "}
								<code className="text-xs">x-uf-disable-content-logging: false</code> on the same request. If content logging is off, raw
								bytes are dropped from the log record even when <code className="text-xs">x-uf-store-raw-request-response: true</code>. Does
				...
				<div className="flex items-center justify-between space-x-2 rounded-sm border p-4">
					<div className="space-y-0.5">
						...
						<p className="text-muted-foreground text-sm">
							...
							<code className="text-xs">x-uf-send-back-raw-request</code> and <code className="text-xs">x-uf-send-back-raw-response</code>{" "}
				...
				{localConfig.enable_logging && unifaiConfig?.is_logs_connected && (
					<div className="space-y-2 rounded-sm border p-4">
						...
						<p className="text-muted-foreground text-sm">
							...
							<code className="text-xs">x-uf-lh-</code> prefix are always captured automatically.
						</p>
						<Textarea
							id="logging-headers"
