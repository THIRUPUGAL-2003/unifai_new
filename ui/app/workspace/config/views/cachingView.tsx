		...
		<div className="mx-auto w-full max-w-4xl space-y-6">
			<div>
				...
				<p className="text-muted-foreground text-sm">
					...
					similarity search for related content. Send the <b>x-uf-cache-key</b> header to scope cached responses to a tenant or feature.
				</p>
			</div>
							...
							<div className={cn("space-y-4", !cachingActive && "pointer-events-none opacity-50")} aria-disabled={!cachingActive}>
								...
								<div className="space-y-4">
									...
									<div className={cn("grid gap-4", mode === "semantic" ? "grid-cols-2" : "grid-cols-1")}>
										<div className="space-y-2">
											...
											/>
											<p className="text-muted-foreground text-xs">
												How long cached entries live before they expire. Override per-request via the <b>x-uf-cache-ttl</b> header.
											</p>
										</div>
										{mode === "semantic" && (
											<div className="space-y-2">
												...
												/>
												<p className="text-muted-foreground text-xs">
													Minimum cosine similarity for a semantic hit. Override per-request via <b>x-uf-cache-threshold</b>.
												</p>
											</div>
										)}
									</div>
								...
								<div className="space-y-2">
									...
									<ul className="text-muted-foreground list-inside list-disc text-xs">
										<li>
											<b>x-uf-cache-key</b>: scope this request to a specific cache partition.
										</li>
										<li>
											<b>x-uf-cache-ttl</b>: override TTL for just this request.
										</li>
										<li>
											<b>x-uf-cache-threshold</b>: override the semantic similarity threshold.
										</li>
										<li>
											<b>x-uf-cache-type</b>: send <code>direct</code> or <code>semantic</code> to limit lookup to one path.
										</li>
										<li>
											<b>x-uf-cache-no-store</b>: <code>true</code> to skip writing the response (still serves cached hits).
										</li>
									</ul>
								</div>
							</div>
