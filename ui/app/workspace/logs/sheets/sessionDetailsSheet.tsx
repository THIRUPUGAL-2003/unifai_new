...
import { displayLogStatus, RequestTypeColors, RequestTypeLabels, StatusBarColors } from "@/lib/constants/logs";
						...
						<TableBody>
							{loadingSession && sessionLogs.length === 0 ? (
								...
								sessionLogs.map((log) => (
									...
									>
										<TableCell>
											<div className={`h-6 w-1 rounded-sm ${StatusBarColors[displayLogStatus(log.status, log.error_details)]}`} />
										</TableCell>
