...
export default function TrialExpiryBanner() {
	...
	const supportHref = `mailto:support@UnifAI.ai?subject=${encodeURIComponent(subject)}`;
	...
	return (
		...
		>
			...
			{expired ? (
				<span>
					Your UnifAI Enterprise Trial has expired.{" "}
				...
				<span>
					Your UnifAI Enterprise Trial expires in {daysRemaining} {daysRemaining === 1 ? "day" : "days"}.{" "}
					<a href={supportHref} className="font-semibold underline underline-offset-2">
						Contact us
					</a>{" "}
					if you need any assistance.
