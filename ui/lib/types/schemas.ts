...
// UnifAI config schema
export const unifaiConfigSchema = z.object({
...
export const prometheusConfigSchema = z
	.object({
		...
		job_name: z.string().default("unifai"),
...
// Controls which headers with the x-uf-eh-* prefix are forwarded to LLM providers
