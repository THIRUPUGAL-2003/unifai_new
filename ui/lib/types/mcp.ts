...
export interface OAuthConfig {
	...
	resource?: string; // Optional RFC 8707 resource indicator, normally auto-discovered
...
export interface MCPClientConfig {
	...
	allowed_extra_headers?: string[]; // Allowlist of x-uf-eh-* headers forwarded to this MCP server. ["*"] = allow all.
