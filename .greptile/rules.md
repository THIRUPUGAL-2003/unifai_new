...
When reviewing a PR, first identify which UnifAI area is touched:
...
- Do not set UnifAI reserved context keys from handlers or plugins.
...
For `transports/unifai-http/handlers/**`:
