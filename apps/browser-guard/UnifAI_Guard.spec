...
datas = [('c:/Users/HP/Desktop/unify - Copy/apps/browser-guard/proxy/browser_ai_proxy.py', '.')]
binaries = []
...
a = Analysis(
    ['c:/Users/HP/Desktop/unify - Copy/apps/browser-guard/agent/unifai_agent.py'],
    pathex=[],
    binaries=binaries,
    datas=datas,
