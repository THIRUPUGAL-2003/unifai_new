...
import (
	...
	"github.com/unifai/unifai/cli/internal/config"
	"github.com/unifai/unifai/cli/internal/harness"
	"github.com/unifai/unifai/cli/internal/installer"
	"github.com/unifai/unifai/cli/internal/mcp"
	"github.com/unifai/unifai/cli/internal/runtime"
	"github.com/unifai/unifai/cli/internal/secrets"
	"github.com/unifai/unifai/cli/internal/ui/logo"
	"github.com/unifai/unifai/cli/internal/ui/tui"
...
// App is the main UnifAI CLI application. It manages configuration, state,
...
func (a *App) Run(ctx context.Context) error {
	...
	if updateVersion != "" {
		...
		if shouldUpdate {
			...
			if err != nil {
				fmt.Fprintf(a.out, "Updated successfully. Please restart unifai.\n")
				return nil
			}
...
// getOrCreateProfile fetches or creates a new UnifAI CLI profile
