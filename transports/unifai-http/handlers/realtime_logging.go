...
func extractRealtimeTurnSummary(event *schemas.UnifAIRealtimeEvent, contentOverride string) string {
...
func finalizedRealtimeInputSummary(event *schemas.UnifAIRealtimeEvent) string {
	if event == nil {
		return ""
	}
...
func pendingRealtimeInputUpdate(event *schemas.UnifAIRealtimeEvent) (string, string) {
	if event == nil {
		return "", ""
	}
...
func finalizedRealtimeToolOutputSummary(event *schemas.UnifAIRealtimeEvent) string {
...
func pendingRealtimeToolOutputUpdate(event *schemas.UnifAIRealtimeEvent) (string, string) {
...
func extractRealtimeExtraParamString(event *schemas.UnifAIRealtimeEvent, key string) string {
...
func realtimeEventItemID(event *schemas.UnifAIRealtimeEvent) string {
	if event == nil {
		return ""
	}
...
func combineRealtimeInputRaw(turnInputs []ufws.RealtimeTurnInput) string {
	var parts []string
...
func extractRealtimeTurnUsage(provider schemas.RealtimeProvider, rawMessage []byte) *schemas.UnifAILLMUsage {
...
func extractRealtimeResponseDoneUsage(rawMessage []byte) *schemas.UnifAILLMUsage {
	if len(rawMessage) == 0 {
		return nil
	}
