...
func (h *OAuth2ConsentHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.UnifAIHTTPMiddleware) {
...
// resolveIdentity resolves uf_mode and uf_sub for the submitted consent.
