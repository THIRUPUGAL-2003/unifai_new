...
// make UnifAI's /mcp endpoint a spec-compliant OAuth 2.1 protected resource:
//
...
func (h *OAuth2DiscoveryHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.UnifAIHTTPMiddleware) {
