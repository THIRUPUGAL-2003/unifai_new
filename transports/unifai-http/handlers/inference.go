...
// forwardProviderHeadersFromContext extracts provider response headers from the unifai context
// and forwards them to the HTTP response. This ensures error responses also include provider headers.
func forwardProviderHeadersFromContext(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext) {
...
func NewInferenceHandler(client *unifai.UnifAI, config *lib.Config) *CompletionHandler {
...
func (b UnifAIParams) getModel() string       { return b.Model }
func (b UnifAIParams) getFallbacks() []string { return b.Fallbacks }

// baseRequest is satisfied by any type that embeds UnifAIParams.
...
// which interferes with sonic's handling of the embedded UnifAIParams struct.
func (cr *ChatRequest) UnmarshalJSON(data []byte) error {
	// First, unmarshal UnifAIParams fields directly
	type unifaiAlias UnifAIParams
	var bp unifaiAlias
	if err := sonic.Unmarshal(data, &bp); err != nil {
		return err
	}
	cr.UnifAIParams = UnifAIParams(bp)
...
func (rr *ResponsesRequest) UnmarshalJSON(data []byte) error {
	...
	rr.UnifAIParams = UnifAIParams(bp)
...
// ResponsesRequest is a unifai responses request
...
// CompactionHTTPRequest is a unifai compaction request (subset of responses fields)
...
// EmbeddingRequest is a unifai embedding request
...
// RerankRequest is a unifai rerank request
...
// OCRHandlerRequest is a unifai OCR request
...
// BatchCreateRequest is a unifai batch create request
...
// BatchListRequest is a unifai batch list request
...
// ContainerCreateRequest is a unifai container create request
...
func enableRawRequestResponseForContainer(unifaiCtx *schemas.UnifAIContext) {
	unifaiCtx.SetValue(schemas.UnifAIContextKeySendBackRawRequest, true)
	unifaiCtx.SetValue(schemas.UnifAIContextKeySendBackRawResponse, true)
	unifaiCtx.SetValue(schemas.UnifAIContextKeyStoreRawRequestResponse, true)
}
...
func createRequestTypeMiddleware(requestType schemas.RequestType) schemas.UnifAIHTTPMiddleware {
...
func (h *CompletionHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.UnifAIHTTPMiddleware) {
	// Base middlewares for all routes
	baseMiddlewares := append([]schemas.UnifAIHTTPMiddleware{RegisterRequestTypeMiddleware}, middlewares...)
	...
	responsesRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ResponsesRetrieveRequest)}, middlewares...)
	responsesDeleteMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ResponsesDeleteRequest)}, middlewares...)
	responsesCancelMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ResponsesCancelRequest)}, middlewares...)
	responsesInputItemsMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ResponsesInputItemsRequest)}, middlewares...)
	...
	videoListMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.VideoListRequest)}, middlewares...)
	videoRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.VideoRetrieveRequest)}, middlewares...)
	videoDownloadMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.VideoDownloadRequest)}, middlewares...)
	videoDeleteMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.VideoDeleteRequest)}, middlewares...)
	videoRemixMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.VideoRemixRequest)}, middlewares...)
	...
	batchCreateMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.BatchCreateRequest)}, middlewares...)
	batchListMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.BatchListRequest)}, middlewares...)
	batchRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.BatchRetrieveRequest)}, middlewares...)
	batchCancelMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.BatchCancelRequest)}, middlewares...)
	batchResultsMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.BatchResultsRequest)}, middlewares...)
	...
	fileUploadMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.FileUploadRequest)}, middlewares...)
	fileListMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.FileListRequest)}, middlewares...)
	fileRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.FileRetrieveRequest)}, middlewares...)
	fileDeleteMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.FileDeleteRequest)}, middlewares...)
	fileContentMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.FileContentRequest)}, middlewares...)
	...
	containerCreateMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerCreateRequest)}, middlewares...)
	containerListMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerListRequest)}, middlewares...)
	containerRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerRetrieveRequest)}, middlewares...)
	containerDeleteMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerDeleteRequest)}, middlewares...)
	...
	containerFileCreateMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerFileCreateRequest)}, middlewares...)
	containerFileListMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerFileListRequest)}, middlewares...)
	containerFileRetrieveMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerFileRetrieveRequest)}, middlewares...)
	containerFileContentMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerFileContentRequest)}, middlewares...)
	containerFileDeleteMW := append([]schemas.UnifAIHTTPMiddleware{createRequestTypeMiddleware(schemas.ContainerFileDeleteRequest)}, middlewares...)
...
func (h *CompletionHandler) listModels(ctx *fasthttp.RequestCtx) {
	...
	if provider == "" && !h.applyListModelsVirtualKeyProviderFilter(ctx, unifaiCtx) {
		return
	}

	var resp *schemas.UnifAIListModelsResponse
	...
	unifaiListModelsReq := &schemas.UnifAIListModelsRequest{
	...
	if len(extraParams) > 0 {
		unifaiListModelsReq.ExtraParams = extraParams
	}

	// If provider is empty, list all models from all providers
	if provider == "" {
		resp, unifaiErr = h.client.ListAllModels(unifaiCtx, unifaiListModelsReq)
	} else {
		resp, unifaiErr = h.client.ListModelsRequest(unifaiCtx, unifaiListModelsReq)
	}

	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
	}

	if streamLargeResponseIfActive(ctx, unifaiCtx) {
		return
	}
...
func enrichAndFilterListModelsResponse(resp *schemas.UnifAIListModelsResponse, catalog *modelcatalog.ModelCatalog) {
	...
	for _, modelEntry := range resp.Data {
		...
		if pricingEntry != nil {
			...
			if pricingEntry.BaseModel != "" && modelEntry.NormalizedName == nil {
				modelEntry.NormalizedName = unifai.Ptr(providerUtils.NormalizeBaseModelSlug(pricingEntry.BaseModel))
			}
			...
			if modelEntry.Pricing == nil {
				...
				if pricingEntry.InputCostPerToken != nil {
					pricing.Prompt = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.InputCostPerToken))
				}
				if pricingEntry.OutputCostPerToken != nil {
					pricing.Completion = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.OutputCostPerToken))
				}
				if pricingEntry.InputCostPerImage != nil {
					pricing.Image = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.InputCostPerImage))
				}
				if pricingEntry.CacheReadInputTokenCost != nil {
					pricing.InputCacheRead = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.CacheReadInputTokenCost))
				}
				if pricingEntry.CacheCreationInputTokenCost != nil {
					pricing.InputCacheWrite = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.CacheCreationInputTokenCost))
				}
				if pricingEntry.SearchContextCostPerQuery != nil {
					pricing.WebSearch = unifai.Ptr(fmt.Sprintf("%.10f", *pricingEntry.SearchContextCostPerQuery))
				}
...
// prepareTextCompletionRequest prepares a UnifAITextCompletionRequest from the HTTP request body
func prepareTextCompletionRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*TextRequest, *schemas.UnifAITextCompletionRequest, error) {
	...
	return req, &schemas.UnifAITextCompletionRequest{
...
func (h *CompletionHandler) textCompletion(ctx *fasthttp.RequestCtx) {
	...
	if req.Stream != nil && *req.Stream {
		h.handleStreamingTextCompletion(ctx, unifaiTextReq, unifaiCtx, cancel)
		return
	}
	...
	resp, unifaiErr := h.client.TextCompletionRequest(unifaiCtx, unifaiTextReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareChatCompletionRequest prepares a UnifAIChatRequest from a ChatRequest
func prepareChatCompletionRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*ChatRequest, *schemas.UnifAIChatRequest, error) {
	...
	return req, &schemas.UnifAIChatRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
		Input:     req.Messages,
...
func (h *CompletionHandler) chatCompletion(ctx *fasthttp.RequestCtx) {
	...
	if effectiveStream(req.Stream) {
		h.handleStreamingChatCompletion(ctx, unifaiChatReq, unifaiCtx, cancel)
		return
	}
	defer cancel() // Ensure cleanup on function exit
	// Complete the request
	resp, unifaiErr := h.client.ChatCompletionRequest(unifaiCtx, unifaiChatReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareResponsesRequest prepares a UnifAIResponsesRequest from a ResponsesRequest
func prepareResponsesRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*ResponsesRequest, *schemas.UnifAIResponsesRequest, error) {
	...
	return req, &schemas.UnifAIResponsesRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
		Input:     input,
...
func (h *CompletionHandler) responses(ctx *fasthttp.RequestCtx) {
	...
	if effectiveStream(req.Stream) {
		h.handleStreamingResponses(ctx, unifaiResponsesReq, unifaiCtx, cancel)
		return
	}

	defer cancel() // Ensure cleanup on function exit

	resp, unifaiErr := h.client.ResponsesRequest(unifaiCtx, unifaiResponsesReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareEmbeddingRequest prepares a UnifAIEmbeddingRequest from the HTTP request body
func prepareEmbeddingRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*EmbeddingRequest, *schemas.UnifAIEmbeddingRequest, error) {
	...
	return req, &schemas.UnifAIEmbeddingRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
		Input:     req.Input,
...
func (h *CompletionHandler) embeddings(ctx *fasthttp.RequestCtx) {
	...
	resp, unifaiErr := h.client.EmbeddingRequest(unifaiCtx, unifaiEmbeddingReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareRerankRequest prepares a UnifAIRerankRequest from the HTTP request body
func prepareRerankRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*RerankRequest, *schemas.UnifAIRerankRequest, error) {
	...
	return req, &schemas.UnifAIRerankRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
		Query:     req.Query,
...
func (h *CompletionHandler) rerank(ctx *fasthttp.RequestCtx) {
	_, unifaiRerankReq, err := prepareRerankRequest(ctx, h.config)
	if err != nil {
		SendError(ctx, fasthttp.StatusBadRequest, err.Error())
		return
	}
	...
	resp, unifaiErr := h.client.RerankRequest(unifaiCtx, unifaiRerankReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareOCRRequest prepares a UnifAIOCRRequest from the HTTP request body
func prepareOCRRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*OCRHandlerRequest, *schemas.UnifAIOCRRequest, error) {
	...
	return req, &schemas.UnifAIOCRRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
		ID:        req.ID,
...
func (h *CompletionHandler) ocr(ctx *fasthttp.RequestCtx) {
	_, unifaiOCRReq, err := prepareOCRRequest(ctx, h.config)
	if err != nil {
		SendError(ctx, fasthttp.StatusBadRequest, err.Error())
		return
	}
	...
	resp, unifaiErr := h.client.OCRRequest(unifaiCtx, unifaiOCRReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareSpeechRequest prepares a UnifAISpeechRequest from the HTTP request body
func prepareSpeechRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*SpeechRequest, *schemas.UnifAISpeechRequest, error) {
	...
	return req, &schemas.UnifAISpeechRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
...
func (h *CompletionHandler) speech(ctx *fasthttp.RequestCtx) {
	...
	if req.StreamFormat != nil && *req.StreamFormat == "sse" {
		h.handleStreamingSpeech(ctx, unifaiSpeechReq, unifaiCtx, cancel)
		return
	}

	defer cancel() // Ensure cleanup on function exit

	resp, unifaiErr := h.client.SpeechRequest(unifaiCtx, unifaiSpeechReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
	...
	if !(unifaiSpeechReq.Provider == schemas.Elevenlabs && req.WithTimestamps != nil && *req.WithTimestamps) {
		unifaiCtx.SetValue(schemas.UnifAIContextKeyLargeResponseContentDisposition, "attachment; filename=speech.mp3")
	}
	...
	if unifaiSpeechReq.Provider == schemas.Elevenlabs && hasTimestamps {
...
// prepareTranscriptionRequest prepares a UnifAITranscriptionRequest from a multipart form.
// Returns the request, whether streaming was requested, and any error.
func prepareTranscriptionRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*schemas.UnifAITranscriptionRequest, bool, error) {
	...
	unifaiTranscriptionReq := &schemas.UnifAITranscriptionRequest{
		Model:     modelName,
		Provider:  schemas.ModelProvider(provider),
	...
	return unifaiTranscriptionReq, stream, nil
}
...
func (h *CompletionHandler) transcription(ctx *fasthttp.RequestCtx) {
	...
	if stream {
		h.handleStreamingTranscriptionRequest(ctx, unifaiTranscriptionReq, unifaiCtx, cancel)
		return
	}

	defer cancel()

	resp, unifaiErr := h.client.TranscriptionRequest(unifaiCtx, unifaiTranscriptionReq)
...
func (h *CompletionHandler) countTokens(ctx *fasthttp.RequestCtx) {
	_, unifaiResponsesReq, err := prepareResponsesRequest(ctx, h.config)
	if err != nil {
		SendError(ctx, fasthttp.StatusBadRequest, err.Error())
		return
	}
	...
	response, unifaiErr := h.client.CountTokensRequest(unifaiCtx, unifaiResponsesReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
// prepareCompactionRequest prepares a UnifAICompactionRequest from the HTTP request body
func prepareCompactionRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*CompactionHTTPRequest, *schemas.UnifAICompactionRequest, error) {
	...
	return req, &schemas.UnifAICompactionRequest{
		Provider:             base.Provider,
		Model:                base.ModelName,
		Input:                input,
...
func (h *CompletionHandler) responsesRetrieve(ctx *fasthttp.RequestCtx) {
	...
	unifaiReq := &schemas.UnifAIResponsesRetrieveRequest{
	...
	ctx.QueryArgs().VisitAll(func(key, value []byte) {
		switch string(key) {
		case "include":
			unifaiReq.Include = append(unifaiReq.Include, string(value))
		}
	})
	if raw := ctx.QueryArgs().Peek("starting_after"); len(raw) > 0 {
		...
		unifaiReq.StartingAfter = schemas.Ptr(n)
	}
	if raw := ctx.QueryArgs().Peek("include_obfuscation"); len(raw) > 0 {
		...
		unifaiReq.IncludeObfuscation = &b
	}
	unifaiCtx, cancel := lib.ConvertToUnifAIContext(ctx, h.config)
	defer cancel()
	if unifaiCtx == nil {
	...
	resp, unifaiErr := h.client.ResponsesRetrieveRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) compaction(ctx *fasthttp.RequestCtx) {
	_, unifaiCompactionReq, err := prepareCompactionRequest(ctx, h.config)
	if err != nil {
		SendError(ctx, fasthttp.StatusBadRequest, err.Error())
		return
	}
	...
	response, unifaiErr := h.client.CompactionRequest(unifaiCtx, unifaiCompactionReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) responsesDelete(ctx *fasthttp.RequestCtx) {
	...
	unifaiReq := &schemas.UnifAIResponsesDeleteRequest{
		Provider:   responsesLifecycleProviderFromQuery(ctx),
		ResponseID: responseID,
	}
	unifaiCtx, cancel := lib.ConvertToUnifAIContext(ctx, h.config)
	...
	resp, unifaiErr := h.client.ResponsesDeleteRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) responsesCancel(ctx *fasthttp.RequestCtx) {
	...
	unifaiReq := &schemas.UnifAIResponsesCancelRequest{
		Provider:   responsesLifecycleProviderFromQuery(ctx),
		ResponseID: responseID,
	}
	unifaiCtx, cancel := lib.ConvertToUnifAIContext(ctx, h.config)
	...
	resp, unifaiErr := h.client.ResponsesCancelRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) responsesInputItems(ctx *fasthttp.RequestCtx) {
	...
	unifaiReq := &schemas.UnifAIResponsesInputItemsRequest{
		Provider:   responsesLifecycleProviderFromQuery(ctx),
		ResponseID: responseID,
	}
	ctx.QueryArgs().VisitAll(func(key, value []byte) {
		switch string(key) {
		case "after":
			unifaiReq.After = string(value)
		case "include":
			unifaiReq.Include = append(unifaiReq.Include, string(value))
		case "order":
			unifaiReq.Order = string(value)
		}
	})
	...
	resp, unifaiErr := h.client.ResponsesInputItemsRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) handleStreamingTextCompletion(ctx *fasthttp.RequestCtx, req *schemas.UnifAITextCompletionRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	...
	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.TextCompletionStreamRequest(unifaiCtx, req)
	}

	h.handleStreamingResponse(ctx, unifaiCtx, getStream, cancel)
}

// handleStreamingChatCompletion handles streaming chat completion requests using Server-Sent Events (SSE)
func (h *CompletionHandler) handleStreamingChatCompletion(ctx *fasthttp.RequestCtx, req *schemas.UnifAIChatRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.ChatCompletionStreamRequest(unifaiCtx, req)
	}
...
func (h *CompletionHandler) handleStreamingResponses(ctx *fasthttp.RequestCtx, req *schemas.UnifAIResponsesRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.ResponsesStreamRequest(unifaiCtx, req)
	}
...
func (h *CompletionHandler) handleStreamingSpeech(ctx *fasthttp.RequestCtx, req *schemas.UnifAISpeechRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.SpeechStreamRequest(unifaiCtx, req)
	}
...
func (h *CompletionHandler) handleStreamingTranscriptionRequest(ctx *fasthttp.RequestCtx, req *schemas.UnifAITranscriptionRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.TranscriptionStreamRequest(unifaiCtx, req)
	}
...
func (h *CompletionHandler) handleStreamingResponse(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, getStream func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError), cancel context.CancelFunc) {
	...
	ctx.SetUserValue(schemas.UnifAIContextKeyTransportPostHookCompleter, &completerSlot)
	...
	go func() {
		...
		for chunk := range stream {
			...
			if chunk.UnifAIResponsesStreamResponse != nil ||
				chunk.UnifAIImageGenerationStreamResponse != nil ||
				(chunk.UnifAIError != nil && (chunk.UnifAIError.ExtraFields.RequestType == schemas.ResponsesStreamRequest || chunk.UnifAIError.ExtraFields.RequestType == schemas.ImageGenerationStreamRequest || chunk.UnifAIError.ExtraFields.RequestType == schemas.ImageEditStreamRequest)) {
				includeEventType = true
			}

			// Image generation streams don't use [DONE] marker
			if chunk.UnifAIImageGenerationStreamResponse != nil {
				skipDoneMarker = true
			}
				...
				if err != nil {
					if chunk == nil {
						...
						if errors.As(err, &structuredErr) && structuredErr != nil {
							if sanitized := lib.SanitizeUnifAIErrorForClient(structuredErr.UnifAIError); sanitized != nil {
			...
			if includeEventType {
				...
				if chunk.UnifAIResponsesStreamResponse != nil {
					eventType = string(chunk.UnifAIResponsesStreamResponse.Type)
				} else if chunk.UnifAIImageGenerationStreamResponse != nil {
					eventType = string(chunk.UnifAIImageGenerationStreamResponse.Type)
				} else if chunk.UnifAIError != nil {
		...
		// Stream completed normally, UnifAI handles cleanup internally
		cancel()
	}()
}
...
// prepareImageGenerationRequest prepares a UnifAIImageGenerationRequest from the HTTP request body
func prepareImageGenerationRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*ImageGenerationHTTPRequest, *schemas.UnifAIImageGenerationRequest, error) {
	...
	return req, &schemas.UnifAIImageGenerationRequest{
		Provider:  base.Provider,
		Model:     base.ModelName,
...
func (h *CompletionHandler) imageGeneration(ctx *fasthttp.RequestCtx) {
	...
	if req.UnifAIParams.Stream != nil && *req.UnifAIParams.Stream {
		h.handleStreamingImageGeneration(ctx, unifaiReq, unifaiCtx, cancel)
		return
	}
	defer cancel()

	// Execute request
	resp, unifaiErr := h.client.ImageGenerationRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) handleStreamingImageGeneration(ctx *fasthttp.RequestCtx, req *schemas.UnifAIImageGenerationRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context
	// Pass the context directly instead of copying to avoid copying lock values

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.ImageGenerationStreamRequest(unifaiCtx, req)
	}

	h.handleStreamingResponse(ctx, unifaiCtx, getStream, cancel)
}

// prepareImageEditRequest prepares a UnifAIImageEditRequest from a multipart form
func prepareImageEditRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*ImageEditHTTPRequest, *schemas.UnifAIImageEditRequest, error) {
...
func (h *CompletionHandler) imageEdit(ctx *fasthttp.RequestCtx) {
	...
	if req.Stream != nil && *req.Stream {
		h.handleStreamingImageEditRequest(ctx, unifaiReq, unifaiCtx, cancel)
		return
	}
	defer cancel()

	// Execute request
	resp, unifaiErr := h.client.ImageEditRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) handleStreamingImageEditRequest(ctx *fasthttp.RequestCtx, req *schemas.UnifAIImageEditRequest, unifaiCtx *schemas.UnifAIContext, cancel context.CancelFunc) {
	// Use the cancellable context from ConvertToUnifAIContext
	// See router.go for detailed explanation of why we need a cancellable context

	getStream := func() (chan *schemas.UnifAIStreamChunk, *schemas.UnifAIError) {
		return h.client.ImageEditStreamRequest(unifaiCtx, req)
	}

	h.handleStreamingResponse(ctx, unifaiCtx, getStream, cancel)
}

// prepareImageVariationRequest prepares a UnifAIImageVariationRequest from a multipart form
func prepareImageVariationRequest(ctx *fasthttp.RequestCtx, config *lib.Config) (*schemas.UnifAIImageVariationRequest, error) {
	...
	if fallbackValues := form.Value["fallbacks"]; len(fallbackValues) > 0 {
		...
		return &schemas.UnifAIImageVariationRequest{
			Provider:       schemas.ModelProvider(provider),
			Model:          modelName,
...
func (h *CompletionHandler) imageVariation(ctx *fasthttp.RequestCtx) {
	...
	resp, unifaiErr := h.client.ImageVariationRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoGeneration(ctx *fasthttp.RequestCtx) {
	...
	resp, unifaiErr := h.client.VideoGenerationRequest(unifaiCtx, unifaiReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoRetrieve(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI video retrieve request
	unifaiVideoReq := &schemas.UnifAIVideoRetrieveRequest{
		Provider: provider,
		ID:       idParts[0],
	}
	...
	resp, unifaiErr := h.client.VideoRetrieveRequest(unifaiCtx, unifaiVideoReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoDownload(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI video download request
	unifaiVideoReq := &schemas.UnifAIVideoDownloadRequest{
		Provider: schemas.ModelProvider(idParts[1]),
		ID:       idParts[0],
	}

	if variant != "" {
		unifaiVideoReq.Variant = schemas.Ptr(schemas.VideoDownloadVariant(variant))
	}
	...
	resp, unifaiErr := h.client.VideoDownloadRequest(unifaiCtx, unifaiVideoReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoList(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI video list request
	unifaiVideoReq := &schemas.UnifAIVideoListRequest{
		Provider: schemas.ModelProvider(provider),
	}
	...
	resp, unifaiErr := h.client.VideoListRequest(unifaiCtx, unifaiVideoReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoDelete(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI video delete request
	unifaiVideoReq := &schemas.UnifAIVideoDeleteRequest{
		Provider: schemas.ModelProvider(idParts[1]),
		ID:       idParts[0],
	}
	...
	resp, unifaiErr := h.client.VideoDeleteRequest(unifaiCtx, unifaiVideoReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) videoRemix(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI video remix request
	unifaiVideoReq := &schemas.UnifAIVideoRemixRequest{
		Provider: provider,
		ID:       idParts[0],
	...
	resp, unifaiErr := h.client.VideoRemixRequest(unifaiCtx, unifaiVideoReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) batchCreate(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI batch create request
	unifaiBatchReq := &schemas.UnifAIBatchCreateRequest{
		Provider:         schemas.ModelProvider(provider),
		Model:            model,
	...
	resp, unifaiErr := h.client.BatchCreateRequest(unifaiCtx, unifaiBatchReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) batchList(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI batch list request
	unifaiBatchReq := &schemas.UnifAIBatchListRequest{
		Provider: schemas.ModelProvider(provider),
		Limit:    limit,
		After:    after,
		BeforeID: before,
	...
	resp, unifaiErr := h.client.BatchListRequest(unifaiCtx, unifaiBatchReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) batchRetrieve(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI batch retrieve request
	unifaiBatchReq := &schemas.UnifAIBatchRetrieveRequest{
		Provider: schemas.ModelProvider(provider),
		BatchID:  batchID,
	}
	...
	resp, unifaiErr := h.client.BatchRetrieveRequest(unifaiCtx, unifaiBatchReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) batchCancel(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI batch cancel request
	unifaiBatchReq := &schemas.UnifAIBatchCancelRequest{
		Provider: schemas.ModelProvider(provider),
		BatchID:  batchID,
	}
	...
	resp, unifaiErr := h.client.BatchCancelRequest(unifaiCtx, unifaiBatchReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) batchResults(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI batch results request
	unifaiBatchReq := &schemas.UnifAIBatchResultsRequest{
		Provider: schemas.ModelProvider(provider),
		BatchID:  batchID,
	}
	...
	resp, unifaiErr := h.client.BatchResultsRequest(unifaiCtx, unifaiBatchReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) fileUpload(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI file upload request
	unifaiFileReq := &schemas.UnifAIFileUploadRequest{
		Provider:      schemas.ModelProvider(provider),
		File:          fileData,
		Filename:      filename,
	...
	resp, unifaiErr := h.client.FileUploadRequest(unifaiCtx, unifaiFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) fileList(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI file list request
	unifaiFileReq := &schemas.UnifAIFileListRequest{
		Provider:      schemas.ModelProvider(provider),
		Purpose:       schemas.FilePurpose(purpose),
		Limit:         limit,
		After:         after,
	...
	resp, unifaiErr := h.client.FileListRequest(unifaiCtx, unifaiFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) fileRetrieve(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI file retrieve request
	unifaiFileReq := &schemas.UnifAIFileRetrieveRequest{
		Provider: schemas.ModelProvider(provider),
		FileID:   fileID,
	}
	...
	resp, unifaiErr := h.client.FileRetrieveRequest(unifaiCtx, unifaiFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) fileDelete(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI file delete request
	unifaiFileReq := &schemas.UnifAIFileDeleteRequest{
		Provider: schemas.ModelProvider(provider),
		FileID:   fileID,
	}
	...
	resp, unifaiErr := h.client.FileDeleteRequest(unifaiCtx, unifaiFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) fileContent(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI file content request
	unifaiFileReq := &schemas.UnifAIFileContentRequest{
		Provider: schemas.ModelProvider(provider),
		FileID:   fileID,
	}
	...
	resp, unifaiErr := h.client.FileContentRequest(unifaiCtx, unifaiFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerCreate(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container create request
	unifaiContainerReq := &schemas.UnifAIContainerCreateRequest{
	...
	enableRawRequestResponseForContainer(unifaiCtx)

	resp, unifaiErr := h.client.ContainerCreateRequest(unifaiCtx, unifaiContainerReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerList(ctx *fasthttp.RequestCtx) {
	...
	var after, order *string
	if afterStr := ctx.QueryArgs().Peek("after"); len(afterStr) > 0 {
		after = unifai.Ptr(string(afterStr))
	}
	if orderStr := ctx.QueryArgs().Peek("order"); len(orderStr) > 0 {
		order = unifai.Ptr(string(orderStr))
	}

	// Build UnifAI container list request
	unifaiContainerReq := &schemas.UnifAIContainerListRequest{
		Provider: schemas.ModelProvider(provider),
		Limit:    limit,
		After:    after,
		Order:    order,
	...
	resp, unifaiErr := h.client.ContainerListRequest(unifaiCtx, unifaiContainerReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerRetrieve(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container retrieve request
	unifaiContainerReq := &schemas.UnifAIContainerRetrieveRequest{
		Provider:    schemas.ModelProvider(provider),
	...
	resp, unifaiErr := h.client.ContainerRetrieveRequest(unifaiCtx, unifaiContainerReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerDelete(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container delete request
	unifaiContainerReq := &schemas.UnifAIContainerDeleteRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
	}
	...
	resp, unifaiErr := h.client.ContainerDeleteRequest(unifaiCtx, unifaiContainerReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerFileCreate(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container file create request
	unifaiContainerFileReq := &schemas.UnifAIContainerFileCreateRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
	}
	...
	if strings.HasPrefix(contentType, "multipart/form-data") {
		...
		unifaiContainerFileReq.FileID = unifai.Ptr(reqBody.FileID)
		if reqBody.FilePath != "" {
			unifaiContainerFileReq.Path = unifai.Ptr(reqBody.FilePath)
		}
	}
	...
	resp, unifaiErr := h.client.ContainerFileCreateRequest(unifaiCtx, unifaiContainerFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerFileList(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container file list request
	unifaiContainerFileReq := &schemas.UnifAIContainerFileListRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
	}
	...
	if limit := ctx.QueryArgs().Peek("limit"); len(limit) > 0 {
		if limitInt, err := strconv.Atoi(string(limit)); err == nil && limitInt > 0 {
			unifaiContainerFileReq.Limit = limitInt
		}
	}
	if after := string(ctx.QueryArgs().Peek("after")); after != "" {
		unifaiContainerFileReq.After = unifai.Ptr(after)
	}
	if order := string(ctx.QueryArgs().Peek("order")); order != "" {
		unifaiContainerFileReq.Order = unifai.Ptr(order)
	}
	...
	resp, unifaiErr := h.client.ContainerFileListRequest(unifaiCtx, unifaiContainerFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerFileRetrieve(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container file retrieve request
	unifaiContainerFileReq := &schemas.UnifAIContainerFileRetrieveRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
		FileID:      fileID,
	}
	...
	resp, unifaiErr := h.client.ContainerFileRetrieveRequest(unifaiCtx, unifaiContainerFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerFileContent(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container file content request
	unifaiContainerFileReq := &schemas.UnifAIContainerFileContentRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
		FileID:      fileID,
	}
	...
	resp, unifaiErr := h.client.ContainerFileContentRequest(unifaiCtx, unifaiContainerFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
...
func (h *CompletionHandler) containerFileDelete(ctx *fasthttp.RequestCtx) {
	...
	// Build UnifAI container file delete request
	unifaiContainerFileReq := &schemas.UnifAIContainerFileDeleteRequest{
		Provider:    schemas.ModelProvider(provider),
		ContainerID: containerID,
		FileID:      fileID,
	}
	...
	resp, unifaiErr := h.client.ContainerFileDeleteRequest(unifaiCtx, unifaiContainerFileReq)
	if unifaiErr != nil {
		forwardProviderHeadersFromContext(ctx, unifaiCtx)
		SendUnifAIError(ctx, unifaiErr)
		return
