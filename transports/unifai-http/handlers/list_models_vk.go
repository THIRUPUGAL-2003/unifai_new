...
func (h *CompletionHandler) applyListModelsVirtualKeyProviderFilter(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext) bool {
	...
	unifaiCtx.SetValue(schemas.UnifAIContextKeyAvailableProviders, availableProviders)
	return true
}
