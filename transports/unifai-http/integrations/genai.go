...
const isGeminiEmbedContentRequestContextKey schemas.UnifAIContextKey = "unifai-is-gemini-embed-content-request"

const isGeminiVideoGenerationRequestContextKey schemas.UnifAIContextKey = "unifai-is-gemini-video-generation-request"

const isGeminiBatchCreateRequestContextKey schemas.UnifAIContextKey = "unifai-is-gemini-batch-create-request"

const requestedGeminiModelMetadataContextKey schemas.UnifAIContextKey = "unifai-requested-gemini-model-metadata"

const genAIRawRequestBodyContextKey schemas.UnifAIContextKey = "unifai-genai-raw-request-body"
...
func CreateGenAIRouteConfigs(pathPrefix string) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		GetRequestTypeInstance: func(ctx context.Context) interface{} {
			if requestType, ok := ctx.Value(schemas.UnifAIContextKeyHTTPRequestType).(schemas.RequestType); ok && requestType == schemas.EmbeddingRequest && ctx.Value(isGeminiEmbedContentRequestContextKey) != nil {
				return &gemini.GeminiEmbeddingRequest{}
			}
			if requestType, ok := ctx.Value(schemas.UnifAIContextKeyHTTPRequestType).(schemas.RequestType); ok && requestType == schemas.VideoGenerationRequest && ctx.Value(isGeminiVideoGenerationRequestContextKey) != nil {
				return &gemini.GeminiVideoGenerationRequest{}
			}
			if requestType, ok := ctx.Value(schemas.UnifAIContextKeyHTTPRequestType).(schemas.RequestType); ok && requestType == schemas.BatchCreateRequest && ctx.Value(isGeminiBatchCreateRequestContextKey) != nil {
		...
		RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
			if geminiReq, ok := req.(*gemini.GeminiGenerationRequest); ok {
				if geminiReq.IsCountTokens {
					return &schemas.UnifAIRequest{
						CountTokensRequest: geminiReq.ToUnifAIResponsesRequest(ctx),
					}, nil
				} else if geminiReq.IsEmbedding {
					return &schemas.UnifAIRequest{
						EmbeddingRequest: geminiReq.ToUnifAIEmbeddingRequest(ctx),
					}, nil
				} else if geminiReq.IsSpeech {
					return &schemas.UnifAIRequest{
						SpeechRequest: geminiReq.ToUnifAISpeechRequest(ctx),
					}, nil
				} else if geminiReq.IsTranscription {
					transcriptionReq, err := geminiReq.ToUnifAITranscriptionRequest(ctx)
					if err != nil {
						return nil, err
					}
					return &schemas.UnifAIRequest{TranscriptionRequest: transcriptionReq}, nil
				} else if geminiReq.IsImageGeneration {
					return &schemas.UnifAIRequest{
						ImageGenerationRequest: geminiReq.ToUnifAIImageGenerationRequest(ctx),
					}, nil
				} else if geminiReq.IsImageEdit {
					return &schemas.UnifAIRequest{
						ImageEditRequest: geminiReq.ToUnifAIImageEditRequest(ctx),
					}, nil
				} else {
					return &schemas.UnifAIRequest{
						ResponsesRequest: geminiReq.ToUnifAIResponsesRequest(ctx),
					}, nil
				}
				...
				return &schemas.UnifAIRequest{
					EmbeddingRequest: req.ToUnifAIEmbeddingRequest(ctx),
				}, nil
			} else if geminiReq, ok := req.(*gemini.GeminiVideoGenerationRequest); ok {
				// convert to unifai video generation request
				unifaiReq, err := geminiReq.ToUnifAIVideoGenerationRequest(ctx)
				if err != nil {
					return nil, err
				}
				return &schemas.UnifAIRequest{
					VideoGenerationRequest: unifaiReq,
				}, nil
			}
		...
		BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
			if geminiReq, ok := req.(*gemini.GeminiBatchCreateRequest); ok {
				...
				// Convert Gemini batch request items directly to UnifAI format
				...
				if geminiReq.Batch.InputConfig.FileName != "" {
					unifaiBatchReq.InputFileID = geminiReq.Batch.InputConfig.FileName
				}

				return &BatchRequest{
					Type:          schemas.BatchCreateRequest,
					CreateRequest: unifaiBatchReq,
				}, nil
			}
		...
		StreamConfig: &StreamConfig{
			ResponsesStreamResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIResponsesStreamResponse) (string, interface{}, error) {
				...
				var state *gemini.UnifAIToGeminiStreamState

				if stateValue := ctx.Value(stateKey); stateValue != nil {
					state = stateValue.(*gemini.UnifAIToGeminiStreamState)
				} else {
					state = gemini.NewUnifAIToGeminiStreamState()
...
func CreateGenAIFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		// that no UnifAI call is made.
		ShortCircuit: func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) (bool, error) {
		...
		// the KV store and builds a full UnifAIFileUploadRequest.
		FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
			...
			if session.VirtualKey != "" {
				if vk, ok := ctx.Value(schemas.UnifAIContextKeyVirtualKey).(string); !ok || vk == "" {
					ctx.SetValue(schemas.UnifAIContextKeyVirtualKey, session.VirtualKey)
				}
			}
...
func CreateGenAIBatchRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		GetRequestTypeInstance: func(ctx context.Context) interface{} {
			return &schemas.UnifAIBatchDeleteRequest{}
		},
		BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
			if deleteReq, ok := req.(*schemas.UnifAIBatchDeleteRequest); ok {
				return &BatchRequest{
		...
		BatchDeleteResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIBatchDeleteResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.Gemini && resp.ExtraFields.RawResponse != nil {
				return resp.ExtraFields.RawResponse, nil
			}
			return map[string]interface{}{}, nil // Gemini returns empty response on delete
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
			if job, ok := req.(*vertex.VertexBatchPredictionJob); ok {
				createReq := vertex.ToUnifAIBatchCreateRequest(job)
				// Provider follows x-model-provider (Vertex by default), set in the PreCallback.
				if provider, ok := ctx.Value(unifaiContextKeyProvider).(schemas.ModelProvider); ok && provider != "" {
				...
				if createReq.Provider == schemas.Vertex && len(createReq.RawRequestBody) > 0 {
					ctx.SetValue(schemas.UnifAIContextKeyUseRawRequestBody, true)
				}
				return &BatchRequest{
					Type:          schemas.BatchCreateRequest,
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
			unifaiCtx.SetValue(unifaiContextKeyProvider, getProviderFromHeader(ctx, schemas.Vertex))
			setGenAIRawRequestBodyFromRequest(ctx, unifaiCtx)
			return nil
		},
	})
...
func extractVertexBatchPathParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	...
	switch r := req.(type) {
	case *schemas.UnifAIBatchListRequest:
		r.Provider = provider
	...
	case *schemas.UnifAIBatchCancelRequest:
		...
		r.Provider = provider
		r.BatchID = batchID
	case *schemas.UnifAIBatchDeleteRequest:
		if batchID == "" {
			return errors.New("batch_id is required")
		}
		r.Provider = provider
...
func extractGeminiBatchIDFromPath(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
...
func extractGeminiFileListQueryParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	...
	} else if listReq, ok := req.(*schemas.UnifAIBatchListRequest); ok {
		listReq.Provider = provider
...
func extractGeminiFileIDFromPath(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
...
func extractGeminiFileUploadParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
			if vertexReq, ok := req.(*vertex.VertexRankRequest); ok {
				return &schemas.UnifAIRequest{
					RerankRequest: vertexReq.ToUnifAIRerankRequest(ctx),
				}, nil
			}
...
func extractGeminiCachedContentNameFromPath(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	...
	switch r := req.(type) {
	case *schemas.UnifAICachedContentRetrieveRequest:
		r.Name = nameStr
		r.Provider = provider
	case *schemas.UnifAICachedContentUpdateRequest:
		r.Name = nameStr
		r.Provider = provider
	case *schemas.UnifAICachedContentDeleteRequest:
		r.Name = nameStr
		r.Provider = provider
	}
	return nil
...
func setGeminiCachedContentCreateProvider(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	if createReq, ok := req.(*schemas.UnifAICachedContentCreateRequest); ok {
		createReq.Provider = provider
	}
	return nil
}
...
func extractGeminiCachedContentListQueryParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	if listReq, ok := req.(*schemas.UnifAICachedContentListRequest); ok {
		listReq.Provider = provider
		if pageSizeStr := string(ctx.QueryArgs().Peek("pageSize")); pageSizeStr != "" {
			if pageSize, err := strconv.Atoi(pageSizeStr); err == nil {
...
func CreateGenAICachedContentRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, cachedBase := range cachedBasePaths {
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAICachedContentCreateRequest{}
			},
			RequestParser: func(ctx *fasthttp.RequestCtx, req interface{}) error {
				createReq, ok := req.(*schemas.UnifAICachedContentCreateRequest)
				if !ok {
			...
			CachedContentRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*CachedContentRequest, error) {
				createReq, ok := req.(*schemas.UnifAICachedContentCreateRequest)
				if !ok {
			...
			CachedContentCreateResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICachedContentCreateResponse) (interface{}, error) {
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAICachedContentListRequest{}
			},
			CachedContentRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*CachedContentRequest, error) {
				listReq, ok := req.(*schemas.UnifAICachedContentListRequest)
				if !ok {
			...
			CachedContentListResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICachedContentListResponse) (interface{}, error) {
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAICachedContentRetrieveRequest{}
			},
			CachedContentRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*CachedContentRequest, error) {
				retrieveReq, ok := req.(*schemas.UnifAICachedContentRetrieveRequest)
				if !ok {
			...
			CachedContentRetrieveResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICachedContentRetrieveResponse) (interface{}, error) {
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAICachedContentUpdateRequest{}
			},
			RequestParser: func(ctx *fasthttp.RequestCtx, req interface{}) error {
				updateReq, ok := req.(*schemas.UnifAICachedContentUpdateRequest)
				if !ok {
			...
			CachedContentUpdateResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICachedContentUpdateResponse) (interface{}, error) {
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAICachedContentDeleteRequest{}
			},
			CachedContentRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*CachedContentRequest, error) {
				deleteReq, ok := req.(*schemas.UnifAICachedContentDeleteRequest)
				if !ok {
			...
			CachedContentDeleteResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICachedContentDeleteResponse) (interface{}, error) {
...
// NewGenAIRouter creates a new GenAIRouter with the given unifai client.
func NewGenAIRouter(client *unifai.UnifAI, handlerStore lib.HandlerStore, logger schemas.Logger) *GenAIRouter {
...
func getLargeRequestTypeDetectionThreshold(ctx *fasthttp.RequestCtx) int64 {
	...
	if sharedCtx, ok := ctx.UserValue(lib.FastHTTPUserValueUnifAIContext).(*schemas.UnifAIContext); ok && sharedCtx != nil {
		if threshold, ok := sharedCtx.Value(schemas.UnifAIContextKeyLargePayloadRequestThreshold).(int64); ok && threshold > 0 {
			return threshold
		}
	}
...
func extractAndSetModelAndRequestType(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	...
	provider := getProviderFromHeader(ctx, schemas.Gemini)
	// set in context
	unifaiCtx.SetValue(unifaiContextKeyProvider, provider)
	...
	case *gemini.GeminiGenerationRequest:
		...
		if isLargePayload, ok := unifaiCtx.Value(schemas.UnifAIContextKeyLargePayloadMode).(bool); ok && isLargePayload {
...
func setGenAIRawRequestBodyFromRequest(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext) {
	if body := ctx.Request.Body(); len(body) > 0 {
		unifaiCtx.SetValue(genAIRawRequestBodyContextKey, copyBytes(body))
	}
}
...
func getGenAIRawRequestBody(ctx *schemas.UnifAIContext) []byte {
	if ctx == nil {
		return nil
	}
...
func extractModelAndRequestType(ctx *fasthttp.RequestCtx) (string, schemas.RequestType) {
	...
	if sharedCtx, ok := ctx.UserValue(lib.FastHTTPUserValueUnifAIContext).(*schemas.UnifAIContext); ok && sharedCtx != nil {
		if isLargePayload, ok := sharedCtx.Value(schemas.UnifAIContextKeyLargePayloadMode).(bool); ok && isLargePayload {
...
func extractGeminiListModelsParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	if listModelsReq, ok := req.(*schemas.UnifAIListModelsRequest); ok {
...
func extractGeminiModelMetadataParams(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	listModelsReq, ok := req.(*schemas.UnifAIListModelsRequest)
	if !ok {
	...
	unifaiCtx.SetValue(requestedGeminiModelMetadataContextKey, modelStr)

	if provider == schemas.Gemini {
		// Use Gemini native metadata endpoint for direct model lookup.
		unifaiCtx.SetValue(schemas.UnifAIContextKeyURLPath, "/models/"+modelStr)
	}

	return nil
}

func convertGeminiModelMetadataResponse(ctx *schemas.UnifAIContext, resp *schemas.UnifAIListModelsResponse) (interface{}, error) {
...
// and maps them to a UnifAI video retrieve request.
func extractGeminiVideoOperationFromPath(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	model := ctx.UserValue("model")
	if model == nil {
	...
	switch r := req.(type) {
	case *schemas.UnifAIVideoRetrieveRequest:
		r.Provider = provider
		...
		if r.Provider == schemas.OpenAI || r.Provider == schemas.Azure {
			...
			unifaiCtx.SetValue(schemas.UnifAIContextKeyVideoOutputRequested, true)
		}
