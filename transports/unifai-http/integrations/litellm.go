...
// NewLiteLLMRouter creates a new LiteLLMRouter with the given unifai client.
func NewLiteLLMRouter(client *unifai.UnifAI, handlerStore lib.HandlerStore, logger schemas.Logger) *LiteLLMRouter {
	routes := []RouteConfig{}
