...
func hydrateOpenAIRequestFromLargePayloadMetadata(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) {
	if unifaiCtx == nil {
		return
	}
...
func openAILargePayloadPreHook(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	hydrateOpenAIRequestFromLargePayloadMetadata(ctx, unifaiCtx, req)
	schemas.ExtractAndSetUserAgentFromHeaders(extractHeadersFromRequest(ctx), unifaiCtx)
	return nil
}

func AzureEndpointPreHook(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		case *schemas.UnifAIListModelsRequest:
			if deploymentProviderStr != "" {
...
// openAIResponsesWireConverter maps a UnifAI responses payload to the OpenAI wire JSON shape.
func openAIResponsesWireConverter(ctx *schemas.UnifAIContext, resp *schemas.UnifAIResponsesResponse) (interface{}, error) {
...
func CreateOpenAIRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		GetRequestTypeInstance: func(ctx context.Context) interface{} {
			if requestType, ok := ctx.Value(schemas.UnifAIContextKeyHTTPRequestType).(schemas.RequestType); ok {
				switch requestType {
		...
		RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
			if openaiReq, ok := req.(*openai.OpenAIChatRequest); ok {
				return &schemas.UnifAIRequest{
					ChatRequest: openaiReq.ToUnifAIChatRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIResponsesRequest); ok {
				if reqType, _ := ctx.Value(schemas.UnifAIContextKeyHTTPRequestType).(schemas.RequestType); reqType == schemas.CountTokensRequest {
					return &schemas.UnifAIRequest{
						CountTokensRequest: openaiReq.ToUnifAIResponsesRequest(ctx),
					}, nil
				}
				return &schemas.UnifAIRequest{
					ResponsesRequest: openaiReq.ToUnifAIResponsesRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITextCompletionRequest); ok {
				return &schemas.UnifAIRequest{
					TextCompletionRequest: openaiReq.ToUnifAITextCompletionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
				return &schemas.UnifAIRequest{
					EmbeddingRequest: openaiReq.ToUnifAIEmbeddingRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAISpeechRequest); ok {
				return &schemas.UnifAIRequest{
					SpeechRequest: openaiReq.ToUnifAISpeechRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
				return &schemas.UnifAIRequest{
					TranscriptionRequest: openaiReq.ToUnifAITranscriptionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
				return &schemas.UnifAIRequest{
					ImageGenerationRequest: openaiReq.ToUnifAIImageGenerationRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
				return &schemas.UnifAIRequest{
					ImageEditRequest: openaiReq.ToUnifAIImageEditRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
				return &schemas.UnifAIRequest{
					ImageVariationRequest: openaiReq.ToUnifAIImageVariationRequest(ctx),
				}, nil
			}
		...
		SpeechResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAISpeechResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		TranscriptionResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAITranscriptionResponse) (interface{}, error) {
		...
		StreamConfig: &StreamConfig{
			...
			SpeechStreamResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAISpeechStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			TranscriptionStreamResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAITranscriptionStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			ImageGenerationStreamResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIImageGenerationStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
		...
		routes = append(routes, RouteConfig{
			...
			AsyncResponsesResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.AsyncJobResponse, responsesResponseConverter ResponsesResponseConverter) (interface{}, map[string]string, error) {
				unifaiResponse := &schemas.UnifAIResponsesResponse{
					ID:     &resp.ID,
					Status: unifai.Ptr(string(resp.Status)),
				}
				if resp.Status == schemas.AsyncJobStatusCompleted {
					...
					unifaiResponse = responsesResp
				}
				response, err := responsesResponseConverter(ctx, unifaiResponse)
				if err != nil {
					return nil, nil, err
				}
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
				...
				if isAzureSDKRequest(ctx) {
					unifaiCtx.SetValue(schemas.UnifAIContextKeyIsAzureUserAgent, true)
				}
				return nil
			},
		})
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIResponsesRetrieveRequest{}
			},
			PreCallback:     extractResponsesLifecycleFromPath(handlerStore),
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if rr, ok := req.(*schemas.UnifAIResponsesRetrieveRequest); ok {
					return &schemas.UnifAIRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIResponsesDeleteRequest{}
			},
			PreCallback:     extractResponsesLifecycleFromPath(handlerStore),
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if dr, ok := req.(*schemas.UnifAIResponsesDeleteRequest); ok {
					return &schemas.UnifAIRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIResponsesCancelRequest{}
			},
			PreCallback:     extractResponsesLifecycleFromPath(handlerStore),
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if cr, ok := req.(*schemas.UnifAIResponsesCancelRequest); ok {
					return &schemas.UnifAIRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIResponsesInputItemsRequest{}
			},
			PreCallback:     extractResponsesLifecycleFromPath(handlerStore),
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if ir, ok := req.(*schemas.UnifAIResponsesInputItemsRequest); ok {
					return &schemas.UnifAIRequest{
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if r, ok := req.(*openai.OpenAICompactionRequest); ok {
					return &schemas.UnifAIRequest{
						CompactionRequest: r.ToUnifAICompactionRequest(ctx),
					}, nil
				}
				return nil, errors.New("invalid compaction request type")
			},
			CompactionResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAICompactionResponse) (interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return resp.ExtraFields.RawResponse, nil
					}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if embeddingReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
					return &schemas.UnifAIRequest{
						EmbeddingRequest: embeddingReq.ToUnifAIEmbeddingRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if speechReq, ok := req.(*openai.OpenAISpeechRequest); ok {
					return &schemas.UnifAIRequest{
						SpeechRequest: speechReq.ToUnifAISpeechRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if transcriptionReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
					return &schemas.UnifAIRequest{
						TranscriptionRequest: transcriptionReq.ToUnifAITranscriptionRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if imageGenReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
					return &schemas.UnifAIRequest{
						ImageGenerationRequest: imageGenReq.ToUnifAIImageGenerationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if imageEditReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
					return &schemas.UnifAIRequest{
						ImageEditRequest: imageEditReq.ToUnifAIImageEditRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if imageVariationReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
					return &schemas.UnifAIRequest{
						ImageVariationRequest: imageVariationReq.ToUnifAIImageVariationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoGenerationReq, ok := req.(*openai.OpenAIVideoGenerationRequest); ok {
					return &schemas.UnifAIRequest{
						VideoGenerationRequest: videoGenerationReq.ToUnifAIVideoGenerationRequest(ctx),
					}, nil
				}
				return nil, errors.New("invalid video generation request type")
			},
			VideoGenerationResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIVideoGenerationResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIVideoRetrieveRequest{}
			},
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoRetrieveReq, ok := req.(*schemas.UnifAIVideoRetrieveRequest); ok {
					return &schemas.UnifAIRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIVideoDownloadRequest{}
			},
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoDownloadReq, ok := req.(*schemas.UnifAIVideoDownloadRequest); ok {
					return &schemas.UnifAIRequest{
			...
			VideoDownloadResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIVideoDownloadResponse) (interface{}, error) {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIVideoDeleteRequest{}
			},
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoDeleteReq, ok := req.(*schemas.UnifAIVideoDeleteRequest); ok {
					return &schemas.UnifAIRequest{
			...
			VideoDeleteResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIVideoDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoRemixReq, ok := req.(*openai.OpenAIVideoRemixRequest); ok {
					return &schemas.UnifAIRequest{
						VideoRemixRequest: openai.ToUnifAIVideoRemixRequest(videoRemixReq),
					}, nil
				}
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIVideoListRequest{}
			},
			RequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*schemas.UnifAIRequest, error) {
				if videoListReq, ok := req.(*schemas.UnifAIVideoListRequest); ok {
					return &schemas.UnifAIRequest{
			...
			VideoListResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIVideoListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
...
func CreateOpenAIBatchRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIBatchCreateRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
				if openaiReq, ok := req.(*schemas.UnifAIBatchCreateRequest); ok {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
				...
				if createReq, ok := req.(*schemas.UnifAIBatchCreateRequest); ok {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIBatchListRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
				if listReq, ok := req.(*schemas.UnifAIBatchListRequest); ok {
					if listReq.Provider == "" {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
				if retrieveReq, ok := req.(*schemas.UnifAIBatchRetrieveRequest); ok {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			BatchRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*BatchRequest, error) {
				if cancelReq, ok := req.(*schemas.UnifAIBatchCancelRequest); ok {
...
func CreateOpenAIFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIFileUploadRequest{}
			},
			...
			FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
				if uploadReq, ok := req.(*schemas.UnifAIFileUploadRequest); ok {
					return &FileRequest{
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
				...
				if unifaiReq, ok := req.(*schemas.UnifAIFileUploadRequest); ok {
					if unifaiReq.Provider == "" {
						if isAzureSDKRequest(ctx) {
							unifaiReq.Provider = schemas.Azure
						} else {
							unifaiReq.Provider = schemas.OpenAI
						}
					}
				}
				return nil
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIFileListRequest{}
			},
			FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
				if listReq, ok := req.(*schemas.UnifAIFileListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &FileRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIFileRetrieveRequest{}
			},
			FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
				if retrieveReq, ok := req.(*schemas.UnifAIFileRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIFileDeleteRequest{}
			},
			FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
				if deleteReq, ok := req.(*schemas.UnifAIFileDeleteRequest); ok {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIFileContentRequest{}
			},
			FileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*FileRequest, error) {
				if contentReq, ok := req.(*schemas.UnifAIFileContentRequest); ok {
...
func extractBatchIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIBatchRetrieveRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		case *schemas.UnifAIBatchCancelRequest:
			r.BatchID = batchIDStr
			// For POST cancel, provider comes from body, only set if empty
			if r.Provider == "" {
				r.Provider = provider
			}
		case *schemas.UnifAIBatchResultsRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		}
...
func extractVideoIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIVideoReferenceRequest:
			r.Provider = providerName
			r.ID = rawVideoID
		case *schemas.UnifAIVideoDownloadRequest:
			r.Provider = providerName
			r.ID = rawVideoID
...
func extractFileIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIFileRetrieveRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.UnifAIFileDeleteRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.UnifAIFileContentRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
...
func extractResponsesLifecycleFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIResponsesRetrieveRequest:
			r.ResponseID = idStr
			r.Provider = provider
		...
		case *schemas.UnifAIResponsesDeleteRequest:
			r.ResponseID = idStr
			r.Provider = provider
		case *schemas.UnifAIResponsesCancelRequest:
			r.ResponseID = idStr
			r.Provider = provider
		case *schemas.UnifAIResponsesInputItemsRequest:
			r.ResponseID = idStr
			r.Provider = provider
			ctx.QueryArgs().VisitAll(func(key, value []byte) {
				switch string(key) {
...
func parseOpenAIFileUploadMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	uploadReq, ok := req.(*schemas.UnifAIFileUploadRequest)
	if !ok {
...
func CreateOpenAIContainerRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerCreateRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.UnifAIContainerCreateRequest); ok {
			...
			ContainerCreateResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerListRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.UnifAIContainerListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerListResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerRetrieveRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.UnifAIContainerRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerRetrieveResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerDeleteRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.UnifAIContainerDeleteRequest); ok {
					if deleteReq.Provider == "" {
						deleteReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerDeleteResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
...
func extractContainerIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIContainerRetrieveRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		case *schemas.UnifAIContainerDeleteRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		}
...
func CreateOpenAIContainerFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerFileCreateRequest{}
			},
			RequestParser: parseContainerFileCreateMultipartRequest,
			ContainerFileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.UnifAIContainerFileCreateRequest); ok {
			...
			ContainerFileCreateResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerFileCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerFileListRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.UnifAIContainerFileListRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileListResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerFileListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerFileRetrieveRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.UnifAIContainerFileRetrieveRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileRetrieveResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerFileRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerFileContentRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if contentReq, ok := req.(*schemas.UnifAIContainerFileContentRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileContentResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerFileContentResponse) (interface{}, error) {
				return resp.Content, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.UnifAIContainerFileDeleteRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.UnifAIContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.UnifAIContainerFileDeleteRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileDeleteResponseConverter: func(ctx *schemas.UnifAIContext, resp *schemas.UnifAIContainerFileDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.UnifAIContext, err *schemas.UnifAIError) interface{} {
				return err
...
func extractContainerAndFileIDFromPath(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, unifaiCtx *schemas.UnifAIContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.UnifAIContainerFileRetrieveRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.UnifAIContainerFileContentRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.UnifAIContainerFileDeleteRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		}
...
// NewOpenAIRouter creates a new OpenAIRouter with the given unifai client.
func NewOpenAIRouter(client *unifai.UnifAI, handlerStore lib.HandlerStore, logger schemas.Logger) *OpenAIRouter {
...
func parseContainerFileCreateMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	createReq, ok := req.(*schemas.UnifAIContainerFileCreateRequest)
	if !ok {
