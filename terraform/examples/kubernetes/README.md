# UnifAI on Kubernetes

Deploys UnifAI on any existing Kubernetes cluster using a Deployment, PVC, and optional Ingress + HPA.
...
To expose UnifAI externally, set `create_load_balancer = true` and configure:
