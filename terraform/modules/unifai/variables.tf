...
variable "config_json" {
  description = "Complete UnifAI config.json as a string. Can be combined with individual config variables (variables override matching keys)."
  type        = string
  default     = null
  sensitive   = true
}
...
variable "config_json_file" {
  description = "Path to a UnifAI config.json file. Can be combined with individual config variables (variables override matching keys)."
  type        = string
  default     = null
}
...
# --- Image ---
variable "image_tag" {
  description = "UnifAI Docker image tag."
  type        = string
  default     = "latest"
}

variable "image_repository" {
  description = "UnifAI Docker image repository."
  type        = string
  default     = "unifai/unifai"
}
...
# of the system. Please read https://docs.unifai.ai/deployment-guides/how-to/multinode
#-----------------------------------------------------------------------------------------
