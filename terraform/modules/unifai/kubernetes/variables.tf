...
variable "service_name" {
  description = "Name for the UnifAI Kubernetes service/deployment."
  type        = string
}

variable "config_json" {
  description = "Complete UnifAI config.json as a string."
  type        = string
  sensitive   = true
}
...
variable "container_port" {
  description = "Port the UnifAI container listens on."
  type        = number
}
