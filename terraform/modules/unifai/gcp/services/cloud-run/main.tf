# ──────────────────────────────────────────────────────────────────────────────
# Cloud Run service sub-module – UnifAI on Google Cloud Run
# ──────────────────────────────────────────────────────────────────────────────
...
resource "google_cloud_run_v2_service" "unifai" {
...
resource "google_cloud_run_v2_service_iam_member" "public_access" {
  ...
  project  = var.project_id
  location = var.region
  name     = google_cloud_run_v2_service.unifai.name
...
resource "google_cloud_run_domain_mapping" "unifai" {
  ...
  spec {
    route_name = google_cloud_run_v2_service.unifai.name
  }
}
