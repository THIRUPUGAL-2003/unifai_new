# All variables pass through to the unifai module.
...
variable "image_repository" { default = "unifai/unifai" }
variable "name_prefix" { default = "unifai" }
...
variable "kubernetes_namespace" { default = "unifai" }
