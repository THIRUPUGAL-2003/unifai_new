...
print_banner() {
    ...
    echo -e "${BLUE}╔═══════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}║     UnifAI Values Generator             ║${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}╚═══════════════════════════════════════════╝${NC}"
    echo ""
}
...
if [[ "$ingress_choice" =~ ^[Yy]$ ]]; then
    ...
    read -p "   Enter your domain (e.g., unifai.yourdomain.com): " DOMAIN
else
...
echo ""
print_info "Install with: helm install unifai ./unifai -f $OUTPUT_FILE"
